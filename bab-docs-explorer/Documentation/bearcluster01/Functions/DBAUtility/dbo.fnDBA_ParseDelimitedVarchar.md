# dbo.fnDBA_ParseDelimitedVarchar
...
```mermaid
flowchart LR
    FUNC["dbo.fnDBA_ParseDelimitedVarchar"]
...
|---|---|---|---|
| @p_SourceText | varchar | 8000 | NO |
| @p_Delimeter | varchar | 100 | NO |
...
CREATE   function [dbo].[fnDBA_ParseDelimitedVarchar] 
 (
...
-- =============================================================================================================
-- Name: fnDBA_ParseDelimitedVarchar
--
-- Description:
--********************************************************************************
