# WM.vwTransactionDetailPayments_All_1_1_BJB20200716
...
```mermaid
flowchart LR
    VIEW["WM.vwTransactionDetailPayments_All_1_1_BJB20200716"]
...
```sql
CREATE VIEW [WM].[vwTransactionDetailPayments_All_1_1_BJB20200716]
AS
