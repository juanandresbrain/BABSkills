...
dbo,BlitzFirst_FileStats_Deltas,CREATE VIEW [dbo].[BlitzFirst_FileStats_Deltas] AS 
WITH RowDates as
(
        SELECT 
...
dbo,BlitzFirst_PerfmonStats_Actuals,CREATE VIEW [dbo].[BlitzFirst_PerfmonStats_Actuals] AS 
...
dbo,BlitzFirst_PerfmonStats_Deltas,CREATE VIEW [dbo].[BlitzFirst_PerfmonStats_Deltas] AS 
WITH RowDates as
(
        SELECT 
                ROW_NUMBER() OVER (ORDER BY [ServerName], [CheckDate]) ID,
...
dbo,BlitzFirst_WaitStats_Deltas,CREATE VIEW [dbo].[BlitzFirst_WaitStats_Deltas] AS 
WITH RowDates as
(
        SELECT 
                ROW_NUMBER() OVER (ORDER BY [ServerName], [CheckDate]) ID,
