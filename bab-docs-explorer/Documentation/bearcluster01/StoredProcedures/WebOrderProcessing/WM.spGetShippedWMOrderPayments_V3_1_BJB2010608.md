# WM.spGetShippedWMOrderPayments_V3_1_BJB2010608
...
```mermaid
flowchart LR
    SP["WM.spGetShippedWMOrderPayments_V3_1_BJB2010608"]
...
```sql
CREATE PROCEDURE [WM].[spGetShippedWMOrderPayments_V3_1_BJB2010608] 
