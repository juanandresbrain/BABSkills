# WM.spGetShippedWMOrderPayments_V3_2_BJB20250906
...
```mermaid
flowchart LR
    SP["WM.spGetShippedWMOrderPayments_V3_2_BJB20250906"]
...
```sql
CREATE PROCEDURE [WM].[spGetShippedWMOrderPayments_V3_2_BJB20250906] 
