# WM.spGetShippedWMOrderItems_V2
...
```mermaid
flowchart LR
    SP["WM.spGetShippedWMOrderItems_V2"]
...
```sql
CREATE PROCEDURE [WM].[spGetShippedWMOrderItems_V2] 
...
BEGIN
	...
	LEFT JOIN [WebOrderProcessing].[WM].[ItemStatus] ist ON oi.OrderItemID = ist.OrderItemID AND ist.CurrentStatus = 1
