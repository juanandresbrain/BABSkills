# WM.spGetReturnWMOrderPayments_V3_1_BJB20210608
...
```mermaid
flowchart LR
    SP["WM.spGetReturnWMOrderPayments_V3_1_BJB20210608"]
...
```sql
CREATE PROCEDURE [WM].[spGetReturnWMOrderPayments_V3_1_BJB20210608] 
...
GROUP BY v.PickupStore, td.TransactionID, PaymentType, v.OrderTransactionIdentifier, o.OrderType, o.EnterpriseSellingID
