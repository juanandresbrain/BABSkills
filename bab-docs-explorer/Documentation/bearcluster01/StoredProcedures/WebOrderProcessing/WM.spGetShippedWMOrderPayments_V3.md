# WM.spGetShippedWMOrderPayments_V3
...
```mermaid
flowchart LR
    SP["WM.spGetShippedWMOrderPayments_V3"]
...
```sql
CREATE PROCEDURE [WM].[spGetShippedWMOrderPayments_V3] 
...
BEGIN
	...
	GROUP BY td.TransactionID, v.[OrderTransactionIdentifier], PaymentTransactionType, [TransactionAmount], TransactionGeneric1, [PaymentGeneric1], [PaymentGeneric2], [PaymentGeneric3], PaymentType, onps.PickupStore
	)
	SELECT OrderNumber
	      ,TransactionID
