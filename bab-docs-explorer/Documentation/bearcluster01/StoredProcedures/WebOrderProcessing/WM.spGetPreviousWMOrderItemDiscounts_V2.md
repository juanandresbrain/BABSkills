# WM.spGetPreviousWMOrderItemDiscounts_V2
...
```mermaid
flowchart LR
    SP["WM.spGetPreviousWMOrderItemDiscounts_V2"]
...
```sql
CREATE PROCEDURE [WM].[spGetPreviousWMOrderItemDiscounts_V2] 
