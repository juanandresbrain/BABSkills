# WM.spGetReturnWMOrderPayments_V3_1
...
```mermaid
flowchart LR
    SP["WM.spGetReturnWMOrderPayments_V3_1"]
...
```sql
CREATE PROCEDURE [WM].[spGetReturnWMOrderPayments_V3_1] 
...
GROUP BY v.PickupStore, td.TransactionID, PaymentType, v.OrderTransactionIdentifier, o.OrderType, o.EnterpriseSellingID, TransactionGeneric1
