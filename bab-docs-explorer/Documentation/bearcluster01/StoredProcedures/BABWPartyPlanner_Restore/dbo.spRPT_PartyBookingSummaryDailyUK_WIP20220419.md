# dbo.spRPT_PartyBookingSummaryDailyUK_WIP20220419
...
```mermaid
flowchart LR
    SP["dbo.spRPT_PartyBookingSummaryDailyUK_WIP20220419"]
...
```sql
CREATE PROC [dbo].[spRPT_PartyBookingSummaryDailyUK_WIP20220419]
-- =============================================================================================================
