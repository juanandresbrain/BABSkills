# Stored Procedures: BABWPartyPlanner_Restore
...
| dbo | [spRPT_GSPartyBookingsReportDaily](dbo.spRPT_GSPartyBookingsReportDaily.md) | dbo.Country, dbo.Customer, dbo.Event, dbo.Occasion, dbo.Package, dbo.Party, dbo.sp_send_dbmail, dbo.Store |
