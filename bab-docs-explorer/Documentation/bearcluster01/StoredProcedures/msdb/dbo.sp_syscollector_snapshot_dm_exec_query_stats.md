# dbo.sp_syscollector_snapshot_dm_exec_query_stats
...
```mermaid
flowchart LR
    SP["dbo.sp_syscollector_snapshot_dm_exec_query_stats"]
    ...
    dbo_sp_syscollector_snapshot_dm_exec_query_stats_internal(["dbo.sp_syscollector_snapshot_dm_exec_query_stats_internal"]) --> SP
```
...
| dbo.sp_syscollector_snapshot_dm_exec_query_stats_internal |
