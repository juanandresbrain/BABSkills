# dbo.autoadmin_metadata_query_task_agent_global_data
...
```mermaid
flowchart LR
    SP["dbo.autoadmin_metadata_query_task_agent_global_data"]
    dbo_autoadmin_task_agent_metadata(["dbo.autoadmin_task_agent_metadata"]) --> SP
    dbo_fn_autoadmin_schema_version(["dbo.fn_autoadmin_schema_version"]) --> SP
```
...
| dbo.fn_autoadmin_schema_version |
