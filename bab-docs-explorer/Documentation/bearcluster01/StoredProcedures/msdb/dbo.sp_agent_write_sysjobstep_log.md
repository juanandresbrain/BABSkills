# dbo.sp_agent_write_sysjobstep_log
...
```mermaid
flowchart LR
    SP["dbo.sp_agent_write_sysjobstep_log"]
    dbo_sp_write_sysjobstep_log(["dbo.sp_write_sysjobstep_log"]) --> SP
```
...
dbo,sp_apply_job_to_targets,CREATE PROCEDURE sp_apply_job_to_targets
