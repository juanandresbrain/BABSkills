...
dbo,sp_verify_jobproc_caller,CREATE PROCEDURE sp_verify_jobproc_caller
...
dbo,sp_verify_jobstep,CREATE PROCEDURE sp_verify_jobstep
  @job_id             UNIQUEIDENTIFIER,
  @step_id            INT,
  @step_name          sysname,
