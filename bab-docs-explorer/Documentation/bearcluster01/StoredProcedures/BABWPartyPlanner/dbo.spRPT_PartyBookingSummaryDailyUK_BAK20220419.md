# dbo.spRPT_PartyBookingSummaryDailyUK_BAK20220419
...
```mermaid
flowchart LR
    SP["dbo.spRPT_PartyBookingSummaryDailyUK_BAK20220419"]
...
```sql
CREATE PROC [dbo].[spRPT_PartyBookingSummaryDailyUK_BAK20220419]
-- =============================================================================================================
