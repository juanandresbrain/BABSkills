# dbo.spRPT_GSPartyBookingsReportDaily_BAK20260512
...
```mermaid
flowchart LR
    SP["dbo.spRPT_GSPartyBookingsReportDaily_BAK20260512"]
...
```sql
CREATE PROC [dbo].[spRPT_GSPartyBookingsReportDaily_BAK20260512]
-- =============================================================================================================
