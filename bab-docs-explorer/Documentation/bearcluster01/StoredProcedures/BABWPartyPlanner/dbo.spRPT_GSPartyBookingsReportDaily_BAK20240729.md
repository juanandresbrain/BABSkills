# dbo.spRPT_GSPartyBookingsReportDaily_BAK20240729
...
```mermaid
flowchart LR
    SP["dbo.spRPT_GSPartyBookingsReportDaily_BAK20240729"]
...
```sql
CREATE PROC [dbo].[spRPT_GSPartyBookingsReportDaily_BAK20240729]
-- =============================================================================================================
-- Name: [dbo].[spRPT_GSPartyBookingsReportDaily_BAK20240729]
--
...
--
--
-- USAGE:  EXEC [dbo].[spRPT_GSPartyBookingsReportDaily_BAK20240729] @ac_recipients = 'timb@buildabear.com'
-- =============================================================================================================
