# dbo.sp_GetBookedPartiesByPartyID_BJB20240611
...
```mermaid
flowchart LR
    SP["dbo.sp_GetBookedPartiesByPartyID_BJB20240611"]
...
CREATE PROCEDURE [dbo].[sp_GetBookedPartiesByPartyID_BJB20240611] 
