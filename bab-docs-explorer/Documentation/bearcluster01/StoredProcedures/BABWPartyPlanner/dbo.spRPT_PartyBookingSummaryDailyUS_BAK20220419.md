# dbo.spRPT_PartyBookingSummaryDailyUS_BAK20220419
...
```mermaid
flowchart LR
    SP["dbo.spRPT_PartyBookingSummaryDailyUS_BAK20220419"]
...
```sql
CREATE PROC [dbo].[spRPT_PartyBookingSummaryDailyUS_BAK20220419]
-- =============================================================================================================
...
select @body =
(
	select  td = BookingMethod,     -- Here we put the column names
			td = COUNT(EventID)
