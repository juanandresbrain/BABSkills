...
UPDATE	[ReportServerBIRPT02TempDB].dbo.ExecutionCache WITH (ROWLOCK) -- had deadlocks caused by page lock escalation using rowlock to avoid it.
...
INSERT INTO [ReportServerBIRPT02TempDB].dbo.ExecutionCache
