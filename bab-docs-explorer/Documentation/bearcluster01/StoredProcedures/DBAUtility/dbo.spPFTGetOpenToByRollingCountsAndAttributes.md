...
END
	...
	SELECT V1_1.Field_a 'Style Code'
		  ...
		  ,a.Field_t 'Net Receipts Units ( 1 Period(s) Ago )'
		  ,a.Field_u 'Net Receipts Units ( 2 Period(s) Ago )'
		  ,a.Field_v 'Net Receipts Units ( 3 Period(s) Ago )'
		  ,a.Field_w 'Net Receipts Units ( 4 Period(s) Ago )'
		  ,a.Field_x 'Net Receipts Units ( 5 Period(s) Ago )'
		  ,a.Field_y 'Net Receipts Units ( 6 Period(s) Ago )'
		  ,a.Field_z 'Net Receipts Units ( 7 Period(s) Ago )'
		  ,a.Field_0 'Net Receipts Units ( 8 Period(s) Ago )'
		  ,a.Field_1 'Net Receipts Units ( 9 Period(s) Ago )'
		  ,a.Field_2 'Net Receipts Units ( 10 Period(s) Ago )'
		  ,a.Field_3 'Net Receipts Units ( 11 Period(s) Ago )'
		  ,a.Field_4 'Net Receipts Units ( 12 Period(s) Ago )'
		  ,a.Field_5 'Net Receipts Units ( This Period )'
		  ,c.Field_6 'On Order Units ( Last 3 Period(s) )'
		  ,c.Field_7 'On Order Units ( This Period )'
		  ,c.Field_8 'On Order Units ( Next 1 Periods )'
		  ,c.Field_9 'On Order Units ( Next 2 Periods )'
		  ,c.Field_a1 'On Order Units ( Next 3 Periods )'
		  ,c.Field_b1 'On Order Units ( Next 4 Periods )'
		  ,c.Field_c1 'On Order Units ( Next 5 Periods )'
		  ,c.Field_d1 'On Order Units ( Next 6 Periods )'
		  ,e.Field_e1 'EOP OH WH Units:InvStatus[Available] ( Current )'
