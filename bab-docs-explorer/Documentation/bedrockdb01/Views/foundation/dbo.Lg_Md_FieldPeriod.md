...
flowchart LR
    ...
    Md_FieldPeriod(["Md_FieldPeriod"]) --> VIEW
```
...
create view dbo.Lg_Md_FieldPeriod  AS
	SELECT a.field_period_id, a.sql_template_id, a.topic_id, 
	       ...
	       a.lblinput_1, a.lblinput1_2, ISNULL(d.first_pair_text, a.lblinput_1) as lblinput1_3,
	       a.lblinput_2, a.lblinput2_2, ISNULL(d.second_pair_text, a.lblinput_2) as lblinput2_3,
	       a.summed, a.range_sql, a.period_id, a.where_sql_template_id, 
	       a.resource_id_1, a.resource_id_2, a.resource_id_3, 
               a.label_resource_name, a.lblinput1_resource_name, a.lblinput2_resource_name, a.heading_label_resource_name,
               c.language_id
	  FROM Md_FieldPeriod a LEFT OUTER JOIN Lg_DependentDesc b ON a.resource_id_1 = b.resource_id
                                ...
                                LEFT OUTER JOIN Lg_DependentDesc d ON a.resource_id_3 = d.resource_id
```
