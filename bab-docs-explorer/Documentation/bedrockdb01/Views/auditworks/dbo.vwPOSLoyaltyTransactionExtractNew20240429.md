# dbo.vwPOSLoyaltyTransactionExtractNew20240429
...
```mermaid
flowchart LR
    VIEW["dbo.vwPOSLoyaltyTransactionExtractNew20240429"]
...
```sql
CREATE view [dbo].[vwPOSLoyaltyTransactionExtractNew20240429]
...
select
	...
	t.email_address as EmailAddress,
