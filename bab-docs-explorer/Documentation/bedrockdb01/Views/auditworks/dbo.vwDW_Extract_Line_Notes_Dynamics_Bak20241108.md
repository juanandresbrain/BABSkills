# dbo.vwDW_Extract_Line_Notes_Dynamics_Bak20241108
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_Extract_Line_Notes_Dynamics_Bak20241108"]
...
---- =====================================================================================================
CREATE VIEW [dbo].[vwDW_Extract_Line_Notes_Dynamics_Bak20241108]
AS
