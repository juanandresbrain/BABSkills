# dbo.vwDW_Extract_Line_Notes_TheoryTestNOv72024
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_Extract_Line_Notes_TheoryTestNOv72024"]
...
-- =====================================================================================================
CREATE VIEW [dbo].[vwDW_Extract_Line_Notes_TheoryTestNOv72024]
AS
...
(
		...
		WHERE th.transaction_id IS null		
			and ln.note_type = 35 -- 35 = VAT Note Type 
			and ln.av_transaction_id  not in ('496072299')
) 
