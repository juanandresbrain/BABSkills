...
```mermaid
flowchart LR
    VIEW["dbo.mew_sales_export_bak"]
    dbo_IFO01780001_final(["dbo.IFO01780001_final"]) --> VIEW
```
...
```sql
create view dbo.mew_sales_export_bak AS
