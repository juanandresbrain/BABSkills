# dbo.vwDW_Extract_Line_Notes_Dynamics_BAK20240202
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_Extract_Line_Notes_Dynamics_BAK20240202"]
...
---- =====================================================================================================
CREATE VIEW [dbo].[vwDW_Extract_Line_Notes_Dynamics_BAK20240202]
AS
...
line_id, 
note_type, 
max (line_note) as line_note -- With the alternate VAT source it seems like some rounding is in play, so I will except the higher value
