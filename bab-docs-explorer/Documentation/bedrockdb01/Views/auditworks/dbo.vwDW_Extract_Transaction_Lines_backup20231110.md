# dbo.vwDW_Extract_Transaction_Lines_backup20231110
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_Extract_Transaction_Lines_backup20231110"]
...
-- =====================================================================================================
CREATE VIEW [dbo].[vwDW_Extract_Transaction_Lines_backup20231110]
AS
