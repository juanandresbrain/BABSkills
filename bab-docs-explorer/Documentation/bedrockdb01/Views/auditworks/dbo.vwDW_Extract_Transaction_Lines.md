# dbo.vwDW_Extract_Transaction_Lines
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_Extract_Transaction_Lines"]
...
--		Dan Tweedie		2023-08-04		Updated final select statement to removeS alpha characters from refefence_no for jump mind pos promotions so they map to or coupon dim. 
-- =====================================================================================================
CREATE VIEW [dbo].[vwDW_Extract_Transaction_Lines]
AS
...
SELECT 
	...
	replace(replace(replace(replace(replace(reference_no, 'PRM',''), 'DM',''), 'CPN',''),'SALEPRICE',''),'EMP','') as reference_no, -- Replaced Above on 11/1/2023 as related to JIRA BIB-656
