...
SELECT p.upc_lookup_division, 
  ...
  FROM auditworks_external.dbo.user_pos_identifier p
...
SELECT u.upc_lookup_division, 
  ...
  FROM auditworks_external.dbo.user_upc u
       LEFT OUTER JOIN auditworks_external.dbo.user_pos_identifier p
