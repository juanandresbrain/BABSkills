# Job: StoresNotTricklePolling Europe
...
flowchart LR
    JOB["StoresNotTricklePolling Europe"]
    JOB --> S1["Step 1: EuropeStoresNotTricklePolling [TSQL]"]
```

## Steps

### Step 1: EuropeStoresNotTricklePolling
**Subsystem:** TSQL  
...
--	and reg.translate_lookup_version = 6 -- US Coalition Stores	
	and reg.translate_lookup_version in (8,9) -- UK Coalition Stores	
	and store.open_date < getdate()+1
	and reg.store_no NOT IN (17,155,165,179,180,212,242,285,470,482,485,486,990,991,1502,1505,1506,1507,1508,1509,1511,1570,2013)
...
exec master..xp_sendmail @recipients = 'RS Polling;jamesh@buildabear.co.uk'
	,@message = 'The following Europe Coalition stores have not reported sales in Auditworks for the last 3 hours:'
	,@subject = 'Europe Stores Not Trickle Polling'
