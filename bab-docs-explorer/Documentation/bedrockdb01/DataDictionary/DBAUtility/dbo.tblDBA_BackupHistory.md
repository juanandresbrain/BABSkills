...
|---|---|---|---|---|---|---|
| BackupHistoryID | int | 4 | 0 | YES |  | Surrogate Key |
| InstanceName | varchar | 200 | 0 |  |  |  |
| DatabaseName | varchar | 200 | 0 |  |  |  |
| BackupName | varchar | 200 | 1 |  |  | The Name of the backup file, before the backup set number, for grouping purposes. |
