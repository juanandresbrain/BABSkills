...
| next_run_schedule_id | int | 4 | 0 |  |  |  |
| current_execution_status | int | 4 | 0 |  |  |  |
| current_execution_step | sysname | 256 | 1 |  |  |  |
| current_retry_attempt | int | 4 | 0 |  |  |  |
| has_step | int | 4 | 1 |  |  |  |
| has_schedule | int | 4 | 1 |  |  |  |
| has_target | int | 4 | 1 |  |  |  |
| type | int | 4 | 0 |  |  |  |
| report_date | datetime | 8 | 0 |  |  |  |
