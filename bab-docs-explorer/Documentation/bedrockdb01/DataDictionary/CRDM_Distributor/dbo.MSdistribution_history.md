...
| current_delivery_rate | float | 8 | 0 |  |  |  |
| current_delivery_latency | int | 4 | 0 |  |  |  |
| delivered_transactions | int | 4 | 0 |  |  |  |
| delivered_commands | int | 4 | 0 |  |  |  |
| average_commands | int | 4 | 0 |  |  |  |
| delivery_rate | float | 8 | 0 |  |  |  |
| delivery_latency | int | 4 | 0 |  |  |  |
| total_delivered_commands | bigint | 8 | 0 |  |  |  |
| error_id | int | 4 | 0 |  |  |  |
| updateable_row | bit | 1 | 0 |  |  |  |
