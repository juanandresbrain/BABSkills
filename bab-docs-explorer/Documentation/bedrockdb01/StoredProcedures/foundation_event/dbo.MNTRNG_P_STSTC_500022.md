...
```mermaid
flowchart LR
    SP["dbo.MNTRNG_P_STSTC_500022"]
    EVNT_500022(["EVNT_500022"]) --> SP
    EVNT_STSTC_500022(["EVNT_STSTC_500022"]) --> SP
    ...
    TMP_STSTC_EVNT_500022(["TMP_STSTC_EVNT_500022"]) --> SP
    TMP_STSTC_KEY_500022(["TMP_STSTC_KEY_500022"]) --> SP
```
...
| TMP_STSTC_EVNT_500022 |
| TMP_STSTC_KEY_500022 |

## Stored Procedure Code

```sql
CREATE PROCEDURE [dbo].[MNTRNG_P_STSTC_500022]

@BATCH_SIZE as int --Max number of records in a batch
AS

--Create statistics temporary table to keep computed values per key
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_STSTC_KEY_500022')
   DROP TABLE dbo.TMP_STSTC_KEY_500022

CREATE TABLE dbo.TMP_STSTC_KEY_500022
(
...
CREATE CLUSTERED INDEX TMP_STSTC_KEY_500022_1 ON dbo.TMP_STSTC_KEY_500022 (POST_DTM , KEY_1 , KEY_2 , KEY_3 , KEY_249 ) ON [PRIMARY] 
CREATE INDEX TMP_STSTC_KEY_500022_2 ON dbo.TMP_STSTC_KEY_500022 (MIN_ID, MAX_ID) ON [PRIMARY]
...
--Indexes to speed up process 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500022_1 ON dbo.TMP_HSTRY_KEY_500022 (KEY_1 , KEY_2 , KEY_3 , KEY_249 ) ON [PRIMARY] 
CREATE INDEX TMP_HSTRY_KEY_500022_2 ON dbo.TMP_HSTRY_KEY_500022 (MIN_ID, MAX_ID) ON [PRIMARY]

--Create temporary event table for statistics
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_STSTC_EVNT_500022')
   DROP TABLE dbo.TMP_STSTC_EVNT_500022

CREATE TABLE dbo.TMP_STSTC_EVNT_500022
(
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_STSTC_EVNT_500022_1 ON dbo.TMP_STSTC_EVNT_500022 (POST_DTM , FLD_1 , FLD_2 , FLD_3 , FLD_249 ) ON [PRIMARY] 
CREATE INDEX TMP_STSTC_EVNT_500022_2 ON dbo.TMP_STSTC_EVNT_500022 (ID_CLMN) ON [PRIMARY]
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500022_1 ON dbo.TMP_HSTRY_EVNT_500022 ( FLD_1 , FLD_2 , FLD_3 , FLD_249 ) ON [PRIMARY]
CREATE INDEX TMP_HSTRY_EVNT_500022_2 ON dbo.TMP_HSTRY_EVNT_500022 (ID_CLMN) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_STSTC_EVNT_500022 (ID_CLMN, POST_DTM , FLD_1 , FLD_2 , FLD_3 , FLD_28 , FLD_249 )
   ...
   INSERT INTO TMP_HSTRY_EVNT_500022 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , FLD_1 , FLD_2 , FLD_3 , FLD_28 , FLD_249 )
   SELECT EVNT_ID,
   ...
   INSERT TMP_STSTC_KEY_500022 (POST_DTM , KEY_1 , KEY_2 , KEY_3 , KEY_249  , CNT, MIN_ID, MAX_ID)
   SELECT MIN(POST_DTM) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_3) , MIN(FLD_249) , COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
     FROM TMP_STSTC_EVNT_500022
   ...
   UPDATE EVNT_STSTC_500022 SET 
          EVNT_STSTC_500022.CNT = s.CNT + te.CNT,
          EVNT_STSTC_500022.LAST_MDFD_DTM = getdate()
          
     FROM TMP_STSTC_KEY_500022 te, EVNT_STSTC_500022 s, TMP_STSTC_EVNT_500022 F, TMP_STSTC_EVNT_500022 L
  ...
  AND s.KEY_249 = te.KEY_249 
   ...
   TRUNCATE TABLE TMP_STSTC_KEY_500022

   --Step 4-Delete temporary events already used to update statistics
   DELETE TMP_STSTC_EVNT_500022
     FROM TMP_STSTC_EVNT_500022 te, EVNT_STSTC_500022 s
  ...
  INSERT EVNT_STSTC_500022 (POST_DTM , KEY_1 , KEY_2 , KEY_3 , KEY_249 , CNT )
   SELECT D.POST_DTM , D.KEY_1 , D.KEY_2 , D.KEY_3 , D.KEY_249 , D.CNT 
     FROM TMP_STSTC_EVNT_500022 F, TMP_STSTC_EVNT_500022 L, TMP_STSTC_KEY_500022 D
   ...
   TRUNCATE TABLE TMP_STSTC_EVNT_500022
   TRUNCATE TABLE TMP_STSTC_KEY_500022
...
DROP TABLE TMP_STSTC_EVNT_500022
DROP TABLE TMP_HSTRY_EVNT_500022
DROP TABLE TMP_STSTC_KEY_500022
