...
flowchart LR
    ...
    TMP_HSTRY_COPY_EVNT_500008(["TMP_HSTRY_COPY_EVNT_500008"]) --> SP
...
```sql
CREATE PROCEDURE [dbo].[MNTRNG_P_HSTRY_500008] 

@BATCH_SIZE as int --Max number of records in a batch
AS

--Create temporary event table to keep a copy of the batch
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_HSTRY_COPY_EVNT_500008')
   DROP TABLE dbo.TMP_HSTRY_COPY_EVNT_500008

CREATE TABLE dbo.TMP_HSTRY_COPY_EVNT_500008
(
...
CREATE CLUSTERED INDEX TMP_HSTRY_COPY_EVNT_500008_1 ON dbo.TMP_HSTRY_COPY_EVNT_500008 (ID_CLMN) ON [PRIMARY]
...
CREATE INDEX TMP_HSTRY_EVNT_500008_1 ON dbo.TMP_HSTRY_EVNT_500008 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_47 , FLD_48 ) ON [PRIMARY] 
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500008_2 ON dbo.TMP_HSTRY_EVNT_500008 (ID_CLMN) ON [PRIMARY]
...
--Indexes to speed up process
CREATE INDEX TMP_HSTRY_KEY_500008_1 ON dbo.TMP_HSTRY_KEY_500008 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48 ) ON [PRIMARY] 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500008_2 ON dbo.TMP_HSTRY_KEY_500008 (MIN_ID, MAX_ID) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_HSTRY_COPY_EVNT_500008 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_47 , FLD_48 , FLD_15 , FLD_17 , FLD_49 , FLD_50 )
   SELECT EVNT_ID,
   ...
   BEGIN
      ...
      INSERT INTO TMP_HSTRY_EVNT_500008 
      SELECT ID_CLMN,
             POST_YEAR,
             POST_MNTH,
             POST_WEEK,
             ...
             POST_DTM 
             , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_47 , FLD_48 , FLD_15 , FLD_17 , FLD_49 , FLD_50 
        FROM TMP_HSTRY_COPY_EVNT_500008 
      ...
      SELECT MIN(POST_YEAR), MIN(POST_MNTH), 0, MIN(POST_DAY) , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_47) , MIN(FLD_48) , MIN(FLD_17) , MAX(FLD_17) , '01/01/1900 12:01:00 AM', COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
 ...
 , EVNT_STSTC_HSTRY_500008.FLD_17_MAX = dbo.GET_MAX(s.FLD_17_MAX, te.FLD_17_MAX) 
  ...
  AND s.KEY_48 = te.FLD_48 
      ...
      INSERT TMP_HSTRY_KEY_500008 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48  , FLD_17_MIN , FLD_17_MAX , POST_DTM, CNT, MIN_ID, MAX_ID)
      SELECT MIN(POST_YEAR), MIN(POST_MNTH), 0, MIN(POST_DAY) , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_47) , MIN(FLD_48) , MIN(FLD_17) , MAX(FLD_17) , MIN(POST_DTM), COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500008
        GROUP BY POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_47 , FLD_48 
 ...
 , FLD_17_MIN , FLD_17_MAX )
      SELECT D.POST_DTM, D.POST_YEAR, D.POST_MNTH, 0, D.POST_DAY , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.INSTNC_NUM , D.KEY_47 , D.KEY_48 , D.CNT , L.FLD_15 , D.FLD_17_MIN , D.FLD_17_MAX 
   ...
   BEGIN
      ...
      --Step 1-Insert computed values from the temp event table
      INSERT TMP_HSTRY_KEY_500008 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48  , FLD_17_MIN , FLD_17_MAX , POST_DTM, CNT, MIN_ID, MAX_ID)
      SELECT MIN(POST_YEAR), 0, MIN(POST_WEEK), 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_47) , MIN(FLD_48) , MIN(FLD_17) , MAX(FLD_17) , '01/01/1900 12:01:00 AM', COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500008
        GROUP BY  SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_47 , FLD_48 
 ...
 , EVNT_STSTC_HSTRY_500008.FLD_17_MAX = dbo.GET_MAX(s.FLD_17_MAX, te.FLD_17_MAX) 
  ...
  AND s.KEY_48 = te.FLD_48 
      ...
      --Step 5-Insert computed values from the temp event table
      INSERT TMP_HSTRY_KEY_500008 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48  , FLD_17_MIN , FLD_17_MAX , POST_DTM, CNT, MIN_ID, MAX_ID)
      SELECT MIN(POST_YEAR), 0, MIN(POST_WEEK), 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_47) , MIN(FLD_48) , MIN(FLD_17) , MAX(FLD_17) , MIN(DATEADD(dd, DATEPART(dy, POST_DTM) - DATEPART(dw, POST_DTM), DATEADD(mm, -DATEPART(mm, POST_DTM) + 1, DATEADD(dd, -DATEPART(dd, POST_DTM) + 1, POST_DTM)))), COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500008
        GROUP BY POST_YEAR, POST_WEEK , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_47 , FLD_48 
      ...
      INSERT EVNT_STSTC_HSTRY_500008 (POST_DTM, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48 , CNT , FLD_15_LAST 
 , FLD_17_MIN , FLD_17_MAX )
      SELECT D.POST_DTM, D.POST_YEAR, 0, D.POST_WEEK, 0 , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.INSTNC_NUM , D.KEY_47 , D.KEY_48 , D.CNT , L.FLD_15 , D.FLD_17_MIN , D.FLD_17_MAX 
        FROM TMP_HSTRY_EVNT_500008 F, TMP_HSTRY_EVNT_500008 L, TMP_HSTRY_KEY_500008 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
   ...
   BEGIN
      ...
      --Step 1-Insert computed values from the temp event table
      INSERT TMP_HSTRY_KEY_500008 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48  , FLD_17_MIN , FLD_17_MAX , POST_DTM, CNT, MIN_ID, MAX_ID)
      SELECT MIN(POST_YEAR), MIN(POST_MNTH), 0, 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_47) , MIN(FLD_48) , MIN(FLD_17) , MAX(FLD_17) , '01/01/1900 12:01:00 AM', COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500008
        GROUP BY  SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_47 , FLD_48 
 ...
 , EVNT_STSTC_HSTRY_500008.FLD_17_MAX = dbo.GET_MAX(s.FLD_17_MAX, te.FLD_17_MAX) 
  ...
  AND s.KEY_48 = te.FLD_48 
      ...
      --Step 5-Insert computed values from the temp event table
      INSERT TMP_HSTRY_KEY_500008 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48  , FLD_17_MIN , FLD_17_MAX , POST_DTM, CNT, MIN_ID, MAX_ID)
      SELECT MIN(POST_YEAR), MIN(POST_MNTH), 0, 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_47) , MIN(FLD_48) , MIN(FLD_17) , MAX(FLD_17) , MIN(DATEADD(dd, -DATEPART(dd, POST_DTM)+1, POST_DTM)), COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500008
        GROUP BY POST_YEAR, POST_MNTH , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_47 , FLD_48 
      ...
      INSERT EVNT_STSTC_HSTRY_500008 (POST_DTM, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48 , CNT , FLD_15_LAST 
 , FLD_17_MIN , FLD_17_MAX )
      SELECT D.POST_DTM, D.POST_YEAR, D.POST_MNTH, 0, 0 , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.INSTNC_NUM , D.KEY_47 , D.KEY_48 , D.CNT , L.FLD_15 , D.FLD_17_MIN , D.FLD_17_MAX 
        FROM TMP_HSTRY_EVNT_500008 F, TMP_HSTRY_EVNT_500008 L, TMP_HSTRY_KEY_500008 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
   ...
   BEGIN
      ...
      --Step 1-Insert computed values from the temp event table
      INSERT TMP_HSTRY_KEY_500008 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48  , FLD_17_MIN , FLD_17_MAX , POST_DTM, CNT, MIN_ID, MAX_ID)
      SELECT MIN(POST_YEAR), 0, 0, 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_47) , MIN(FLD_48) , MIN(FLD_17) , MAX(FLD_17) , '01/01/1900 12:01:00 AM', COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500008
        GROUP BY  SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_47 , FLD_48 
 ...
 , EVNT_STSTC_HSTRY_500008.FLD_17_MAX = dbo.GET_MAX(s.FLD_17_MAX, te.FLD_17_MAX) 
  ...
  AND s.KEY_48 = te.FLD_48 
      ...
      --Step 5-Insert computed values from the temp event table
      INSERT TMP_HSTRY_KEY_500008 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48  , FLD_17_MIN , FLD_17_MAX , POST_DTM, CNT, MIN_ID, MAX_ID)
      SELECT MIN(POST_YEAR), 0, 0, 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_47) , MIN(FLD_48) , MIN(FLD_17) , MAX(FLD_17) , MIN(DATEADD(mm, -DATEPART(mm, POST_DTM)+1, DATEADD(dd, -DATEPART(dd, POST_DTM)+1, POST_DTM))), COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500008
        GROUP BY POST_YEAR , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_47 , FLD_48 
      ...
      INSERT EVNT_STSTC_HSTRY_500008 (POST_DTM, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_47 , KEY_48 , CNT , FLD_15_LAST 
 , FLD_17_MIN , FLD_17_MAX )
      SELECT D.POST_DTM, D.POST_YEAR, 0, 0, 0 , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.INSTNC_NUM , D.KEY_47 , D.KEY_48 , D.CNT , L.FLD_15 , D.FLD_17_MIN , D.FLD_17_MAX 
        FROM TMP_HSTRY_EVNT_500008 F, TMP_HSTRY_EVNT_500008 L, TMP_HSTRY_KEY_500008 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
   ...
   TRUNCATE TABLE TMP_HSTRY_COPY_EVNT_500008
...
DROP TABLE TMP_HSTRY_COPY_EVNT_500008
