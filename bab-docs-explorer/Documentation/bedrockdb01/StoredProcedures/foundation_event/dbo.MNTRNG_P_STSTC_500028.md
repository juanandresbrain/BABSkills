...
```mermaid
flowchart LR
    SP["dbo.MNTRNG_P_STSTC_500028"]
    EVNT_500028(["EVNT_500028"]) --> SP
    EVNT_STSTC_500028(["EVNT_STSTC_500028"]) --> SP
    ...
    TMP_STSTC_EVNT_500028(["TMP_STSTC_EVNT_500028"]) --> SP
    TMP_STSTC_KEY_500028(["TMP_STSTC_KEY_500028"]) --> SP
```
...
| TMP_STSTC_EVNT_500028 |
| TMP_STSTC_KEY_500028 |

## Stored Procedure Code

```sql
CREATE PROCEDURE [dbo].[MNTRNG_P_STSTC_500028]

@BATCH_SIZE as int --Max number of records in a batch
AS

--Create statistics temporary table to keep computed values per key
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_STSTC_KEY_500028')
   DROP TABLE dbo.TMP_STSTC_KEY_500028

CREATE TABLE dbo.TMP_STSTC_KEY_500028
(
...
CREATE CLUSTERED INDEX TMP_STSTC_KEY_500028_1 ON dbo.TMP_STSTC_KEY_500028 (POST_DTM , KEY_1 , KEY_2 , KEY_3 , KEY_34 , KEY_5 , KEY_7 ) ON [PRIMARY] 
CREATE INDEX TMP_STSTC_KEY_500028_2 ON dbo.TMP_STSTC_KEY_500028 (MIN_ID, MAX_ID) ON [PRIMARY]
...
--Indexes to speed up process 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500028_1 ON dbo.TMP_HSTRY_KEY_500028 (KEY_1 , KEY_2 , KEY_3 , KEY_34 , KEY_5 , KEY_7 ) ON [PRIMARY] 
CREATE INDEX TMP_HSTRY_KEY_500028_2 ON dbo.TMP_HSTRY_KEY_500028 (MIN_ID, MAX_ID) ON [PRIMARY]

--Create temporary event table for statistics
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_STSTC_EVNT_500028')
   DROP TABLE dbo.TMP_STSTC_EVNT_500028

CREATE TABLE dbo.TMP_STSTC_EVNT_500028
(
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_STSTC_EVNT_500028_1 ON dbo.TMP_STSTC_EVNT_500028 (POST_DTM , FLD_1 , FLD_2 , FLD_3 , FLD_34 , FLD_5 , FLD_7 ) ON [PRIMARY] 
CREATE INDEX TMP_STSTC_EVNT_500028_2 ON dbo.TMP_STSTC_EVNT_500028 (ID_CLMN) ON [PRIMARY]
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500028_1 ON dbo.TMP_HSTRY_EVNT_500028 ( FLD_1 , FLD_2 , FLD_3 , FLD_34 , FLD_5 , FLD_7 ) ON [PRIMARY]
CREATE INDEX TMP_HSTRY_EVNT_500028_2 ON dbo.TMP_HSTRY_EVNT_500028 (ID_CLMN) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_HSTRY_EVNT_500028 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , FLD_1 , FLD_2 , FLD_3 , FLD_28 , FLD_35 , FLD_34 , FLD_297 , FLD_279 , FLD_280 , FLD_250 , FLD_251 , FLD_712 , FLD_253 , FLD_255 , FLD_708 , FLD_709 , FLD_710 , FLD_271 , FLD_272 , FLD_273 , FLD_274 , FLD_275 , FLD_276 , FLD_277 , FLD_278 , FLD_259 , FLD_260 , FLD_268 , FLD_261 , FLD_262 , FLD_711 , FLD_466 , FLD_4 , FLD_5 , FLD_7 , FLD_264 , FLD_265 , FLD_440 , FLD_360 , FLD_361 , FLD_30 , FLD_32 , FLD_31 , FLD_33 )
   SELECT EVNT_ID,
   ...
   INSERT TMP_STSTC_KEY_500028 (POST_DTM , KEY_1 , KEY_2 , KEY_3 , KEY_34 , KEY_5 , KEY_7  , FLD_30_SUM , FLD_30_MAX , FLD_32_SUM , FLD_32_MAX , FLD_31_SUM , FLD_31_MAX , FLD_33_SUM , FLD_33_MAX , CNT, MIN_ID, MAX_ID)
   ...
   UPDATE EVNT_STSTC_500028 SET 
          EVNT_STSTC_500028.CNT = s.CNT + te.CNT,
          EVNT_STSTC_500028.LAST_MDFD_DTM = getdate()
          , EVNT_STSTC_500028.FLD_259_LAST = L.FLD_259 
 , EVNT_STSTC_500028.FLD_262_LAST = L.FLD_262 
 , EVNT_STSTC_500028.FLD_30_SUM = s.FLD_30_SUM + te.FLD_30_SUM 
 , EVNT_STSTC_500028.FLD_30_MAX = dbo.GET_MAX(s.FLD_30_MAX, te.FLD_30_MAX) 
 , EVNT_STSTC_500028.FLD_32_SUM = s.FLD_32_SUM + te.FLD_32_SUM 
 , EVNT_STSTC_500028.FLD_32_MAX = dbo.GET_MAX(s.FLD_32_MAX, te.FLD_32_MAX) 
 , EVNT_STSTC_500028.FLD_31_SUM = s.FLD_31_SUM + te.FLD_31_SUM 
 , EVNT_STSTC_500028.FLD_31_MAX = dbo.GET_MAX(s.FLD_31_MAX, te.FLD_31_MAX) 
 , EVNT_STSTC_500028.FLD_33_SUM = s.FLD_33_SUM + te.FLD_33_SUM 
 , EVNT_STSTC_500028.FLD_33_MAX = dbo.GET_MAX(s.FLD_33_MAX, te.FLD_33_MAX) 
 
     FROM TMP_STSTC_KEY_500028 te, EVNT_STSTC_500028 s, TMP_STSTC_EVNT_500028 F, TMP_STSTC_EVNT_500028 L
  ...
  AND s.KEY_7 = te.KEY_7 
   ...
   TRUNCATE TABLE TMP_STSTC_KEY_500028

   --Step 4-Delete temporary events already used to update statistics
   DELETE TMP_STSTC_EVNT_500028
     FROM TMP_STSTC_EVNT_500028 te, EVNT_STSTC_500028 s
  ...
  INSERT EVNT_STSTC_500028 (POST_DTM , KEY_1 , KEY_2 , KEY_3 , KEY_34 , KEY_5 , KEY_7 , CNT , FLD_259_LAST 
 , FLD_262_LAST 
 , FLD_30_SUM , FLD_30_MAX , FLD_32_SUM , FLD_32_MAX , FLD_31_SUM , FLD_31_MAX , FLD_33_SUM , FLD_33_MAX )
   SELECT D.POST_DTM , D.KEY_1 , D.KEY_2 , D.KEY_3 , D.KEY_34 , D.KEY_5 , D.KEY_7 , D.CNT , L.FLD_259 , L.FLD_262 , D.FLD_30_SUM , D.FLD_30_MAX , D.FLD_32_SUM , D.FLD_32_MAX , D.FLD_31_SUM , D.FLD_31_MAX , D.FLD_33_SUM , D.FLD_33_MAX 
     FROM TMP_STSTC_EVNT_500028 F, TMP_STSTC_EVNT_500028 L, TMP_STSTC_KEY_500028 D
   ...
   TRUNCATE TABLE TMP_STSTC_EVNT_500028
   TRUNCATE TABLE TMP_STSTC_KEY_500028
...
DROP TABLE TMP_STSTC_EVNT_500028
DROP TABLE TMP_HSTRY_EVNT_500028
DROP TABLE TMP_STSTC_KEY_500028
