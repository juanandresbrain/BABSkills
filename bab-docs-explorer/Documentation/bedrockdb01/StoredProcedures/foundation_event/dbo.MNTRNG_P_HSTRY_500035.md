...
flowchart LR
    ...
    TMP_HSTRY_COPY_EVNT_500035(["TMP_HSTRY_COPY_EVNT_500035"]) --> SP
...
```sql
CREATE PROCEDURE [dbo].[MNTRNG_P_HSTRY_500035] 

@BATCH_SIZE as int --Max number of records in a batch
AS

--Create temporary event table to keep a copy of the batch
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_HSTRY_COPY_EVNT_500035')
   DROP TABLE dbo.TMP_HSTRY_COPY_EVNT_500035

CREATE TABLE dbo.TMP_HSTRY_COPY_EVNT_500035
(
...
CREATE CLUSTERED INDEX TMP_HSTRY_COPY_EVNT_500035_1 ON dbo.TMP_HSTRY_COPY_EVNT_500035 (ID_CLMN) ON [PRIMARY]
...
CREATE INDEX TMP_HSTRY_EVNT_500035_1 ON dbo.TMP_HSTRY_EVNT_500035 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , FLD_1 , FLD_2 , FLD_3 , FLD_34 , FLD_5 , FLD_7 ) ON [PRIMARY] 
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500035_2 ON dbo.TMP_HSTRY_EVNT_500035 (ID_CLMN) ON [PRIMARY]
...
--Indexes to speed up process
CREATE INDEX TMP_HSTRY_KEY_500035_1 ON dbo.TMP_HSTRY_KEY_500035 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , KEY_1 , KEY_2 , KEY_3 , KEY_34 , KEY_5 , KEY_7 ) ON [PRIMARY] 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500035_2 ON dbo.TMP_HSTRY_KEY_500035 (MIN_ID, MAX_ID) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_HSTRY_COPY_EVNT_500035 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , FLD_1 , FLD_2 , FLD_3 , FLD_28 , FLD_35 , FLD_34 , FLD_251 , FLD_259 , FLD_262 , FLD_466 , FLD_4 , FLD_5 , FLD_7 , FLD_264 , FLD_265 , FLD_360 , FLD_361 , FLD_30 , FLD_32 , FLD_31 , FLD_33 )
   SELECT EVNT_ID,
   ...
   BEGIN
      ...
      INSERT INTO TMP_HSTRY_EVNT_500035 
      SELECT ID_CLMN,
             POST_YEAR,
             POST_MNTH,
             POST_WEEK,
             ...
             POST_DTM 
             , FLD_1 , FLD_2 , FLD_3 , FLD_28 , FLD_35 , FLD_34 , FLD_251 , FLD_259 , FLD_262 , FLD_466 , FLD_4 , FLD_5 , FLD_7 , FLD_264 , FLD_265 , FLD_360 , FLD_361 , FLD_30 , FLD_32 , FLD_31 , FLD_33 
        FROM TMP_HSTRY_COPY_EVNT_500035 
 ...
 , FLD_30_SUM , FLD_30_MAX , FLD_32_SUM , FLD_32_MAX , FLD_31_SUM , FLD_31_MAX , FLD_33_SUM , FLD_33_MAX )
   ...
   TRUNCATE TABLE TMP_HSTRY_COPY_EVNT_500035
...
DROP TABLE TMP_HSTRY_COPY_EVNT_500035
