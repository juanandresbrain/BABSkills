...
CREATE CLUSTERED INDEX TMP_STSTC_KEY_500001_1 ON dbo.TMP_STSTC_KEY_500001 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_1 , KEY_2 , KEY_4 , KEY_5 , KEY_6 , KEY_15 ) ON [PRIMARY] 
...
--Indexes to speed up process 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500001_1 ON dbo.TMP_HSTRY_KEY_500001 (SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_1 , KEY_2 , KEY_4 , KEY_5 , KEY_6 , KEY_15 ) ON [PRIMARY] 
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_STSTC_EVNT_500001_1 ON dbo.TMP_STSTC_EVNT_500001 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 ) ON [PRIMARY] 
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500001_1 ON dbo.TMP_HSTRY_EVNT_500001 ( SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 ) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_STSTC_EVNT_500001 (ID_CLMN, POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 , FLD_16 , FLD_17 , FLD_18 , FLD_19 , FLD_20 , FLD_21 , FLD_22 , FLD_23 , FLD_24 , FLD_25 , FLD_48 , FLD_49 , FLD_50 , FLD_128 , FLD_129 , FLD_700 )
   ...
   INSERT INTO TMP_HSTRY_EVNT_500001 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 , FLD_16 , FLD_17 , FLD_18 , FLD_19 , FLD_20 , FLD_21 , FLD_22 , FLD_23 , FLD_24 , FLD_25 , FLD_48 , FLD_49 , FLD_50 , FLD_128 , FLD_129 , FLD_700 )
   SELECT EVNT_ID,
   ...
   INSERT TMP_STSTC_KEY_500001 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_1 , KEY_2 , KEY_4 , KEY_5 , KEY_6 , KEY_15  , FLD_16_SUM , FLD_16_MIN , FLD_16_MAX , FLD_17_SUM , FLD_17_MIN , FLD_17_MAX , FLD_18_SUM , FLD_18_MIN , FLD_18_MAX , FLD_19_SUM , FLD_19_MIN , FLD_19_MAX , CNT, MIN_ID, MAX_ID)
   SELECT MIN(POST_DTM) , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_4) , MIN(FLD_5) , MIN(FLD_6) , MIN(FLD_15) , SUM(FLD_16) , MIN(FLD_16) , MAX(FLD_16) , SUM(FLD_17) , MIN(FLD_17) , MAX(FLD_17) , SUM(FLD_18) , MIN(FLD_18) , MAX(FLD_18) , SUM(FLD_19) , MIN(FLD_19) , MAX(FLD_19) , COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
     FROM TMP_STSTC_EVNT_500001
    GROUP BY POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 
 ...
 , EVNT_STSTC_500001.FLD_49_LAST = L.FLD_49 
  ...
  INSERT EVNT_STSTC_500001 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_1 , KEY_2 , KEY_4 , KEY_5 , KEY_6 , KEY_15 , CNT , FLD_16_SUM , FLD_16_MIN , FLD_16_MAX , FLD_17_SUM , FLD_17_MIN , FLD_17_MAX , FLD_18_SUM , FLD_18_MIN , FLD_18_MAX , FLD_19_SUM , FLD_19_MIN , FLD_19_MAX , FLD_48_LAST 
 , FLD_49_LAST 
 )
   SELECT D.POST_DTM , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.INSTNC_NUM , D.KEY_1 , D.KEY_2 , D.KEY_4 , D.KEY_5 , D.KEY_6 , D.KEY_15 , D.CNT , D.FLD_16_SUM , D.FLD_16_MIN , D.FLD_16_MAX , D.FLD_17_SUM , D.FLD_17_MIN , D.FLD_17_MAX , D.FLD_18_SUM , D.FLD_18_MIN , D.FLD_18_MAX , D.FLD_19_SUM , D.FLD_19_MIN , D.FLD_19_MAX , L.FLD_48 , L.FLD_49 
 ...
 , FLD_49_LAST 
      ...
      SELECT D.POST_DTM, 0, 0, 0, 0 , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.INSTNC_NUM , D.KEY_1 , D.KEY_2 , D.KEY_4 , D.KEY_5 , D.KEY_6 , D.KEY_15 , D.CNT , D.FLD_16_SUM , D.FLD_16_MIN , D.FLD_16_MAX , D.FLD_17_SUM , D.FLD_17_MIN , D.FLD_17_MAX , D.FLD_18_SUM , D.FLD_18_MIN , D.FLD_18_MAX , D.FLD_19_SUM , D.FLD_19_MIN , D.FLD_19_MAX , L.FLD_48 , L.FLD_49 
