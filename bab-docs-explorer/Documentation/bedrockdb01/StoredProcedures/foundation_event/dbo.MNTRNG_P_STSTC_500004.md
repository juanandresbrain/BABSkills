...
```mermaid
flowchart LR
    SP["dbo.MNTRNG_P_STSTC_500004"]
    EVNT_500004(["EVNT_500004"]) --> SP
    EVNT_STSTC_500004(["EVNT_STSTC_500004"]) --> SP
    ...
    TMP_STSTC_EVNT_500004(["TMP_STSTC_EVNT_500004"]) --> SP
    TMP_STSTC_KEY_500004(["TMP_STSTC_KEY_500004"]) --> SP
```
...
| TMP_STSTC_EVNT_500004 |
| TMP_STSTC_KEY_500004 |

## Stored Procedure Code

```sql
CREATE PROCEDURE [dbo].[MNTRNG_P_STSTC_500004]

@BATCH_SIZE as int --Max number of records in a batch
AS

--Create statistics temporary table to keep computed values per key
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_STSTC_KEY_500004')
   DROP TABLE dbo.TMP_STSTC_KEY_500004

CREATE TABLE dbo.TMP_STSTC_KEY_500004
(
...
CREATE CLUSTERED INDEX TMP_STSTC_KEY_500004_1 ON dbo.TMP_STSTC_KEY_500004 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_1 , KEY_2 , KEY_4 , KEY_5 ) ON [PRIMARY] 
CREATE INDEX TMP_STSTC_KEY_500004_2 ON dbo.TMP_STSTC_KEY_500004 (MIN_ID, MAX_ID) ON [PRIMARY]
...
--Indexes to speed up process 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500004_1 ON dbo.TMP_HSTRY_KEY_500004 (SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_1 , KEY_2 , KEY_4 , KEY_5 ) ON [PRIMARY] 
CREATE INDEX TMP_HSTRY_KEY_500004_2 ON dbo.TMP_HSTRY_KEY_500004 (MIN_ID, MAX_ID) ON [PRIMARY]

--Create temporary event table for statistics
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_STSTC_EVNT_500004')
   DROP TABLE dbo.TMP_STSTC_EVNT_500004

CREATE TABLE dbo.TMP_STSTC_EVNT_500004
(
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_STSTC_EVNT_500004_1 ON dbo.TMP_STSTC_EVNT_500004 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_1 , FLD_2 , FLD_4 , FLD_5 ) ON [PRIMARY] 
CREATE INDEX TMP_STSTC_EVNT_500004_2 ON dbo.TMP_STSTC_EVNT_500004 (ID_CLMN) ON [PRIMARY]
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500004_1 ON dbo.TMP_HSTRY_EVNT_500004 ( SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_1 , FLD_2 , FLD_4 , FLD_5 ) ON [PRIMARY]
CREATE INDEX TMP_HSTRY_EVNT_500004_2 ON dbo.TMP_HSTRY_EVNT_500004 (ID_CLMN) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_STSTC_EVNT_500004 (ID_CLMN, POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_26 , FLD_27 )
   ...
   INSERT INTO TMP_HSTRY_EVNT_500004 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_26 , FLD_27 )
   SELECT EVNT_ID,
   ...
   INSERT TMP_STSTC_KEY_500004 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_1 , KEY_2 , KEY_4 , KEY_5  , FLD_26_SUM , FLD_26_MIN , FLD_26_MAX , FLD_27_SUM , CNT, MIN_ID, MAX_ID)
   SELECT MIN(POST_DTM) , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_4) , MIN(FLD_5) , SUM(FLD_26) , MIN(FLD_26) , MAX(FLD_26) , SUM(FLD_27) , COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
     FROM TMP_STSTC_EVNT_500004
    GROUP BY POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_1 , FLD_2 , FLD_4 , FLD_5 
   ...
   UPDATE EVNT_STSTC_500004 SET 
          EVNT_STSTC_500004.CNT = s.CNT + te.CNT,
          EVNT_STSTC_500004.LAST_MDFD_DTM = getdate()
          , EVNT_STSTC_500004.FLD_26_SUM = s.FLD_26_SUM + te.FLD_26_SUM 
 , EVNT_STSTC_500004.FLD_26_MIN = dbo.GET_MIN(s.FLD_26_MIN, te.FLD_26_MIN) 
 , EVNT_STSTC_500004.FLD_26_MAX = dbo.GET_MAX(s.FLD_26_MAX, te.FLD_26_MAX) 
 , EVNT_STSTC_500004.FLD_27_SUM = s.FLD_27_SUM + te.FLD_27_SUM 
 
     FROM TMP_STSTC_KEY_500004 te, EVNT_STSTC_500004 s, TMP_STSTC_EVNT_500004 F, TMP_STSTC_EVNT_500004 L
  ...
  AND s.KEY_5 = te.KEY_5 
   ...
   TRUNCATE TABLE TMP_STSTC_KEY_500004

   --Step 4-Delete temporary events already used to update statistics
   DELETE TMP_STSTC_EVNT_500004
     FROM TMP_STSTC_EVNT_500004 te, EVNT_STSTC_500004 s
  ...
  INSERT EVNT_STSTC_500004 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , KEY_1 , KEY_2 , KEY_4 , KEY_5 , CNT , FLD_26_SUM , FLD_26_MIN , FLD_26_MAX , FLD_27_SUM )
   SELECT D.POST_DTM , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.INSTNC_NUM , D.KEY_1 , D.KEY_2 , D.KEY_4 , D.KEY_5 , D.CNT , D.FLD_26_SUM , D.FLD_26_MIN , D.FLD_26_MAX , D.FLD_27_SUM 
     FROM TMP_STSTC_EVNT_500004 F, TMP_STSTC_EVNT_500004 L, TMP_STSTC_KEY_500004 D
   ...
   TRUNCATE TABLE TMP_STSTC_EVNT_500004
   TRUNCATE TABLE TMP_STSTC_KEY_500004
   ...
   BEGIN
      ...
      SELECT 0, 0, 0, 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_4) , MIN(FLD_5) , SUM(FLD_26) , MIN(FLD_26) , MAX(FLD_26) , SUM(FLD_27) , '01/01/1900 12:01:00 AM', COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
 ...
 , EVNT_STSTC_HSTRY_500004.FLD_27_SUM = s.FLD_27_SUM + te.FLD_27_SUM 
  ...
  AND s.KEY_5 = te.FLD_5 
      ...
      SELECT D.POST_DTM, 0, 0, 0, 0 , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.INSTNC_NUM , D.KEY_1 , D.KEY_2 , D.KEY_4 , D.KEY_5 , D.CNT , D.FLD_26_SUM , D.FLD_26_MIN , D.FLD_26_MAX , D.FLD_27_SUM 
...
DROP TABLE TMP_STSTC_EVNT_500004
DROP TABLE TMP_HSTRY_EVNT_500004
DROP TABLE TMP_STSTC_KEY_500004
