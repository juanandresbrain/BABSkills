...
```mermaid
flowchart LR
    SP["dbo.MNTRNG_P_STSTC_500007"]
    EVNT_500007(["EVNT_500007"]) --> SP
    EVNT_STSTC_500007(["EVNT_STSTC_500007"]) --> SP
    ...
    TMP_STSTC_EVNT_500007(["TMP_STSTC_EVNT_500007"]) --> SP
    TMP_STSTC_KEY_500007(["TMP_STSTC_KEY_500007"]) --> SP
```
...
| TMP_STSTC_EVNT_500007 |
| TMP_STSTC_KEY_500007 |

## Stored Procedure Code

```sql
CREATE PROCEDURE [dbo].[MNTRNG_P_STSTC_500007]

@BATCH_SIZE as int --Max number of records in a batch
AS

--Create statistics temporary table to keep computed values per key
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_STSTC_KEY_500007')
   DROP TABLE dbo.TMP_STSTC_KEY_500007

CREATE TABLE dbo.TMP_STSTC_KEY_500007
(
...
CREATE CLUSTERED INDEX TMP_STSTC_KEY_500007_1 ON dbo.TMP_STSTC_KEY_500007 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM ) ON [PRIMARY] 
CREATE INDEX TMP_STSTC_KEY_500007_2 ON dbo.TMP_STSTC_KEY_500007 (MIN_ID, MAX_ID) ON [PRIMARY]
...
--Indexes to speed up process 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500007_1 ON dbo.TMP_HSTRY_KEY_500007 (SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM ) ON [PRIMARY] 
CREATE INDEX TMP_HSTRY_KEY_500007_2 ON dbo.TMP_HSTRY_KEY_500007 (MIN_ID, MAX_ID) ON [PRIMARY]

--Create temporary event table for statistics
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_STSTC_EVNT_500007')
   DROP TABLE dbo.TMP_STSTC_EVNT_500007

CREATE TABLE dbo.TMP_STSTC_EVNT_500007
(
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_STSTC_EVNT_500007_1 ON dbo.TMP_STSTC_EVNT_500007 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM ) ON [PRIMARY] 
CREATE INDEX TMP_STSTC_EVNT_500007_2 ON dbo.TMP_STSTC_EVNT_500007 (ID_CLMN) ON [PRIMARY]
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500007_1 ON dbo.TMP_HSTRY_EVNT_500007 ( SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM ) ON [PRIMARY]
CREATE INDEX TMP_HSTRY_EVNT_500007_2 ON dbo.TMP_HSTRY_EVNT_500007 (ID_CLMN) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_STSTC_EVNT_500007 (ID_CLMN, POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_42 , FLD_43 , FLD_44 , FLD_45 , FLD_46 , FLD_300 )
   ...
   INSERT INTO TMP_HSTRY_EVNT_500007 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , FLD_42 , FLD_43 , FLD_44 , FLD_45 , FLD_46 , FLD_300 )
   SELECT EVNT_ID,
   ...
   INSERT TMP_STSTC_KEY_500007 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM  , CNT, MIN_ID, MAX_ID)
   SELECT MIN(POST_DTM) , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
     FROM TMP_STSTC_EVNT_500007
    GROUP BY POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM 
   ...
   UPDATE EVNT_STSTC_500007 SET 
          EVNT_STSTC_500007.CNT = s.CNT + te.CNT,
          EVNT_STSTC_500007.LAST_MDFD_DTM = getdate()
          , EVNT_STSTC_500007.FLD_42_LAST = L.FLD_42 
 
     FROM TMP_STSTC_KEY_500007 te, EVNT_STSTC_500007 s, TMP_STSTC_EVNT_500007 F, TMP_STSTC_EVNT_500007 L
  ...
  AND s.INSTNC_NUM = te.INSTNC_NUM 
   ...
   TRUNCATE TABLE TMP_STSTC_KEY_500007

   --Step 4-Delete temporary events already used to update statistics
   DELETE TMP_STSTC_EVNT_500007
     FROM TMP_STSTC_EVNT_500007 te, EVNT_STSTC_500007 s
  ...
  INSERT EVNT_STSTC_500007 (POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , INSTNC_NUM , CNT , FLD_42_LAST 
 )
   SELECT D.POST_DTM , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.INSTNC_NUM , D.CNT , L.FLD_42 
     FROM TMP_STSTC_EVNT_500007 F, TMP_STSTC_EVNT_500007 L, TMP_STSTC_KEY_500007 D
   ...
   TRUNCATE TABLE TMP_STSTC_EVNT_500007
   TRUNCATE TABLE TMP_STSTC_KEY_500007
   ...
   BEGIN
      ...
      SELECT 0, 0, 0, 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(INSTNC_NUM) , '01/01/1900 12:01:00 AM', COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
  ...
  AND s.INSTNC_NUM = te.INSTNC_NUM 
      ...
      SELECT D.POST_DTM, 0, 0, 0, 0 , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.INSTNC_NUM , D.CNT , L.FLD_42 
...
DROP TABLE TMP_STSTC_EVNT_500007
DROP TABLE TMP_HSTRY_EVNT_500007
DROP TABLE TMP_STSTC_KEY_500007
