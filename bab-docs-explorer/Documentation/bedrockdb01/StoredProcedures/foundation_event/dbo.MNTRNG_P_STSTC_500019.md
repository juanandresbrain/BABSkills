...
```mermaid
flowchart LR
    SP["dbo.MNTRNG_P_STSTC_500019"]
    EVNT_500019(["EVNT_500019"]) --> SP
    EVNT_STSTC_500019(["EVNT_STSTC_500019"]) --> SP
    ...
    TMP_STSTC_EVNT_500019(["TMP_STSTC_EVNT_500019"]) --> SP
    TMP_STSTC_KEY_500019(["TMP_STSTC_KEY_500019"]) --> SP
```
...
| TMP_STSTC_EVNT_500019 |
| TMP_STSTC_KEY_500019 |

## Stored Procedure Code

```sql
CREATE PROCEDURE [dbo].[MNTRNG_P_STSTC_500019]

@BATCH_SIZE as int --Max number of records in a batch
AS

--Create statistics temporary table to keep computed values per key
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_STSTC_KEY_500019')
   DROP TABLE dbo.TMP_STSTC_KEY_500019

CREATE TABLE dbo.TMP_STSTC_KEY_500019
(
...
CREATE CLUSTERED INDEX TMP_STSTC_KEY_500019_1 ON dbo.TMP_STSTC_KEY_500019 (POST_DTM , KEY_102 ) ON [PRIMARY] 
CREATE INDEX TMP_STSTC_KEY_500019_2 ON dbo.TMP_STSTC_KEY_500019 (MIN_ID, MAX_ID) ON [PRIMARY]
...
--Indexes to speed up process 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500019_1 ON dbo.TMP_HSTRY_KEY_500019 (KEY_102 ) ON [PRIMARY] 
CREATE INDEX TMP_HSTRY_KEY_500019_2 ON dbo.TMP_HSTRY_KEY_500019 (MIN_ID, MAX_ID) ON [PRIMARY]

--Create temporary event table for statistics
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_STSTC_EVNT_500019')
   DROP TABLE dbo.TMP_STSTC_EVNT_500019

CREATE TABLE dbo.TMP_STSTC_EVNT_500019
(
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_STSTC_EVNT_500019_1 ON dbo.TMP_STSTC_EVNT_500019 (POST_DTM , FLD_102 ) ON [PRIMARY] 
CREATE INDEX TMP_STSTC_EVNT_500019_2 ON dbo.TMP_STSTC_EVNT_500019 (ID_CLMN) ON [PRIMARY]
...
--Indexes to speed up process
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500019_1 ON dbo.TMP_HSTRY_EVNT_500019 ( FLD_102 ) ON [PRIMARY]
CREATE INDEX TMP_HSTRY_EVNT_500019_2 ON dbo.TMP_HSTRY_EVNT_500019 (ID_CLMN) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_STSTC_EVNT_500019 (ID_CLMN, POST_DTM , FLD_102 , FLD_101 , FLD_103 , FLD_104 , FLD_105 , FLD_119 , FLD_120 , FLD_121 , FLD_70 , FLD_71 )
   ...
   INSERT INTO TMP_HSTRY_EVNT_500019 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , FLD_102 , FLD_101 , FLD_103 , FLD_104 , FLD_105 , FLD_119 , FLD_120 , FLD_121 , FLD_70 , FLD_71 )
   SELECT EVNT_ID,
   ...
   INSERT TMP_STSTC_KEY_500019 (POST_DTM , KEY_102  , CNT, MIN_ID, MAX_ID)
   SELECT MIN(POST_DTM) , MIN(FLD_102) , COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
     FROM TMP_STSTC_EVNT_500019
    GROUP BY POST_DTM , FLD_102 
   ...
   UPDATE EVNT_STSTC_500019 SET 
          EVNT_STSTC_500019.CNT = s.CNT + te.CNT,
          EVNT_STSTC_500019.LAST_MDFD_DTM = getdate()
          , EVNT_STSTC_500019.FLD_103_LAST = L.FLD_103 
 , EVNT_STSTC_500019.FLD_104_LAST = L.FLD_104 
 , EVNT_STSTC_500019.FLD_105_LAST = L.FLD_105 
 , EVNT_STSTC_500019.FLD_119_LAST = L.FLD_119 
 , EVNT_STSTC_500019.FLD_70_LAST = L.FLD_70 
 , EVNT_STSTC_500019.FLD_71_LAST = L.FLD_71 
 
     FROM TMP_STSTC_KEY_500019 te, EVNT_STSTC_500019 s, TMP_STSTC_EVNT_500019 F, TMP_STSTC_EVNT_500019 L
   ...
   TRUNCATE TABLE TMP_STSTC_KEY_500019

   --Step 4-Delete temporary events already used to update statistics
   DELETE TMP_STSTC_EVNT_500019
     FROM TMP_STSTC_EVNT_500019 te, EVNT_STSTC_500019 s
  ...
  INSERT EVNT_STSTC_500019 (POST_DTM , KEY_102 , CNT , FLD_103_LAST 
 , FLD_104_LAST 
 , FLD_105_LAST 
 , FLD_119_LAST 
 ...
 , FLD_71_FRST , FLD_71_LAST 
   ...
   SELECT D.POST_DTM , D.KEY_102 , D.CNT , L.FLD_103 , L.FLD_104 , L.FLD_105 , L.FLD_119 , F.FLD_70 , L.FLD_70 , F.FLD_71 , L.FLD_71 
     FROM TMP_STSTC_EVNT_500019 F, TMP_STSTC_EVNT_500019 L, TMP_STSTC_KEY_500019 D
   ...
   TRUNCATE TABLE TMP_STSTC_EVNT_500019
   TRUNCATE TABLE TMP_STSTC_KEY_500019
   ...
   BEGIN
      ...
      SELECT 0, 0, 0, 0 , MIN(FLD_102) , '01/01/1900 12:01:00 AM', COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
 ...
 , FLD_71_FRST , FLD_71_LAST 
      ...
      SELECT D.POST_DTM, 0, 0, 0, 0 , D.KEY_102 , D.CNT , L.FLD_103 , L.FLD_104 , L.FLD_105 , L.FLD_119 , F.FLD_70 , L.FLD_70 , F.FLD_71 , L.FLD_71 
...
DROP TABLE TMP_STSTC_EVNT_500019
DROP TABLE TMP_HSTRY_EVNT_500019
DROP TABLE TMP_STSTC_KEY_500019
