...
```sql
CREATE PROCEDURE [dbo].[MNTRNG_P_HSTRY_500016] 

@BATCH_SIZE as int --Max number of records in a batch
AS

--Create temporary event table to keep a copy of the batch
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_HSTRY_COPY_EVNT_500016')
   DROP TABLE dbo.TMP_HSTRY_COPY_EVNT_500016

CREATE TABLE dbo.TMP_HSTRY_COPY_EVNT_500016
(
...
CREATE CLUSTERED INDEX TMP_HSTRY_COPY_EVNT_500016_1 ON dbo.TMP_HSTRY_COPY_EVNT_500016 (ID_CLMN) ON [PRIMARY]
...
CREATE INDEX TMP_HSTRY_EVNT_500016_1 ON dbo.TMP_HSTRY_EVNT_500016 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , FLD_85 , FLD_1 , FLD_2 , FLD_90 ) ON [PRIMARY] 
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500016_2 ON dbo.TMP_HSTRY_EVNT_500016 (ID_CLMN) ON [PRIMARY]
...
--Indexes to speed up process
CREATE INDEX TMP_HSTRY_KEY_500016_1 ON dbo.TMP_HSTRY_KEY_500016 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , KEY_85 , KEY_1 , KEY_2 , KEY_90 ) ON [PRIMARY] 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500016_2 ON dbo.TMP_HSTRY_KEY_500016 (MIN_ID, MAX_ID) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_HSTRY_COPY_EVNT_500016 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , FLD_85 , FLD_84 , FLD_86 , FLD_1 , FLD_2 , FLD_467 , FLD_90 , FLD_91 , FLD_92 , FLD_93 , FLD_94 , FLD_95 , FLD_70 , FLD_71 )
   SELECT EVNT_ID,
   ...
   BEGIN
      ...
      INSERT INTO TMP_HSTRY_EVNT_500016 
      SELECT ID_CLMN,
             POST_YEAR,
             POST_MNTH,
             POST_WEEK,
             ...
             POST_DTM 
             , FLD_85 , FLD_84 , FLD_86 , FLD_1 , FLD_2 , FLD_467 , FLD_90 , FLD_91 , FLD_92 , FLD_93 , FLD_94 , FLD_95 , FLD_70 , FLD_71 
        FROM TMP_HSTRY_COPY_EVNT_500016 
 ...
 , FLD_71_FRST , FLD_71_LAST 
      ...
      SELECT D.POST_DTM, D.POST_YEAR, D.POST_MNTH, 0, D.POST_DAY , D.KEY_85 , D.KEY_1 , D.KEY_2 , D.KEY_90 , D.CNT , L.FLD_467 , F.FLD_94 , L.FLD_94 , F.FLD_95 , L.FLD_95 , F.FLD_70 , L.FLD_70 , F.FLD_71 , L.FLD_71 
 ...
 , FLD_71_FRST , FLD_71_LAST 
      ...
      SELECT D.POST_DTM, D.POST_YEAR, 0, D.POST_WEEK, 0 , D.KEY_85 , D.KEY_1 , D.KEY_2 , D.KEY_90 , D.CNT , L.FLD_467 , F.FLD_94 , L.FLD_94 , F.FLD_95 , L.FLD_95 , F.FLD_70 , L.FLD_70 , F.FLD_71 , L.FLD_71 
        FROM TMP_HSTRY_EVNT_500016 F, TMP_HSTRY_EVNT_500016 L, TMP_HSTRY_KEY_500016 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
 ...
 , FLD_71_FRST , FLD_71_LAST 
      ...
      SELECT D.POST_DTM, D.POST_YEAR, D.POST_MNTH, 0, 0 , D.KEY_85 , D.KEY_1 , D.KEY_2 , D.KEY_90 , D.CNT , L.FLD_467 , F.FLD_94 , L.FLD_94 , F.FLD_95 , L.FLD_95 , F.FLD_70 , L.FLD_70 , F.FLD_71 , L.FLD_71 
        FROM TMP_HSTRY_EVNT_500016 F, TMP_HSTRY_EVNT_500016 L, TMP_HSTRY_KEY_500016 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
 ...
 , FLD_71_FRST , FLD_71_LAST 
      ...
      SELECT D.POST_DTM, D.POST_YEAR, 0, 0, 0 , D.KEY_85 , D.KEY_1 , D.KEY_2 , D.KEY_90 , D.CNT , L.FLD_467 , F.FLD_94 , L.FLD_94 , F.FLD_95 , L.FLD_95 , F.FLD_70 , L.FLD_70 , F.FLD_71 , L.FLD_71 
        FROM TMP_HSTRY_EVNT_500016 F, TMP_HSTRY_EVNT_500016 L, TMP_HSTRY_KEY_500016 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
   ...
   TRUNCATE TABLE TMP_HSTRY_COPY_EVNT_500016
...
DROP TABLE TMP_HSTRY_COPY_EVNT_500016
