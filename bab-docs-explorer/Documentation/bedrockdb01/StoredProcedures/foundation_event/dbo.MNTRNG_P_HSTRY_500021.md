...
```sql
CREATE PROCEDURE [dbo].[MNTRNG_P_HSTRY_500021] 

@BATCH_SIZE as int --Max number of records in a batch
AS

--Create temporary event table to keep a copy of the batch
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_HSTRY_COPY_EVNT_500021')
   DROP TABLE dbo.TMP_HSTRY_COPY_EVNT_500021

CREATE TABLE dbo.TMP_HSTRY_COPY_EVNT_500021
(
...
CREATE CLUSTERED INDEX TMP_HSTRY_COPY_EVNT_500021_1 ON dbo.TMP_HSTRY_COPY_EVNT_500021 (ID_CLMN) ON [PRIMARY]
...
CREATE INDEX TMP_HSTRY_EVNT_500021_1 ON dbo.TMP_HSTRY_EVNT_500021 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , FLD_1 , FLD_2 , FLD_3 , FLD_249 ) ON [PRIMARY] 
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500021_2 ON dbo.TMP_HSTRY_EVNT_500021 (ID_CLMN) ON [PRIMARY]
...
--Indexes to speed up process
CREATE INDEX TMP_HSTRY_KEY_500021_1 ON dbo.TMP_HSTRY_KEY_500021 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , KEY_1 , KEY_2 , KEY_3 , KEY_249 ) ON [PRIMARY] 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500021_2 ON dbo.TMP_HSTRY_KEY_500021 (MIN_ID, MAX_ID) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_HSTRY_COPY_EVNT_500021 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , FLD_1 , FLD_2 , FLD_3 , FLD_28 , FLD_249 )
   SELECT EVNT_ID,
   ...
   BEGIN
      ...
      INSERT INTO TMP_HSTRY_EVNT_500021 
      SELECT ID_CLMN,
             POST_YEAR,
             POST_MNTH,
             POST_WEEK,
             ...
             POST_DTM 
             , FLD_1 , FLD_2 , FLD_3 , FLD_28 , FLD_249 
        FROM TMP_HSTRY_COPY_EVNT_500021 
  ...
  AND s.KEY_249 = te.FLD_249 
   ...
   TRUNCATE TABLE TMP_HSTRY_COPY_EVNT_500021
...
DROP TABLE TMP_HSTRY_COPY_EVNT_500021
