...
flowchart LR
    ...
    TMP_HSTRY_COPY_EVNT_500029(["TMP_HSTRY_COPY_EVNT_500029"]) --> SP
...
```sql
CREATE PROCEDURE [dbo].[MNTRNG_P_HSTRY_500029] 

@BATCH_SIZE as int --Max number of records in a batch
AS

--Create temporary event table to keep a copy of the batch
IF EXISTS (SELECT * FROM sysobjects WHERE xtype = 'U' AND name = 'TMP_HSTRY_COPY_EVNT_500029')
   DROP TABLE dbo.TMP_HSTRY_COPY_EVNT_500029

CREATE TABLE dbo.TMP_HSTRY_COPY_EVNT_500029
(
...
CREATE CLUSTERED INDEX TMP_HSTRY_COPY_EVNT_500029_1 ON dbo.TMP_HSTRY_COPY_EVNT_500029 (ID_CLMN) ON [PRIMARY]
...
CREATE INDEX TMP_HSTRY_EVNT_500029_1 ON dbo.TMP_HSTRY_EVNT_500029 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , FLD_1 , FLD_2 , FLD_3 , FLD_34 , FLD_5 , FLD_7 ) ON [PRIMARY] 
CREATE CLUSTERED INDEX TMP_HSTRY_EVNT_500029_2 ON dbo.TMP_HSTRY_EVNT_500029 (ID_CLMN) ON [PRIMARY]
...
--Indexes to speed up process
CREATE INDEX TMP_HSTRY_KEY_500029_1 ON dbo.TMP_HSTRY_KEY_500029 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , KEY_1 , KEY_2 , KEY_3 , KEY_34 , KEY_5 , KEY_7 ) ON [PRIMARY] 
CREATE CLUSTERED INDEX TMP_HSTRY_KEY_500029_2 ON dbo.TMP_HSTRY_KEY_500029 (MIN_ID, MAX_ID) ON [PRIMARY]
...
BEGIN
   ...
   INSERT INTO TMP_HSTRY_COPY_EVNT_500029 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , FLD_1 , FLD_2 , FLD_3 , FLD_28 , FLD_35 , FLD_34 , FLD_251 , FLD_296 , FLD_262 , FLD_466 , FLD_4 , FLD_5 , FLD_7 , FLD_264 , FLD_265 , FLD_360 , FLD_361 , FLD_30 , FLD_32 , FLD_31 , FLD_33 )
   SELECT EVNT_ID,
   ...
   BEGIN
      ...
      INSERT INTO TMP_HSTRY_EVNT_500029 
      SELECT ID_CLMN,
             POST_YEAR,
             POST_MNTH,
             POST_WEEK,
             ...
             POST_DTM 
             , FLD_1 , FLD_2 , FLD_3 , FLD_28 , FLD_35 , FLD_34 , FLD_251 , FLD_296 , FLD_262 , FLD_466 , FLD_4 , FLD_5 , FLD_7 , FLD_264 , FLD_265 , FLD_360 , FLD_361 , FLD_30 , FLD_32 , FLD_31 , FLD_33 
        FROM TMP_HSTRY_COPY_EVNT_500029 
 ...
 , FLD_30_SUM , FLD_30_MAX , FLD_32_SUM , FLD_32_MAX , FLD_31_SUM , FLD_31_MAX , FLD_33_SUM , FLD_33_MAX )
      SELECT D.POST_DTM, D.POST_YEAR, D.POST_MNTH, 0, D.POST_DAY , D.KEY_1 , D.KEY_2 , D.KEY_3 , D.KEY_34 , D.KEY_5 , D.KEY_7 , D.CNT , L.FLD_262 , D.FLD_30_SUM , D.FLD_30_MAX , D.FLD_32_SUM , D.FLD_32_MAX , D.FLD_31_SUM , D.FLD_31_MAX , D.FLD_33_SUM , D.FLD_33_MAX 
 ...
 , EVNT_STSTC_HSTRY_500029.FLD_33_MAX = dbo.GET_MAX(s.FLD_33_MAX, te.FLD_33_MAX) 
  ...
  AND s.KEY_7 = te.FLD_7 
      ...
      INSERT EVNT_STSTC_HSTRY_500029 (POST_DTM, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , KEY_1 , KEY_2 , KEY_3 , KEY_34 , KEY_5 , KEY_7 , CNT , FLD_262_LAST 
 , FLD_30_SUM , FLD_30_MAX , FLD_32_SUM , FLD_32_MAX , FLD_31_SUM , FLD_31_MAX , FLD_33_SUM , FLD_33_MAX )
      SELECT D.POST_DTM, D.POST_YEAR, 0, D.POST_WEEK, 0 , D.KEY_1 , D.KEY_2 , D.KEY_3 , D.KEY_34 , D.KEY_5 , D.KEY_7 , D.CNT , L.FLD_262 , D.FLD_30_SUM , D.FLD_30_MAX , D.FLD_32_SUM , D.FLD_32_MAX , D.FLD_31_SUM , D.FLD_31_MAX , D.FLD_33_SUM , D.FLD_33_MAX 
        FROM TMP_HSTRY_EVNT_500029 F, TMP_HSTRY_EVNT_500029 L, TMP_HSTRY_KEY_500029 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
 ...
 , EVNT_STSTC_HSTRY_500029.FLD_33_MAX = dbo.GET_MAX(s.FLD_33_MAX, te.FLD_33_MAX) 
  ...
  AND s.KEY_7 = te.FLD_7 
      ...
      INSERT EVNT_STSTC_HSTRY_500029 (POST_DTM, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , KEY_1 , KEY_2 , KEY_3 , KEY_34 , KEY_5 , KEY_7 , CNT , FLD_262_LAST 
 , FLD_30_SUM , FLD_30_MAX , FLD_32_SUM , FLD_32_MAX , FLD_31_SUM , FLD_31_MAX , FLD_33_SUM , FLD_33_MAX )
      SELECT D.POST_DTM, D.POST_YEAR, D.POST_MNTH, 0, 0 , D.KEY_1 , D.KEY_2 , D.KEY_3 , D.KEY_34 , D.KEY_5 , D.KEY_7 , D.CNT , L.FLD_262 , D.FLD_30_SUM , D.FLD_30_MAX , D.FLD_32_SUM , D.FLD_32_MAX , D.FLD_31_SUM , D.FLD_31_MAX , D.FLD_33_SUM , D.FLD_33_MAX 
        FROM TMP_HSTRY_EVNT_500029 F, TMP_HSTRY_EVNT_500029 L, TMP_HSTRY_KEY_500029 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
 ...
 , EVNT_STSTC_HSTRY_500029.FLD_33_MAX = dbo.GET_MAX(s.FLD_33_MAX, te.FLD_33_MAX) 
  ...
  AND s.KEY_7 = te.FLD_7 
      ...
      INSERT EVNT_STSTC_HSTRY_500029 (POST_DTM, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , KEY_1 , KEY_2 , KEY_3 , KEY_34 , KEY_5 , KEY_7 , CNT , FLD_262_LAST 
 , FLD_30_SUM , FLD_30_MAX , FLD_32_SUM , FLD_32_MAX , FLD_31_SUM , FLD_31_MAX , FLD_33_SUM , FLD_33_MAX )
      SELECT D.POST_DTM, D.POST_YEAR, 0, 0, 0 , D.KEY_1 , D.KEY_2 , D.KEY_3 , D.KEY_34 , D.KEY_5 , D.KEY_7 , D.CNT , L.FLD_262 , D.FLD_30_SUM , D.FLD_30_MAX , D.FLD_32_SUM , D.FLD_32_MAX , D.FLD_31_SUM , D.FLD_31_MAX , D.FLD_33_SUM , D.FLD_33_MAX 
        FROM TMP_HSTRY_EVNT_500029 F, TMP_HSTRY_EVNT_500029 L, TMP_HSTRY_KEY_500029 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
   ...
   TRUNCATE TABLE TMP_HSTRY_COPY_EVNT_500029
...
DROP TABLE TMP_HSTRY_COPY_EVNT_500029
