...
CREATE INDEX TMP_HSTRY_EVNT_500001_1 ON dbo.TMP_HSTRY_EVNT_500001 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 ) ON [PRIMARY] 
...
--Indexes to speed up process
CREATE INDEX TMP_HSTRY_KEY_500001_1 ON dbo.TMP_HSTRY_KEY_500001 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , KEY_1 , KEY_2 , KEY_4 , KEY_5 , KEY_6 , KEY_15 ) ON [PRIMARY] 
...
BEGIN
   ...
   INSERT INTO TMP_HSTRY_COPY_EVNT_500001 (ID_CLMN, POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY, POST_DTM , SRVR_NAME , APP_ID , PRDCT_ID , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 , FLD_16 , FLD_17 , FLD_18 , FLD_19 , FLD_20 , FLD_21 , FLD_22 , FLD_23 , FLD_24 , FLD_25 , FLD_48 , FLD_49 , FLD_50 , FLD_128 , FLD_129 , FLD_700 )
   SELECT EVNT_ID,
 ...
 , EVNT_STSTC_HSTRY_500001.FLD_49_LAST = L.FLD_49 
  ...
  AND s.KEY_15 = te.FLD_15 
      ...
      SELECT MIN(POST_YEAR), MIN(POST_MNTH), 0, MIN(POST_DAY) , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_4) , MIN(FLD_5) , MIN(FLD_6) , MIN(FLD_15) , SUM(FLD_16) , MIN(FLD_16) , MAX(FLD_16) , SUM(FLD_17) , MIN(FLD_17) , MAX(FLD_17) , SUM(FLD_18) , MIN(FLD_18) , MAX(FLD_18) , SUM(FLD_19) , MIN(FLD_19) , MAX(FLD_19) , MIN(POST_DTM), COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500001
        GROUP BY POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 
 ...
 , FLD_49_LAST 
   ...
   BEGIN
      ...
      --Step 1-Insert computed values from the temp event table
      INSERT TMP_HSTRY_KEY_500001 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , KEY_1 , KEY_2 , KEY_4 , KEY_5 , KEY_6 , KEY_15  , FLD_16_SUM , FLD_16_MIN , FLD_16_MAX , FLD_17_SUM , FLD_17_MIN , FLD_17_MAX , FLD_18_SUM , FLD_18_MIN , FLD_18_MAX , FLD_19_SUM , FLD_19_MIN , FLD_19_MAX , POST_DTM, CNT, MIN_ID, MAX_ID)
      SELECT MIN(POST_YEAR), 0, MIN(POST_WEEK), 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_4) , MIN(FLD_5) , MIN(FLD_6) , MIN(FLD_15) , SUM(FLD_16) , MIN(FLD_16) , MAX(FLD_16) , SUM(FLD_17) , MIN(FLD_17) , MAX(FLD_17) , SUM(FLD_18) , MIN(FLD_18) , MAX(FLD_18) , SUM(FLD_19) , MIN(FLD_19) , MAX(FLD_19) , '01/01/1900 12:01:00 AM', COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500001
        GROUP BY  SRVR_NAME , APP_ID , PRDCT_ID , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 
 ...
 , EVNT_STSTC_HSTRY_500001.FLD_49_LAST = L.FLD_49 
  ...
  AND s.KEY_15 = te.FLD_15 
      ...
      SELECT MIN(POST_YEAR), 0, MIN(POST_WEEK), 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_4) , MIN(FLD_5) , MIN(FLD_6) , MIN(FLD_15) , SUM(FLD_16) , MIN(FLD_16) , MAX(FLD_16) , SUM(FLD_17) , MIN(FLD_17) , MAX(FLD_17) , SUM(FLD_18) , MIN(FLD_18) , MAX(FLD_18) , SUM(FLD_19) , MIN(FLD_19) , MAX(FLD_19) , MIN(DATEADD(dd, DATEPART(dy, POST_DTM) - DATEPART(dw, POST_DTM), DATEADD(mm, -DATEPART(mm, POST_DTM) + 1, DATEADD(dd, -DATEPART(dd, POST_DTM) + 1, POST_DTM)))), COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500001
        GROUP BY POST_YEAR, POST_WEEK , SRVR_NAME , APP_ID , PRDCT_ID , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 
 ...
 , FLD_49_LAST 
      ...
      SELECT D.POST_DTM, D.POST_YEAR, 0, D.POST_WEEK, 0 , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.KEY_1 , D.KEY_2 , D.KEY_4 , D.KEY_5 , D.KEY_6 , D.KEY_15 , D.CNT , D.FLD_16_SUM , D.FLD_16_MIN , D.FLD_16_MAX , D.FLD_17_SUM , D.FLD_17_MIN , D.FLD_17_MAX , D.FLD_18_SUM , D.FLD_18_MIN , D.FLD_18_MAX , D.FLD_19_SUM , D.FLD_19_MIN , D.FLD_19_MAX , L.FLD_48 , L.FLD_49 
        FROM TMP_HSTRY_EVNT_500001 F, TMP_HSTRY_EVNT_500001 L, TMP_HSTRY_KEY_500001 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
   ...
   BEGIN
      ...
      --Step 1-Insert computed values from the temp event table
      INSERT TMP_HSTRY_KEY_500001 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , KEY_1 , KEY_2 , KEY_4 , KEY_5 , KEY_6 , KEY_15  , FLD_16_SUM , FLD_16_MIN , FLD_16_MAX , FLD_17_SUM , FLD_17_MIN , FLD_17_MAX , FLD_18_SUM , FLD_18_MIN , FLD_18_MAX , FLD_19_SUM , FLD_19_MIN , FLD_19_MAX , POST_DTM, CNT, MIN_ID, MAX_ID)
      SELECT MIN(POST_YEAR), MIN(POST_MNTH), 0, 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_4) , MIN(FLD_5) , MIN(FLD_6) , MIN(FLD_15) , SUM(FLD_16) , MIN(FLD_16) , MAX(FLD_16) , SUM(FLD_17) , MIN(FLD_17) , MAX(FLD_17) , SUM(FLD_18) , MIN(FLD_18) , MAX(FLD_18) , SUM(FLD_19) , MIN(FLD_19) , MAX(FLD_19) , '01/01/1900 12:01:00 AM', COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500001
        GROUP BY  SRVR_NAME , APP_ID , PRDCT_ID , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 
 ...
 , EVNT_STSTC_HSTRY_500001.FLD_49_LAST = L.FLD_49 
  ...
  AND s.KEY_15 = te.FLD_15 
      ...
      SELECT MIN(POST_YEAR), MIN(POST_MNTH), 0, 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_4) , MIN(FLD_5) , MIN(FLD_6) , MIN(FLD_15) , SUM(FLD_16) , MIN(FLD_16) , MAX(FLD_16) , SUM(FLD_17) , MIN(FLD_17) , MAX(FLD_17) , SUM(FLD_18) , MIN(FLD_18) , MAX(FLD_18) , SUM(FLD_19) , MIN(FLD_19) , MAX(FLD_19) , MIN(DATEADD(dd, -DATEPART(dd, POST_DTM)+1, POST_DTM)), COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500001
        GROUP BY POST_YEAR, POST_MNTH , SRVR_NAME , APP_ID , PRDCT_ID , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 
 ...
 , FLD_49_LAST 
      ...
      SELECT D.POST_DTM, D.POST_YEAR, D.POST_MNTH, 0, 0 , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.KEY_1 , D.KEY_2 , D.KEY_4 , D.KEY_5 , D.KEY_6 , D.KEY_15 , D.CNT , D.FLD_16_SUM , D.FLD_16_MIN , D.FLD_16_MAX , D.FLD_17_SUM , D.FLD_17_MIN , D.FLD_17_MAX , D.FLD_18_SUM , D.FLD_18_MIN , D.FLD_18_MAX , D.FLD_19_SUM , D.FLD_19_MIN , D.FLD_19_MAX , L.FLD_48 , L.FLD_49 
        FROM TMP_HSTRY_EVNT_500001 F, TMP_HSTRY_EVNT_500001 L, TMP_HSTRY_KEY_500001 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
   ...
   BEGIN
      ...
      --Step 1-Insert computed values from the temp event table
      INSERT TMP_HSTRY_KEY_500001 (POST_YEAR, POST_MNTH, POST_WEEK, POST_DAY , SRVR_NAME , APP_ID , PRDCT_ID , KEY_1 , KEY_2 , KEY_4 , KEY_5 , KEY_6 , KEY_15  , FLD_16_SUM , FLD_16_MIN , FLD_16_MAX , FLD_17_SUM , FLD_17_MIN , FLD_17_MAX , FLD_18_SUM , FLD_18_MIN , FLD_18_MAX , FLD_19_SUM , FLD_19_MIN , FLD_19_MAX , POST_DTM, CNT, MIN_ID, MAX_ID)
      SELECT MIN(POST_YEAR), 0, 0, 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_4) , MIN(FLD_5) , MIN(FLD_6) , MIN(FLD_15) , SUM(FLD_16) , MIN(FLD_16) , MAX(FLD_16) , SUM(FLD_17) , MIN(FLD_17) , MAX(FLD_17) , SUM(FLD_18) , MIN(FLD_18) , MAX(FLD_18) , SUM(FLD_19) , MIN(FLD_19) , MAX(FLD_19) , '01/01/1900 12:01:00 AM', COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500001
        GROUP BY  SRVR_NAME , APP_ID , PRDCT_ID , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 
 ...
 , EVNT_STSTC_HSTRY_500001.FLD_49_LAST = L.FLD_49 
  ...
  AND s.KEY_15 = te.FLD_15 
      ...
      SELECT MIN(POST_YEAR), 0, 0, 0 , MIN(SRVR_NAME) , MIN(APP_ID) , MIN(PRDCT_ID) , MIN(FLD_1) , MIN(FLD_2) , MIN(FLD_4) , MIN(FLD_5) , MIN(FLD_6) , MIN(FLD_15) , SUM(FLD_16) , MIN(FLD_16) , MAX(FLD_16) , SUM(FLD_17) , MIN(FLD_17) , MAX(FLD_17) , SUM(FLD_18) , MIN(FLD_18) , MAX(FLD_18) , SUM(FLD_19) , MIN(FLD_19) , MAX(FLD_19) , MIN(DATEADD(mm, -DATEPART(mm, POST_DTM)+1, DATEADD(dd, -DATEPART(dd, POST_DTM)+1, POST_DTM))), COUNT(*), MIN(ID_CLMN), MAX(ID_CLMN)
        FROM TMP_HSTRY_EVNT_500001
        GROUP BY POST_YEAR , SRVR_NAME , APP_ID , PRDCT_ID , FLD_1 , FLD_2 , FLD_4 , FLD_5 , FLD_6 , FLD_15 
 ...
 , FLD_49_LAST 
      ...
      SELECT D.POST_DTM, D.POST_YEAR, 0, 0, 0 , D.SRVR_NAME , D.APP_ID , D.PRDCT_ID , D.KEY_1 , D.KEY_2 , D.KEY_4 , D.KEY_5 , D.KEY_6 , D.KEY_15 , D.CNT , D.FLD_16_SUM , D.FLD_16_MIN , D.FLD_16_MAX , D.FLD_17_SUM , D.FLD_17_MIN , D.FLD_17_MAX , D.FLD_18_SUM , D.FLD_18_MIN , D.FLD_18_MAX , D.FLD_19_SUM , D.FLD_19_MIN , D.FLD_19_MAX , L.FLD_48 , L.FLD_49 
        FROM TMP_HSTRY_EVNT_500001 F, TMP_HSTRY_EVNT_500001 L, TMP_HSTRY_KEY_500001 D
       WHERE D.MIN_ID = F.ID_CLMN 
         AND D.MAX_ID = L.ID_CLMN
