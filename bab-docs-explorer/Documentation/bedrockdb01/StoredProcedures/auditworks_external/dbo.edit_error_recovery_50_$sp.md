# dbo.edit_error_recovery_50_$sp
...
```mermaid
flowchart LR
    SP["dbo.edit_error_recovery_50_$sp"]
...
```sql
create proc [dbo].[edit_error_recovery_50_$sp] 
...
/* Author: Paul S. , last modified by Andrew V. on 1998/11/20 */
...
SELECT @violated_sareject_rule = 50,
	@translate_msg = 'Duplicate lines from the translate were skipped by the edit for transaction lines',
	@process_name = 'edit_error_recovery_50_$sp',
        @message_id = 201068
...
WHILE 1=1
  ...
  IF @errno != 0
    BEGIN
     SELECT @errmsg = 'Failed to delete duplicate rows from transl_transaction_line',
