...
SELECT	@interface_id = 53, -- change this
	@from_transaction_date = '07/23/2000', -- starting date
	@to_transaction_date = '08/23/2000', -- ending date or = getdate() if all
...
DECLARE reprocess_trans CURSOR FAST_FORWARD
  FOR
    SELECT DISTINCT ah.av_transaction_id
      FROM av_transaction_header ah WITH (NOLOCK), av_interface_control ic
