...
Apr19,04 Maryam   DV-1071 Modified to pass in @user_name and @process_id which was an output parameter.
                          modified the call to common_error_handling to pass these two variables.
