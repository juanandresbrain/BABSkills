...
DATE		NAME	DEF	DESC
Mar26,12        Vicci   XPRESS  remove clear text default password and don't create logins if it is not passed (since TPLs now install with only one login this proc is no longer really required).
