...
29-Apr-04       Maryam         DV-1071  Change @process_id from int to binary(16). Receive 
					@user_name and pass both variables to common_error_handling_$sp.
25-Apr-02 	Phu	       1-C9P5S  Delete transactions in if_tax_detail table
26-Nov-01 	Winnie	       1-969YY  Add logic for R3 error handling
16-Jul-99	Daphna		5026	author
