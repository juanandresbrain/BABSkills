...
27-Sep-04  David   DV-1146   Use user_id instead of user_name.
19-Jul-04  ShuZ    DV-1071   Expand user_name to nvarchar(50)
22-Apr-04  Maryam  DV-1071   change the datatype of @process_id to be binary(16) and pass
                             @process_id and @user_name to the sub procs.
17-Jan-03  ShuZ    1-HZ3U2   Change double quote to single quote
19-Apr-02  ShuZ    1-CD0IX   Standardize  R3.5 Common error handling
24-Apr-00  Daphna     6093   reorganize logic so that no work done if store not locked     
16-Mar-99  Vicci      ??     last modified
09-Jan-97  Seb        n/a    author
*/
