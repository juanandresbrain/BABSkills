# dbo.edit_error_recovery_48_$sp
...
```mermaid
flowchart LR
    SP["dbo.edit_error_recovery_48_$sp"]
...
```sql
create proc [dbo].[edit_error_recovery_48_$sp] 
...
/* Description: To ignore duplicate lines ( caused by translate error ) and recover
   the rest of the transactions in the batch. Called by edit_error_recovery_$sp.
...
Jan07/99 Henry		5868  	To prevent the cleanup of tax-lines with different tax_levels.   
...
SELECT @violated_sareject_rule = 48,
	@translate_msg = 'Duplicate lines from the translate were skipped by the edit for tax override details',
	@process_name = 'edit_error_recovery_48_$sp',
        @message_id = 201068
...
WHILE 1=1
  ...
  IF @errno != 0
    BEGIN
     SELECT @errmsg = 'Failed to delete duplicate rows from transl_tax_override_detail',
