...
```sql
create proc [dbo].[cust_liab_export_$sp] @process_no	tinyint
...
HISTORY
Date      Name         Def#  Desc
Apr08,05  Maryam    1-1BG37K move truncate of work_voucher to the begining of the proc.
...
/* export to Separate Server a  header row with clean date and export-to-offline flag 
  ...
  */
  ...
  -- DEF 1-CYE1P: convert @clean_date to varchar
