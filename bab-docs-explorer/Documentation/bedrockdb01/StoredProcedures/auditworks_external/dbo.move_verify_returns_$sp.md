...
```sql
create proc [dbo].[move_verify_returns_$sp] 
@store_check			tinyint, -- 0:no validation, 1:validate return_detail.return_from_store, 2:stock_control_detail.other_store_no, 3:both
