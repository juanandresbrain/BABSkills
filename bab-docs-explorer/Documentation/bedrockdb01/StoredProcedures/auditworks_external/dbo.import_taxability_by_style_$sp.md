          ...
          IF @errno != 0
            BEGIN
              SELECT @errmsg = 'Failed to INSERT newly imported exceptions for store_no = ' +
				...
				', style_reference_id = ' + convert(nvarchar, @style_reference_id) + ', tax_level = ' + convert(nvarchar, @tax_level)+
				...
				+ CONVERT(nvarchar(11), @effective_from_date)+' into the taxability_by_style table ',
		     @object_name = 'taxability_by_style',
