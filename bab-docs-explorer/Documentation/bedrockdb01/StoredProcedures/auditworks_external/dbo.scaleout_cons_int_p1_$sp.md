...
SELECT @trace_msg = nchar(13) + nchar(10) + ':LOG && scaleout_cons_int_p1_$sp starts: ' + convert(nchar, @start_datetime, 8)
PRINT @trace_msg
...
SELECT @trace_msg = nchar(13) + nchar(10) + ':LOG && scaleout_cons_int_p1_$sp ends: ' + convert(nchar, getdate(), 8)
PRINT @trace_msg
