...
Apr20,04 Maryam      DV-1071 Modified to receive @user_name and @process_id as input parameters and 
 			     pass it to the sub procs. change the datatype of bit to tinyint,
