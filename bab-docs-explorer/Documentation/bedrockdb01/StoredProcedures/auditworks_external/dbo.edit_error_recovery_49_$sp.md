# dbo.edit_error_recovery_49_$sp
...
```mermaid
flowchart LR
    SP["dbo.edit_error_recovery_49_$sp"]
...
```sql
create proc [dbo].[edit_error_recovery_49_$sp] 
...
SELECT @violated_sareject_rule = 49,
	@translate_msg = 'Duplicate lines from the translate were skipped by the edit for returns',
	@process_name = 'edit_error_recovery_49_$sp',
        @message_id = 201068
...
/* close cursor */
  ...
  IF @errno != 0
    BEGIN
     SELECT @errmsg = 'Failed to delete duplicate rows from transl_return_detail',
