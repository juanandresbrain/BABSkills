...
```sql
create proc dbo.move_store_$sp @process_id             binary(16),
@user_id                int,
@from_store_no		int,
...
@transaction_series     nchar(1) = ' '   /* frontend should not pass a NULL, always blank as of SA5 */,
...
BEGIN
  ...
  BEGIN
   IF (@from_register_no = -1)
	...
	@to_cashier_no, @to_till_no, @errmsg4 OUTPUT,
