...
BEGIN
  ...
  SELECT
    ...
    + '<DOCAMNT>' + convert(nvarchar, convert(numeric(12,2),ABS(l.gross_line_amount - l.pos_discount_amount))) + '</DOCAMNT>'
    + '<SLSAMNT>' + convert(nvarchar, convert(numeric(12,2),ABS(l.gross_line_amount - l.pos_discount_amount))) + '</SLSAMNT>'
