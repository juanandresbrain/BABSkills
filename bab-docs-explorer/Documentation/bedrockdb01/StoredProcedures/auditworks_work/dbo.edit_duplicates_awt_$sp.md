...
```mermaid
flowchart LR
    SP["dbo.edit_duplicates_awt_$sp"]
...
```sql
create proc dbo.edit_duplicates_awt_$sp 
...
IF (@violated_sareject_rule = 50 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_transaction_line
      FROM awt_transaction_line al, #work_lines_edit we
...
IF (@violated_sareject_rule = 41 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_merchandise_detail
      FROM awt_merchandise_detail am, #work_lines_edit we
...
IF (@violated_sareject_rule = 42 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_authorization_detail
      FROM awt_authorization_detail ad, #work_lines_edit we
...
IF (@violated_sareject_rule = 43 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_stock_control_detail
      FROM awt_stock_control_detail ac, #work_lines_edit we
...
IF (@violated_sareject_rule = 44 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_special_order_detail
      FROM awt_special_order_detail ao, #work_lines_edit we
...
IF (@violated_sareject_rule = 45 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_post_void_detail
      FROM awt_post_void_detail ap, #work_lines_edit we
...
IF (@violated_sareject_rule = 46 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_payroll_detail
      FROM awt_payroll_detail ay, #work_lines_edit we
...
IF (@violated_sareject_rule = 48 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_tax_override_detail
      FROM awt_tax_override_detail ax, #work_lines_edit we
...
IF (@violated_sareject_rule = 49 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_return_detail
      FROM awt_return_detail ar, #work_lines_edit we
...
IF (@violated_sareject_rule = 51 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_customer
      FROM awt_customer ac, #work_lines_edit we
     WHERE ac.store_no = we.store_no
       AND ac.register_no = we.register_no
       AND ac.entry_date_time = we.entry_date_time
       AND ac.transaction_series = we.transaction_series
...
IF (@violated_sareject_rule = 52 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_customer_detail
      FROM awt_customer_detail ai, #work_lines_edit we
...
IF (@violated_sareject_rule = 53 OR @violated_sareject_rule = -1)
  BEGIN
    DELETE awt_line_note
      FROM awt_line_note an, #work_lines_edit we
...
error:
	...
	SELECT @errmsg = 'edit_duplicates_awt_$sp: ' + @errmsg
