...
flowchart LR
    ...
    backupfile(["backupfile"]) --> SP
    backupmediafamily(["backupmediafamily"]) --> SP
    backupmediaset(["backupmediaset"]) --> SP
    backupset(["backupset"]) --> SP
    restorefile(["restorefile"]) --> SP
    restorefilegroup(["restorefilegroup"]) --> SP
    restorehistory(["restorehistory"]) --> SP
```
