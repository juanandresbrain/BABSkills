...
DECLARE
	...
	@discount_total			line_amount_18_4,
	@errno 				int,
...
CREATE TABLE #work_discounts(store_no int not null,
	                     ...
	                     tot_discount_amount NUMERIC(18,4) not null);
...
CREATE TABLE #tender_totals(transaction_id numeric(14,0) not null, -- tran_id_datatype
                            tender_total NUMERIC(18,4) not null);
...
CREATE TABLE #discount_totals(
	...
	disc_line_amt NUMERIC(18,4) not null,
	disc_detail_amt NUMERIC(18,4) not null,
...
BEGIN
  ...
  BEGIN
	...
	UPDATE work_merchandise_edit
	   SET net_line_amount = CONVERT(NUMERIC(18,4),(tl.gross_line_amount - tl.pos_discount_amount))
