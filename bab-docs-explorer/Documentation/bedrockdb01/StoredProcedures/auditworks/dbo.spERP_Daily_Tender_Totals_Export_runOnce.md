# dbo.spERP_Daily_Tender_Totals_Export_runOnce
...
```mermaid
flowchart LR
    SP["dbo.spERP_Daily_Tender_Totals_Export_runOnce"]
...
```sql
CREATE procedure [dbo].[spERP_Daily_Tender_Totals_Export_runOnce]
--(
...
SET @TransactionStartDate = DATEDIFF(DAY, '10/13/2023', GETDATE())  --<< SET START DATE
SET @TransactionEndDate = DATEDIFF(DAY, '10/14/2023', GETDATE())  --<< SET END DATE
...
SET @ERPFilePath = '\\stl-dynsnc-p-01\GeneralJournal\resubmit'  --<< PROD ERP file destination path

--SET @Recipients = 'paulb@buildabear.com'
SET @Recipients = 'ianw@buildabear.com;ianw@buildabear.com'
...
SET @Copy_Recipients = 'ianw@buildabear.com;ianw@buildabear.com'
