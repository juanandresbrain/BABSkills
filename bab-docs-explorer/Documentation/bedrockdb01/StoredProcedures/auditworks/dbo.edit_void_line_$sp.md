...
Dec16,14 Paul      TFS-94103 use try catch, add @transaction_no to cursor
Aug14,14 Phu           80984 To avoid voiding reversal on a different line.
