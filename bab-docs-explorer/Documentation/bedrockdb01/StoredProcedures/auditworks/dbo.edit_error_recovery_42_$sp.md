# dbo.edit_error_recovery_42_$sp
...
```mermaid
flowchart LR
    SP["dbo.edit_error_recovery_42_$sp"]
...
```sql
create proc dbo.edit_error_recovery_42_$sp 
...
SELECT @violated_sareject_rule = 42,
       @translate_msg = 'Duplicate lines from the translate were skipped by the edit for authorization details',
       @process_name = 'edit_error_recovery_42_$sp',
       @message_id = 201068
...
WHILE 1=1
  ...
  IF @errno != 0
    BEGIN
     SELECT @errmsg = 'Failed to delete from transl_authorization_detail',
