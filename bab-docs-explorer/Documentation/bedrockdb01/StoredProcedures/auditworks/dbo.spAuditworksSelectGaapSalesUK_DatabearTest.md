# dbo.spAuditworksSelectGaapSalesUK_DatabearTest
...
```mermaid
flowchart LR
    SP["dbo.spAuditworksSelectGaapSalesUK_DatabearTest"]
...
```sql
CREATE proc [dbo].[spAuditworksSelectGaapSalesUK_DatabearTest]
as
...
-- exec spAuditworksSelectGaapSalesUK_DatabearTest
-- =============================================================================================================
set nocount on
...
select * from #UKGaapSalesAW return
