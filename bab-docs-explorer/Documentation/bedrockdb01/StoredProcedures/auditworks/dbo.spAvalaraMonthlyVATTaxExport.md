# dbo.spAvalaraMonthlyVATTaxExport
...
```mermaid
flowchart LR
    SP["dbo.spAvalaraMonthlyVATTaxExport"]
...
```sql
CREATE procedure [dbo].[spAvalaraMonthlyVATTaxExport]
...
--SET @TransactionStartDate = '2024-04-30'
--SET @TransactionEndDate = '2024-05-04'
