# dbo.util_repop_if_tables_curr_md_$sp
...
```mermaid
flowchart LR
    SP["dbo.util_repop_if_tables_curr_md_$sp"]
...
```sql
CREATE proc [dbo].[util_repop_if_tables_curr_md_$sp]
