...
BEGIN
  ...
  SELECT 'Transactions Processed : ' + convert(varchar,@session_tran_count) + 
         '  Transactions/hour : ' + convert(char(10), @session_per_hour) 
...
SELECT 'Overall Edit (transactions/hour) : ' + convert(char(7),@overall)
