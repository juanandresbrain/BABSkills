# dbo.spDW_DetermineTransactionsToPull_DynamicsBACKUP20230328
...
```mermaid
flowchart LR
    SP["dbo.spDW_DetermineTransactionsToPull_DynamicsBACKUP20230328"]
...
```sql
CREATE PROCEDURE [dbo].[spDW_DetermineTransactionsToPull_DynamicsBACKUP20230328]
