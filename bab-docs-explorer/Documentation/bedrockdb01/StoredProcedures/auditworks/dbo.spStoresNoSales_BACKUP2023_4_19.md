# dbo.spStoresNoSales_BACKUP2023_4_19
...
```mermaid
flowchart LR
    SP["dbo.spStoresNoSales_BACKUP2023_4_19"]
...
```sql
create procedure [dbo].[spStoresNoSales_BACKUP2023_4_19]
-- =====================================================================================================
...
set @recipients = 'poll@buildabear.com;EntSysSupport@buildabear.com'
--set @alertrecipients = 'EnterpriseSystemsAlerts@buildabear.com;poll@buildabear.com;EntSysSupport@buildabear.com'
set @alertrecipients = 'poll@buildabear.com;EntSysSupport@buildabear.com'
IF @DaysBack = '1' SET @alertrecipients = 'poll@buildabear.com;EntSysSupport@buildabear.com'

--set @recipients = 'paulb@buildabear.com'
--set @alertrecipients = 'paulb@buildabear.com;3142391415@txt.att.net'
