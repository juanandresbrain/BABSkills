...
```sql
CREATE PROC [dbo].[usp_GAAPSales_CDN]
-- =============================================================================================================
-- Name: [dbo].[usp_GAAPSales_CDN]  
--
-- Description:	
...
--                        )
    ...
    WHERE   c.gl_company IN ( 300 ) -- CDN stores only
