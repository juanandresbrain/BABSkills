# dbo.spAvalaraMonthlyVATTaxExport_dev
...
```mermaid
flowchart LR
    SP["dbo.spAvalaraMonthlyVATTaxExport_dev"]
...
```sql
CREATE procedure [dbo].[spAvalaraMonthlyVATTaxExport_dev]
...
--SELECT '2021-07-04' AS STRT_DATE_TIME
--	,'2021-07-31' AS END_DATE_TIME
--INTO ##StartJobCheck
...
AND (SELECT COUNT(*)
		...
		AND CONVERT(VARCHAR(10), process_end_time, 120) = CONVERT(VARCHAR(10), GETDATE()-23, 120)) = 1  ----- REMOVE -23!
AND (SELECT COUNT(*)
...
--SET @TransactionStartDate = '2021-07-04'
--SET @TransactionEndDate = '2021-07-31'
...
--SET @AvalaraFilePath = '\\stl-avaldb-t-01\Inbox'  --<< PROD Avalara file destination path
...
join	BEDROCKDB02.me_01.dbo.calendar_date cd on tsr.TransactionDate = cd.calendar_date
WHERE 1=1 -- tsr.CustomerCountry = @cntrycode
...
SET @ChkFileCMD = 'dir /B ' + @ChkFileDrive +  + ' ' + @AvalaraFilePath + 'AVALARA_VAT_EXPORT_GB_*' + @FileDate + '*.multitxt' 
