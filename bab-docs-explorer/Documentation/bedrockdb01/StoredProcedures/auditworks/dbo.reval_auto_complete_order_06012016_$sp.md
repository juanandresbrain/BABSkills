# dbo.reval_auto_complete_order_06012016_$sp
...
```mermaid
flowchart LR
    SP["dbo.reval_auto_complete_order_06012016_$sp"]
...
```sql
create proc [dbo].[reval_auto_complete_order_06012016_$sp] AS 
/* 
...
DECLARE
  ...
  @rows				int,
  @units			unit_datatype,
  @auto_complete_transaction_id numeric(12,0),
...
CREATE TABLE #merge_auto_complete_line (
       ...
       auto_complete_transaction_id numeric(12,0) not null,
