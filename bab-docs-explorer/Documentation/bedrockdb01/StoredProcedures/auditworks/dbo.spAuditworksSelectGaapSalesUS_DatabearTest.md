# dbo.spAuditworksSelectGaapSalesUS_DatabearTest
...
```mermaid
flowchart LR
    SP["dbo.spAuditworksSelectGaapSalesUS_DatabearTest"]
...
```sql
CREATE PROC [dbo].[spAuditworksSelectGaapSalesUS_DatabearTest]
as
-- =============================================================================================================
...
-- exec [dbo].[spAuditworksSelectGaapSalesUS_DatabearTest]
-- =============================================================================================================
...
select * from #USGaapSalesAW return
