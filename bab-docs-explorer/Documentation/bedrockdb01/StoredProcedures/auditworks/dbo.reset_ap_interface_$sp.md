...
```sql
create proc dbo.reset_ap_interface_$sp 
...
/* Proc name:   reset_ap_interface_$sp
** Description: Reset retrieval_in_progress flag to signal that the basic
**              A/P interface file has been completed. Called by
...
SELECT	@process_name = 'reset_ap_interface_$sp',
        @message_id = 201068
