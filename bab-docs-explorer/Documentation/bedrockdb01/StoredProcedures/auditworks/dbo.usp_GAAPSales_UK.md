...
```sql
CREATE PROC [dbo].[usp_GAAPSales_UK]
-- =============================================================================================================
-- Name: [dbo].[usp_GAAPSales_UK]  
--
-- Description:	
...
-- exec usp_GAAPSales_UK
-- =============================================================================================================
AS 
    IF ( OBJECT_ID('tempdb..#GAAPSales_UK') IS NOT NULL ) 
        DROP TABLE #GAAPSales_UK
    SELECT  c.store_no,
            c.store_name,
...
--                        )
    ...
    WHERE   c.gl_company IN ( 700, 2101, 2102) -- UK stores only
...
--CALCULATE TOTAL VAT FOR STORES' SALES
    ...
    WHERE   ( h.transaction_date BETWEEN CONVERT(CHAR, GETDATE(), 101)
            ...
            AND gl_company IN ( 700, 2101, 2102)-- UK stores only
