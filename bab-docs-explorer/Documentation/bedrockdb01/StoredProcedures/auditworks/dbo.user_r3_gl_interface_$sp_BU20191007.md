# dbo.user_r3_gl_interface_$sp_BU20191007
...
```mermaid
flowchart LR
    SP["dbo.user_r3_gl_interface_$sp_BU20191007"]
...
```sql
CREATE proc  [dbo].[user_r3_gl_interface_$sp_BU20191007] 
...
SELECT
	...
	@min_seq_offset = 1,
	@message_id = 201068,
	@process_name = 'user_r3_gl_interface_$sp_BU20191007',
	@filler = Space(255),
