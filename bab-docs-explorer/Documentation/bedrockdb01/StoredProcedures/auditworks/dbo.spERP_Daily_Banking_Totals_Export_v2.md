# dbo.spERP_Daily_Banking_Totals_Export_v2
...
```mermaid
flowchart LR
    SP["dbo.spERP_Daily_Banking_Totals_Export_v2"]
...
```sql
CREATE procedure [dbo].[spERP_Daily_Banking_Totals_Export_v2]
...
--SET @TransactionStartDate = 16
--SET @TransactionEndDate = 15
