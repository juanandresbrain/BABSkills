# dbo.spAvalaraMonthlyVATTaxExport_dev_052021
...
```mermaid
flowchart LR
    SP["dbo.spAvalaraMonthlyVATTaxExport_dev_052021"]
...
```sql
create procedure [dbo].[spAvalaraMonthlyVATTaxExport_dev_052021]
...
--SET @TransactionStartDate = '2020-01-05'
--SET @TransactionEndDate = '2020-02-01'
...
AND		th.transaction_date BETWEEN '2020-10-04' and '2021-01-02' --@TransactionStartDate AND @TransactionEndDate
