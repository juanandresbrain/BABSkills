# dbo.spAvalaraMonthySalesTaxExport_BU20200512
...
```mermaid
flowchart LR
    SP["dbo.spAvalaraMonthySalesTaxExport_BU20200512"]
...
```sql
CREATE   procedure [dbo].[spAvalaraMonthySalesTaxExport_BU20200512]
...
--		Keith Lee			05/06/2020		Added code to exclude registers 52-57 for BOSFS transactions
-- 
...
--SELECT '2020-05-01' AS STRT_DATE_TIME
--	,'2020-05-05' AS END_DATE_TIME
--INTO ##StartJobCheck
...
AND		th.register_no not between 52 and 57  -- 52 = Web Reg 2 (default sales), 53 = Web Reg 3 (PayPal), 56 = Web Reg 6 (Amazon), 57 = Web 7 (refunds/returns)
