# dbo.spAvalaraMonthlyVATTaxExport_IDW_2024
...
```mermaid
flowchart LR
    SP["dbo.spAvalaraMonthlyVATTaxExport_IDW_2024"]
...
```sql
CREATE procedure [dbo].[spAvalaraMonthlyVATTaxExport_IDW_2024]
...
SET @TransactionStartDate = '2024-03-03'
SET @TransactionEndDate = '2024-04-06'
...
select * from ##TaxSummaryResults --where InvoiceNumber = 'R2017202309030200002390'
