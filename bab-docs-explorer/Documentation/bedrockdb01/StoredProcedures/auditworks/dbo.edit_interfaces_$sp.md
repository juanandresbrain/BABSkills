...
Dec19,16 Serguei DAOM-1856 retrofit from Oracle: Bug in Edit Interfaces which causes the UPC revalidation not to kick in for non-pre/post-audit interfaces
...
SELECT
	...
	upc_on_file_flag,
	pos_deptclass,
	CONVERT(NUMERIC(18,4),gross_line_amount / units),   -- DEF 1-BM501
	CONVERT(NUMERIC(18,4), net_line_amount / units),   -- DEF 1-BM501
	CONVERT(NUMERIC(18,4), plu_amount / units),   -- DEF 1-BM501
	scanned,
	pos_identifier,
	pos_identifier_type,
	originating_store_no,
