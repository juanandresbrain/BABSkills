# dbo.edit_error_recovery_45_$sp
...
```mermaid
flowchart LR
    SP["dbo.edit_error_recovery_45_$sp"]
...
```sql
create proc dbo.edit_error_recovery_45_$sp 
...
SELECT @violated_sareject_rule = 45,
	@translate_msg = 'Duplicate lines from the translate were skipped by the edit for post voids',
	@process_name = 'edit_error_recovery_45_$sp',
        @message_id = 201068
...
WHILE 1=1
  ...
  IF @errno != 0
    BEGIN
     SELECT @errmsg = 'Failed to delete duplicate rows from transl_post_void_detail',
