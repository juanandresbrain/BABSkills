# dbo.edit_discount_detail_$sp_20181113
...
```mermaid
flowchart LR
    SP["dbo.edit_discount_detail_$sp_20181113"]
...
```sql
CREATE proc [dbo].[edit_discount_detail_$sp_20181113] 
...
JUL21,15 akhoukaz     13151  Expand the length of the column for tender total and amounts
...
CREATE TABLE #discounts( transaction_id numeric(14,0) null, -- tran_id_datatype
  ...
  line_id numeric(5,0) not null,
                         ...
                         pos_discount_amount NUMERIC(18,4) not null,
                         pos_discount_amount_adj NUMERIC(18,4) not null,
...
SELECT td.store_no,
       ...
       td.transaction_no,
       td.line_id,
       SUM(CONVERT(NUMERIC(18,4),discount_amount_sign) * CONVERT(NUMERIC(18,4),(ABS(td.pos_discount_amount - pos_discount_amount_adj))))
...
HAVING SUM(CONVERT(NUMERIC(18,4),discount_amount_sign) *
	   CONVERT(NUMERIC(18,4),(ABS(td.pos_discount_amount - pos_discount_amount_adj)))) != 0;
