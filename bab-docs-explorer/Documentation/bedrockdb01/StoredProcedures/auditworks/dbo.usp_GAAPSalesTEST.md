...
```sql
CREATE PROC [dbo].[usp_GAAPSalesTEST]
-- =============================================================================================================
...
AS 
    ...
    FROM    ( SELECT    a.store_no,
              ...
              WHERE     ( a.transaction_date BETWEEN CONVERT(CHAR, GETDATE(), 101)
                          ...
                          AND b.line_object IN ( 100, 102,103, 200, 202, 203, 204, 206,
