# dbo.spAvalaraMonthySalesTaxExport_BU20220214
...
```mermaid
flowchart LR
    SP["dbo.spAvalaraMonthySalesTaxExport_BU20220214"]
...
```sql
CREATE   procedure [dbo].[spAvalaraMonthySalesTaxExport_BU20220214]
...
--SELECT '2020-10-04' AS STRT_DATE_TIME
--	,'2020-10-31' AS END_DATE_TIME
--INTO ##StartJobCheck1
...
--SET @TransactionStartDate = '2021-10-03'
--SET @TransactionEndDate = '2021-10-30'
