...
HISTORY:
Date     Name          Def#  Desc
Aug25,16 Vicci     DAOM-1331 Look for work_master_sub_list to 'line_object_actv_nmds_idx_tax' instead of 'line_object'
...
BEGIN
  ...
  SELECT table_name, 
   ...
   WHERE interface_id = @interface_id
     AND table_name = 'line_object_actv_nmds_idx_tax'
