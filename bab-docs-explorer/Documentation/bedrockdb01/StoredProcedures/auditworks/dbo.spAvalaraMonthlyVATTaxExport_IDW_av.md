# dbo.spAvalaraMonthlyVATTaxExport_IDW_av
...
```mermaid
flowchart LR
    SP["dbo.spAvalaraMonthlyVATTaxExport_IDW_av"]
...
```sql
--exec [dbo].[spAvalaraMonthlyVATTaxExport_IDW_av]
...
CREATE procedure [dbo].[spAvalaraMonthlyVATTaxExport_IDW_av]
...
SET @TransactionStartDate = '2026-02-01'
SET @TransactionEndDate = '2026-02-28'
