# dbo.edit_error_recovery_52_$sp
...
```mermaid
flowchart LR
    SP["dbo.edit_error_recovery_52_$sp"]
...
```sql
create proc dbo.edit_error_recovery_52_$sp 
...
Apr16,01 Henry		1-CEM8P Correctly handle cleanup of duplicate lines in customer_detail table.
...
SELECT @violated_sareject_rule = 52,
	@translate_msg = 'Duplicate lines from the translate were skipped by the edit for customer details',
	@process_name = 'edit_error_recovery_52_$sp',
        @message_id = 201068
...
CREATE TABLE #work_lines_edit (
	...
	customer_info_type	smallint not null,
...
WHILE 1=1
  ...
  DELETE transl_customer_detail
    WHERE store_no = @store_no
      ...
      AND customer_info_type = @customer_info_type
      AND row_sequence_no > @min_sequence_no

  SELECT @errno = @@error
  IF @errno != 0
    BEGIN
     SELECT @errmsg = 'Failed to delete duplicate rows from transl_customer_detail',
