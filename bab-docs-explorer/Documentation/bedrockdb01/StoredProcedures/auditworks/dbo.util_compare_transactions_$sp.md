...
SELECT @process_id, @comparison_id, 'sa_rejection_reason', 'S/A Rejection reason', 
       u.comparison_key + ' _ ' + CONVERT(varchar, line_id) + ' _ ' + CONVERT(varchar, violated_sareject_rule),
       CONVERT(varchar, line_object) + ' _ ' + CONVERT(varchar, line_action) + ' _ ' + 
...
SELECT @process_id, @comparison_id, 'if_rejection_reason', 'I/F Rejection reason', 
       u.comparison_key + ' _ ' + CONVERT(varchar, line_id) + ' _ ' + CONVERT(varchar, if_reject_reason),
       CONVERT(varchar, deferred) + ' _ ' + 
       memo1 + ' _ ' + memo2 + ' _ ' + memo3 + ' _ ' + 
       CONVERT(varchar, lookup_key1),
       null,
       null  
