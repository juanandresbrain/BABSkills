# dbo.util_repop_if_tables_curr_BU20161018_$sp
...
```mermaid
flowchart LR
    SP["dbo.util_repop_if_tables_curr_BU20161018_$sp"]
    ...
    paul_repop_curr(["paul_repop_curr"]) --> SP
...
```sql
CREATE proc [dbo].[util_repop_if_tables_curr_BU20161018_$sp]
...
SELECT	@interface_id = 52, -- change this
	@from_transaction_date = '10/26/2014', -- starting date
	@to_transaction_date = '10/26/2014', -- ending date or = getdate() if all
	@reversal = 1  -- 1 = normal entries,  -1 = reversals
	--@store_no = 255 -- specify store if required
  ...
  FOR
	...
	FROM paul_repop_curr ic
     /*  FROM interface_control ic, transaction_header th
		...
		AND th.store_no in (2001,2002,2003,2004,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,
2018,2019,2020,2021,2022,2023,2024,2025,2026,2027,2028,2029,2030,2031,2032,2033,
2034,2035,2037,2038,2039,2040,2041,2042,2043,2044,2045,2046,2047,2048,2049,2052,
2055,2056,2057,2058,2059,2995)*/
