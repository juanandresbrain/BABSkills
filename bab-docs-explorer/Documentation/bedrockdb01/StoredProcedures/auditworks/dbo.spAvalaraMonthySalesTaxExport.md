# dbo.spAvalaraMonthySalesTaxExport
...
```mermaid
flowchart LR
    SP["dbo.spAvalaraMonthySalesTaxExport"]
...
```sql
CREATE   procedure [dbo].[spAvalaraMonthySalesTaxExport]
...
IF (Object_ID('tempdb..##StartJobCheck1') IS NOT NULL) DROP TABLE ##StartJobCheck1
...
IF (Object_ID('tempdb..##TaxStoreAddress') IS NOT NULL) DROP TABLE ##TaxStoreAddress
...
join	##TaxStoreAddress tsa on tsd.CustomerCode = tsa.store_no
