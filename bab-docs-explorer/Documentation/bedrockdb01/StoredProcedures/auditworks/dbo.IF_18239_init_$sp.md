...
```sql
create proc dbo.IF_18239_init_$sp
@batch_size int 
AS
...
/* TRUNCATE Ex_Work_18239 */
TRUNCATE TABLE Ex_Work_18239
SELECT @errno = @@error 
IF @errno <> 0 
   BEGIN
   SELECT @errmsg = 'Unable to Truncate Ex_Work_18239 table'
   GOTO error
   END
...
INSERT INTO auditworks.dbo.Ex_Work_18239
