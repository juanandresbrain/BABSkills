...
```mermaid
flowchart LR
    VIEW["catalog.effective_object_permissions"]
    internal_current_user_object_permissions(["internal.current_user_object_permissions"]) --> VIEW
    internal_object_folders(["internal.object_folders"]) --> VIEW
