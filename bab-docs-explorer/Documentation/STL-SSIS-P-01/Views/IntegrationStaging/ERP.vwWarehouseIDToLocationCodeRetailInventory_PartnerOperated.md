...
```mermaid
flowchart LR
    VIEW["ERP.vwWarehouseIDToLocationCodeRetailInventory_PartnerOperated"]
...
```sql
CREATE view [ERP].[vwWarehouseIDToLocationCodeRetailInventory_PartnerOperated]

as

---------------------------------------------------------------------------------
-- Tim Callahan	-	2024-09-12	-	Created View to allow Partner Operated Stores to use SSRS POS Reports  based on [ERP].[vwWarehouseIDToLocationCodeRetailInventory]
---------------------------------------------------------------------------------
...
and wm.WarehouseId in ('2019','2079','2080','2081','2082','2083')
