...
```mermaid
flowchart LR
    VIEW["ERP.vwDistributionsReadyToRelease"]
...
```sql
CREATE view [ERP].[vwDistributionsReadyToRelease]
...
-- 2023-12-05	- Tim Callahan - Added DateDiff Condition to DistroData CTE to increase performance this was somewhat related to JIRA BIB704 changes 
------------------------------------------------------------------------------------------------------------------------------------------------
With 
DistroData as 
	(
			...
			--and h.OrderID IN ('TO0000058934','TO0000058935') 
...
AND (
	...
	--OR dd.OrderID in ('TO0000657305','TO0000657306','TO0000657307','TO0000657309','TO0000657310','TO0000657311','TO0000657312','TO0000657313','TO0000657314','TO0000657316','TO0000657317','TO0000657318','TO0000657319','TO0000657516') -- Ad Hoc Let Order Export 
)
```
