# WMS.vwStoreShipmentsToDynamicsPOtoSO_ONDEMAND
...
```mermaid
flowchart LR
    VIEW["WMS.vwStoreShipmentsToDynamicsPOtoSO_ONDEMAND"]
...
```sql
CREATE view [WMS].[vwStoreShipmentsToDynamicsPOtoSO_ONDEMAND]
