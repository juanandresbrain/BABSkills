# WEB.vwProductStorefrontCatalogUSdeltaXML
...
```mermaid
flowchart LR
    VIEW["WEB.vwProductStorefrontCatalogUSdeltaXML"]
...
```sql
CREATE view [WEB].[vwProductStorefrontCatalogUSdeltaXML]

as

--------------------------------------------------------------------------------------------------
-- vwProductStorefrontCatalogUSdeltaXML - Outputs XML for eCommerce Product Storefront Catalog XML 
