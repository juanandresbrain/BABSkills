# WEB.vwProductCatalogMasterFullXML_BACKUP20221101
...
```mermaid
flowchart LR
    VIEW["WEB.vwProductCatalogMasterFullXML_BACKUP20221101"]
...
```sql
CREATE view [WEB].[vwProductCatalogMasterFullXML_BACKUP20221101]
