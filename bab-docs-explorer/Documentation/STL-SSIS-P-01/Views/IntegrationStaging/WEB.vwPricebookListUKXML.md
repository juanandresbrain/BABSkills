...
```mermaid
flowchart LR
    VIEW["WEB.vwPricebookListUKXML"]
    web_PricebookBundleSkuFact(["web.PricebookBundleSkuFact"]) --> VIEW
...
```sql
CREATE view [WEB].[vwPricebookListUKXML]
...
---	2024-08-06 - Tim Callahan - Unioned Bundle Sku List Price Data as related to JIRA BIB685
---------------------------------------------------------------------------------------------------
