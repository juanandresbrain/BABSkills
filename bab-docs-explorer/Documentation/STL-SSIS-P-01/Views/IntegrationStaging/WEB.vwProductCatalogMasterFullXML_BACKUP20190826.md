...
```mermaid
flowchart LR
    VIEW["WEB.vwProductCatalogMasterFullXML_BACKUP20190826"]
...
```sql
create view [WEB].[vwProductCatalogMasterFullXML_BACKUP20190826]
...
--	2019-06-20	-	Dan Tweedie	-	Updated view to include warninglabel xml attribute where it was previously commented out, added new case statement to derive values
--------------------------------------------------------------------------------------------------
			...
			(
				...
				( 
					select
						...
						case 
							when WarningLabel = 'SP' then 'WARNING: Choking Hazard – Small Parts. Not for Children under 3 yrs'
							when WarningLabel = 'ENT' then 'WARNING: Possible Entanglement or Strangulation Hazard – Not suitable for children under 3 yrs'
							when WarningLabel = 'B' then 'WARNING: Choking Hazard - Toy contains small ball. Not for Children under 3 yrs'
							else NULL
