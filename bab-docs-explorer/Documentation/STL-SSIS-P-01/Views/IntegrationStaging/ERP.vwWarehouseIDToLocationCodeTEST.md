# ERP.vwWarehouseIDToLocationCodeTEST
...
```mermaid
flowchart LR
    VIEW["ERP.vwWarehouseIDToLocationCodeTEST"]
...
```sql
CREATE view [ERP].[vwWarehouseIDToLocationCodeTEST]
							...
							then 
								case 
									...
									when OperationalSiteID = 9451
										then '9451' 
									when OperationalSiteID in (9901,9902,9903)
										then WarehouseID
...
--		and left(WarehouseID,2) not in ('92') --excludes various hubs, pool points, etc 
		...
		and WarehouseID not in  ('9404','9416','9419','9452')       
