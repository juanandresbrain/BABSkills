...
```mermaid
flowchart LR
    VIEW["WEB.vwProductStorefrontCategoryMap"]
...
```sql
CREATE view [WEB].[vwProductStorefrontCategoryMap]
...
--	2018-04-02	Dan Tweedie	-	Added Parent, Collection and ProductName for the purpose of interfacing this data to Omniture. The original interfact to SFCC is not changing.
--	2019-04-08	Dan Tweedie	Added coding for Trousers and Shorts (ctrl-f to see it)
--------------------------------------------------------------------------------------------------
		...
		join XREF x on 
			...
			and x.TertiaryCategoryName = case 
										...
										when a.HierarchyGroupCode in ('W-C-K-06-04-02','W-D-K-06-04-02','W-E-K-06-04-02','W-F-K-06-04-02')
											and a.ProductSellingGeography = 'US'
											then 'Pants and Shorts'
										when a.HierarchyGroupCode in ('W-C-K-06-04-02','W-D-K-06-04-02','W-E-K-06-04-02','W-F-K-06-04-02')
											and a.ProductSellingGeography = 'UK'
											then 'Trousers and Shorts' 
...
select 
	...
	substring(u.Parent,4,1000) Parent,
	u.DisplayName as Collection,
	a.DisplayName as ProductName
from Unions u
join Attributes a on u.BABWProductID = a.BABWProductID 
...
select distinct 
	...
	c.CategoryID,
	x.PrimaryCategoryDesignation,
	substring(c.Parent,4,1000) as Parent,
	c.DisplayName as Collection,
	a.DisplayName as ProductName
