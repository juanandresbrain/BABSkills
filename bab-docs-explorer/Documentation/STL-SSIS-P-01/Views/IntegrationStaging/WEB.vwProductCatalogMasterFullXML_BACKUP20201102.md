# WEB.vwProductCatalogMasterFullXML_BACKUP20201102
...
```mermaid
flowchart LR
    VIEW["WEB.vwProductCatalogMasterFullXML_BACKUP20201102"]
...
```sql
CREATE view [WEB].[vwProductCatalogMasterFullXML_BACKUP20201102]
...
ViewTypes as
	(
		...
		select
			m.BABWProductID,
			case 
				when left(m.BABWProductID,1) = 4 and m.BABWProductID not in ('424925','424974','490501','090502', '490502','028284','028285','028287','028288','428284','428285','428287','428288')
					then '/' + cast(cast(right(m.BABWProductID,5) as int) as varchar)+'x.jpg' 
				when m.BABWProductID in ('424925','424974','490501','090502', '490502','028284','028285','028287','028288','428284','428285','428287','428288')
...
ProductStage as
	(
		select 
			...
			giftCardType
		from WEB.ProductCatalogMasterAttributes
		where style_code not in ('080088','028175','028176')
		UNION
		select 
			Style_Code,
			DisplayName,
		...
		AND CurrentBatch = 1
		and style_code not in ('080088','028175','028176')
	),
Products (XML) as
	(
		select
