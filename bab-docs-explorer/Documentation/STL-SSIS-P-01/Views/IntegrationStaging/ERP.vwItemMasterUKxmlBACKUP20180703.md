# ERP.vwItemMasterUKxmlBACKUP20180703
...
```mermaid
flowchart LR
    VIEW["ERP.vwItemMasterUKxmlBACKUP20180703"]
    erp_ItemMasterToWMStage(["erp.ItemMasterToWMStage"]) --> VIEW
```
...
```sql
create view [ERP].[vwItemMasterUKxmlBACKUP20180703]
...
XMLStage (XML) as
	(
		...
		from erp.ItemMasterToWMStage
		where left(Style,1) = '4'
