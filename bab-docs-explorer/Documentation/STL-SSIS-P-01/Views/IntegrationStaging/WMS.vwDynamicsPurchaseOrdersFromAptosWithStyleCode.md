# WMS.vwDynamicsPurchaseOrdersFromAptosWithStyleCode
...
```mermaid
flowchart LR
    VIEW["WMS.vwDynamicsPurchaseOrdersFromAptosWithStyleCode"]
...
```sql
create view [WMS].[vwDynamicsPurchaseOrdersFromAptosWithStyleCode]
