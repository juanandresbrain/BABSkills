# WEB.vwPricebooksUKXML_BAK20220705
...
```mermaid
flowchart LR
    VIEW["WEB.vwPricebooksUKXML_BAK20220705"]
    WEB_vwPricebookListUKXML(["WEB.vwPricebookListUKXML"]) --> VIEW
    WEB_vwPricebookSaleUKXML(["WEB.vwPricebookSaleUKXML"]) --> VIEW
```
...
```sql
create view [WEB].[vwPricebooksUKXML_BAK20220705]
