# internal.append_execution_component_phases
...
```mermaid
flowchart LR
    SP["internal.append_execution_component_phases"]
    internal_check_permission(["internal.check_permission"]) --> SP
    internal_execution_component_phases(["internal.execution_component_phases"]) --> SP
```
