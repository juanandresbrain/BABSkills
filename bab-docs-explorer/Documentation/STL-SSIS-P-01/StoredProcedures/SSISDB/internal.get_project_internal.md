...
```mermaid
flowchart LR
    SP["internal.get_project_internal"]
    ...
    internal_decrypt_lob_data(["internal.decrypt_lob_data"]) --> SP
...
internal,get_project_parameter_values,CREATE PROCEDURE [internal].[get_project_parameter_values]
        @execution_id bigint,		    
        @project_id bigint,				
        @version_id bigint             
WITH EXECUTE AS 'AllSchemaOwner'
