# WEB.spMergePricebookBundleSkuFact_Bak20241003
...
```mermaid
flowchart LR
    SP["WEB.spMergePricebookBundleSkuFact_Bak20241003"]
...
```sql
CREATE proc [WEB].[spMergePricebookBundleSkuFact_Bak20241003]-- Update to Proper Name 
