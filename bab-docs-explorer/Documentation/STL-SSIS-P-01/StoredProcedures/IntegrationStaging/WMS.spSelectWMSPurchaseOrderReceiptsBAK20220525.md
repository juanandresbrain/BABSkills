# WMS.spSelectWMSPurchaseOrderReceiptsBAK20220525
...
```mermaid
flowchart LR
    SP["WMS.spSelectWMSPurchaseOrderReceiptsBAK20220525"]
...
```sql
CREATE proc [WMS].[spSelectWMSPurchaseOrderReceiptsBAK20220525] 
