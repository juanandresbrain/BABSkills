# dbo.spStoreSalesCheck_Find_SalesDiff_Bak20230815
...
```mermaid
flowchart LR
    SP["dbo.spStoreSalesCheck_Find_SalesDiff_Bak20230815"]
    ...
    dbo_vwPOSSalesTotalByDay(["dbo.vwPOSSalesTotalByDay"]) --> SP
```
...
| dbo.vwPOSSalesTotalByDay |

## Stored Procedure Code

```sql
CREATE PROCEDURE [dbo].[spStoreSalesCheck_Find_SalesDiff_Bak20230815]
AS
-- =============================================================================================================
...
where BusinessDate = 
	case when datepart(hh, getdate()) <=8 --up until 8am, the job will look for previous day, else same day
