# WMS.spEmailPOExportSummaryBAK20220801
...
```mermaid
flowchart LR
    SP["WMS.spEmailPOExportSummaryBAK20220801"]
...
```sql
CREATE proc [WMS].[spEmailPOExportSummaryBAK20220801] 
...
declare 
	...
	set @text = 
		'<font face =arial size = 2><B>PO Export Summary - Aptos to Dynamics</B><br><br></font>' +
			'<table border="1">' +
				'<tr><th><font face =arial size = 2>AptosPONumber</font></th>' +
					...
					'<th><font face =arial size = 2>Dynamics1100PO</font></th>' +
		...
		@recipients = 'dant@buildabear.com;elizabethw@buildabear.com;ScottP@buildabear.com;mariash@buildabear.com;EntSysSupport@buildabear.com',
		@body = @text,
...
begin 
	set @text = 
		...
		exec msdb.dbo.sp_send_dbmail
		@profile_name = 'biadmin',
		@recipients = 'dant@buildabear.com;elizabethw@buildabear.com;ScottP@buildabear.com;mariash@buildabear.com;EntSysSupport@buildabear.com;markd@buildabear.com',
		@body = @text,
