# dbo.autoadmin_metadata_query_dbs
...
```mermaid
flowchart LR
    SP["dbo.autoadmin_metadata_query_dbs"]
    dbo_autoadmin_managed_databases(["dbo.autoadmin_managed_databases"]) --> SP
...
dbo,autoadmin_metadata_query_schema_version,CREATE PROCEDURE autoadmin_metadata_query_schema_version
