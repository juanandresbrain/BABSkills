...
```sql
exec ERP.spOutputSalesOrderUDA @BatchID = '{308D2C8F-D385-4EFB-BBE8-124B2CF80488}', @FileLocation = '\\pipeapp01\Company01\Text File to IM Import Tables - Import UDAs\'
```
...
where datediff(dd, date_shipped, getdate()) <=14
and shipped_qty <> 0
```
