...
flowchart TD
    ...
    subgraph ControlFlow
        SalesAuditToDynamicsDWFacts_task["SalesAuditToDynamicsDWFacts"]
        SEQ___Merge_Fact_Tables_task["SEQ - Merge Fact Tables"]
        SalesAuditToDynamicsDWFacts_task --> SEQ___Merge_Fact_Tables_task
        Build_TransactionFactsDynamics_task["Build TransactionFactsDynamics"]
        SEQ___Merge_Fact_Tables_task --> Build_TransactionFactsDynamics_task
        Delete_OldTransactions_task["Delete_OldTransactions"]
        Build_TransactionFactsDynamics_task --> Delete_OldTransactions_task
        Generate_Balancing_Tables_task["Generate Balancing Tables"]
        Delete_OldTransactions_task --> Generate_Balancing_Tables_task
        Merge_DiscountFactsDynamics_task["Merge DiscountFactsDynamics"]
        Generate_Balancing_Tables_task --> Merge_DiscountFactsDynamics_task
        Merge_TenderFactsDynamics_task["Merge TenderFactsDynamics"]
        Merge_DiscountFactsDynamics_task --> Merge_TenderFactsDynamics_task
        Merge_TransactionDetailFactsDynamics_task["Merge TransactionDetailFactsDynamics"]
        Merge_TenderFactsDynamics_task --> Merge_TransactionDetailFactsDynamics_task
        Merge_TransactionFactsDynamics_task["Merge TransactionFactsDynamics"]
        Merge_TransactionDetailFactsDynamics_task --> Merge_TransactionFactsDynamics_task
        Merge_TransactionTaxDynamicsStage_task["Merge TransactionTaxDynamicsStage"]
        Merge_TransactionFactsDynamics_task --> Merge_TransactionTaxDynamicsStage_task
        SEQ___Parallel_Staging_task["SEQ - Parallel Staging"]
        Merge_TransactionTaxDynamicsStage_task --> SEQ___Parallel_Staging_task
        Load_3rd_party_GC_From_Valuelink_task["Load 3rd party GC From Valuelink"]
        SEQ___Parallel_Staging_task --> Load_3rd_party_GC_From_Valuelink_task
        ...
        Customer_Liability___Stage_to_Exclude_ES_task["Customer Liability - Stage to Exclude ES"]
        SEQ___PreStage_One_task --> Customer_Liability___Stage_to_Exclude_ES_task
        Data_Flow___Cust_Liability_task["Data Flow - Cust Liability"]
        Customer_Liability___Stage_to_Exclude_ES_task --> Data_Flow___Cust_Liability_task
        ...
        DataFlow___TransactionTaxes_task["DataFlow - TransactionTaxes"]
        DataFlow___Transaction_Lines_task --> DataFlow___TransactionTaxes_task
        spDW_Extract_Transaction_Lines_task["spDW_Extract_Transaction_Lines"]
        DataFlow___TransactionTaxes_task --> spDW_Extract_Transaction_Lines_task
        ...
        spDW_DetermineTransactionsToPull_Dynamics_task["spDW_DetermineTransactionsToPull_Dynamics"]
        Set_Store_Date_Time_Keys_task --> spDW_DetermineTransactionsToPull_Dynamics_task
        Truncate_Stage_task["Truncate Stage"]
        spDW_DetermineTransactionsToPull_Dynamics_task --> Truncate_Stage_task
        ...
        Build_Missing_Line_Object_Actions_task --> FIX_Invalid_LO_1625_task
        ...
        Build_AW_MAUnitCost_Dynamics_task["Build_AW_MAUnitCost_Dynamics"]
        AssignCouponNumbers_task --> Build_AW_MAUnitCost_Dynamics_task
        Cost_Merch_Items_Dynamics_task["Cost_Merch_Items_Dynamics"]
        Build_AW_MAUnitCost_Dynamics_task --> Cost_Merch_Items_Dynamics_task
        Determine_Discount_Lift_task["Determine_Discount_Lift"]
        Cost_Merch_Items_Dynamics_task --> Determine_Discount_Lift_task
...
| Task | Type |
|---|---|
| SalesAuditToDynamicsDWFacts | Microsoft.Package |
| SEQ - Merge Fact Tables | STOCK:SEQUENCE |
| Build TransactionFactsDynamics | Microsoft.ExecuteSQLTask |
| Delete_OldTransactions | Microsoft.ExecuteSQLTask |
| Generate Balancing Tables | Microsoft.ExecuteSQLTask |
| Merge DiscountFactsDynamics | Microsoft.ExecuteSQLTask |
| Merge TenderFactsDynamics | Microsoft.ExecuteSQLTask |
| Merge TransactionDetailFactsDynamics | Microsoft.ExecuteSQLTask |
| Merge TransactionFactsDynamics | Microsoft.ExecuteSQLTask |
| Merge TransactionTaxDynamicsStage | Microsoft.ExecuteSQLTask |
...
| Customer Liability - Stage to Exclude ES | Microsoft.ExecuteSQLTask |
...
| DataFlow - TransactionTaxes | Microsoft.Pipeline |
...
| spDW_DetermineTransactionsToPull_Dynamics | Microsoft.ExecuteSQLTask |
...
| Build_AW_MAUnitCost_Dynamics | Microsoft.ExecuteSQLTask |
| Cost_Merch_Items_Dynamics | Microsoft.ExecuteSQLTask |
...
|  | -- Previously just this source table: tmpTransactionLinesStage_Dynamics use auditworks;  select tl.transaction_id,  tl.line_id,  tl.line_sequence,  tl.line_object_type,  tl.line_object,  tl.line_action,  tl.gross_line_amount,  tl.pos_discount_amount,  tl.db_cr_none,  tl.reference_type,  tl.reference_no,  tl.voiding_reversal_flag --,loam.target -- Just For Troubleshooting\validation --,dd.pos_disco |
|  | select tl.transaction_id, tl.line_id,  tl.line_sequence,  tl.line_object_type,  tl.line_object, tl.line_action,  tl.gross_line_amount,  tl.pos_discount_amount, td.taxable_amount,  td.nontaxable_amount,  td.combined_rate, td.tax_amount_expected, th.transaction_date, td.tax_level from dwETL_Transactions_To_Pull_Dynamics trig WITH (NOLOCK) join [dbo].[transaction_header] th (nolock) on trig.transacti |
...
|  | [dbo].[tmpTransactionLinesStage_Dynamics] |
