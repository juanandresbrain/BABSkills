...
```mermaid
flowchart TD
    n_Package_CommWorks_API_data_flow["CommWorks API data flow"]
    n_Package_merge["merge"]
    n_Package_truncate_table["truncate table"]
    n_Package_truncate_table --> n_Package_CommWorks_API_data_flow
    n_Package_CommWorks_API_data_flow --> n_Package_merge
```
