...
flowchart LR
    ...
    dbo_tblDBA_SQLBlitzResults(["dbo.tblDBA_SQLBlitzResults"]) --> SP
```
...
```sql
CREATE PROCEDURE [dbo].[spDBA_Blitz] 
...
-- Name: spDBA_Blitz
--
-- Description:	Runs an fairly through check of best practices. Modifed to put into repository server
--
-- Output: none
-- 
-- Available actions:
...
-- Dependencies: 
--  COREDB01_MAINT.DBAUtilityMaster.dbo.tblDBA_SQLBlitzResults 
--
-- Revision History:
--		Mike Pelikan	02/27/2012		Intitial deployment
...
----------------------------------------------------------------------------------------------------
    ...
    SET @VersionNumber = '1.01' ; -- custom release BABW 20120130 mikep
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 1 AS CheckID ,
                    1 AS Priority ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 2 AS CheckID ,
                    1 AS Priority ,
                    'Backup' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 4 AS CheckID ,
                    10 AS Priority ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 5 AS CheckID ,
                    10 AS Priority ,
                    'Security' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 6 AS CheckID ,
                    200 AS Priority ,
                    'Security' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 7 AS CheckID ,
                    10 AS Priority ,
                    'Security' AS FindingsGroup ,
    ...
    IF @@VERSION NOT LIKE '%Microsoft SQL Server 2000%'
        ...
        BEGIN
            SET @StringToExecute = 'INSERT INTO #BlitzResults (InstanceName, CheckID, Priority, FindingsGroup, Finding, URL, Details)
SELECT @@ServerName, 8 AS CheckID, 150 AS Priority, ''Security'' AS FindingsGroup, ''Server Audits Running'' AS Finding, 
    ...
    IF @@VERSION NOT LIKE '%Microsoft SQL Server 2000%' 
        BEGIN
            SET @StringToExecute = 'INSERT INTO #BlitzResults (InstanceName, CheckID, Priority, FindingsGroup, Finding, URL, Details)
SELECT @@ServerName, 9 AS CheckID, 200 AS Priority, ''Surface Area'' AS FindingsGroup, ''Endpoints Configured'' AS Finding, 
    ...
    IF @@VERSION NOT LIKE '%Microsoft SQL Server 2000%'
        ...
        BEGIN
            SET @StringToExecute = 'INSERT INTO #BlitzResults (InstanceName, CheckID, Priority, FindingsGroup, Finding, URL, Details)
SELECT @@ServerName, 10 AS CheckID, 100 AS Priority, ''Performance'' AS FindingsGroup, ''Resource Governor Enabled'' AS Finding, 
    ...
    IF @@VERSION NOT LIKE '%Microsoft SQL Server 2000%' 
        BEGIN
            SET @StringToExecute = 'INSERT INTO #BlitzResults (InstanceName, CheckID, Priority, FindingsGroup, Finding, URL, Details)
SELECT @@ServerName, 11 AS CheckID, 100 AS Priority, ''Performance'' AS FindingsGroup, ''Server Triggers Enabled'' AS Finding, 
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 12 AS CheckID ,
                    10 AS Priority ,
    ...
    IF @@VERSION NOT LIKE '%Microsoft SQL Server 2000%'
        ...
        BEGIN
            SET @StringToExecute = 'INSERT INTO #BlitzResults (InstanceName, CheckID, Priority, FindingsGroup, Finding, URL, Details)
SELECT TOP 1 @@ServerName, 13 AS CheckID, 110 AS Priority, ''Performance'' AS FindingsGroup, ''Plan Guides Enabled'' AS Finding, 
    ...
    IF @@VERSION LIKE '%Microsoft SQL Server 2000%' 
        BEGIN
            SET @StringToExecute = 'INSERT INTO #BlitzResults (InstanceName, CheckID, Priority, FindingsGroup, Finding, URL, Details)
SELECT @@ServerName, 14 AS CheckID, 50 AS Priority, ''Reliability'' AS FindingsGroup, ''Page Verification Not Optimal'' AS Finding, 
...
SELECT @@ServerName, 14 AS CheckID, 50 AS Priority, ''Reliability'' AS FindingsGroup, ''Page Verification Not Optimal'' AS Finding, 
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 15 AS CheckID ,
                    110 AS Priority ,
                    'Performance' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 16 AS CheckID ,
                    110 AS Priority ,
                    'Performance' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 17 AS CheckID ,
                    110 AS Priority ,
                    'Performance' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 18 AS CheckID ,
                    110 AS Priority ,
                    'Performance' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 19 AS CheckID ,
                    200 AS Priority ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 20 AS CheckID ,
                    110 AS Priority ,
                    'Informational' AS FindingsGroup ,
    ...
    IF @@VERSION NOT LIKE '%Microsoft SQL Server 2000%'
        ...
        BEGIN
            SET @StringToExecute = 'INSERT INTO #BlitzResults (InstanceName, CheckID, Priority, FindingsGroup, Finding, URL, Details)
SELECT @@ServerName, 21 AS CheckID, 20 AS Priority, ''Encryption'' AS FindingsGroup, ''Database Encrypted'' AS Finding, 
...
/* Compare sp_configure defaults */
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 22 AS CheckID ,
                    200 AS Priority ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 23 AS CheckID ,
                    20 AS Priority ,
                    'Security' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 27 AS CheckID ,
                    200 AS Priority ,
                    'Informational' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 28 AS CheckID ,
                    200 AS Priority ,
                    'Informational' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 29 AS CheckID ,
                    200 AS Priority ,
                    'Informational' AS FindingsGroup ,
    ...
    IF NOT EXISTS ( SELECT  *
        ...
        INSERT  INTO #BlitzResults
                ...
                SELECT  @@ServerName, 30 AS CheckID ,
                        50 AS Priority ,
                        'Reliability' AS FindingsGroup ,
    ...
    IF NOT EXISTS ( SELECT  *
        ...
        INSERT  INTO #BlitzResults
                ...
                SELECT  @@ServerName, 31 AS CheckID ,
                        50 AS Priority ,
                        'Reliability' AS FindingsGroup ,
    ...
    EXEC dbo.sp_MSforeachdb 'INSERT INTO #BlitzResults SELECT DISTINCT @@ServerName, 32, 110, ''Performance'', ''Triggers on Tables'', ''http://www.BrentOzar.com/blitz/table-triggers/'', (''The ? database has triggers on the '' + s.name + ''.'' + o.name + '' table.'') FROM [?].sys.triggers t INNER JOIN [?].sys.objects o ON t.parent_id = o.object_id INNER JOIN [?].sys.schemas s ON o.schema_id = s.schema_id WHERE t.is_ms_shipped = 0' ;

    IF @@VERSION NOT LIKE '%Microsoft SQL Server 2000%'
        AND @@VERSION NOT LIKE '%Microsoft SQL Server 2005%' 
        BEGIN
            EXEC dbo.sp_MSforeachdb 'INSERT INTO #BlitzResults SELECT DISTINCT @@ServerName, 33, 200, ''Licensing'', ''Enterprise Edition Features In Use'', ''http://www.BrentOzar.com/blitz/enterprise-edition-features/'', (''The ? database is using '' + feature_name + ''.  If this database is restored onto a Standard Edition server, the restore will fail.'') FROM [?].sys.dm_db_persisted_sku_features' ;
        END ;
 ...
 --             Details
 --           )
 --           SELECT  @@ServerName, 35 AS CheckID ,
 --                   100 AS Priority ,
 --                   'Performance' AS FindingsGroup ,
 ...
 --           HAVING  COUNT(*) > 1 ;
    ...
    EXEC dbo.sp_MSforeachdb 'INSERT INTO #BlitzResults SELECT @@ServerName, 41, 100, ''Performance'', ''Multiple Log Files on One Drive'', ''http://www.BrentOzar.com/blitz/multiple-log-files-same-drive/'', (''The ? database has multiple log files on the '' + LEFT(physical_name, 1) + '' drive. This is not a performance booster because log file access is sequential, not parallel.'') FROM [?].sys.database_files WHERE type_desc = ''LOG'' AND ''?'' <> ''[tempdb]'' GROUP BY LEFT(physical_name, 1) HAVING COUNT(*) > 1' ;

    EXEC dbo.sp_MSforeachdb 'INSERT INTO #BlitzResults SELECT DISTINCT @@ServerName, 42, 100, ''Performance'', ''Uneven File Growth Settings in One Filegroup'', ''http://www.BrentOzar.com/blitz/file-growth-settings/'', (''The ? database has multiple data files in one filegroup, but they are not all set up to grow in identical amounts.  This can lead to uneven file activity inside the filegroup.'') FROM [?].sys.database_files WHERE type_desc = ''ROWS'' GROUP BY data_space_id HAVING COUNT(DISTINCT growth) > 1 OR COUNT(DISTINCT is_percent_growth) > 1' ;
    ...
    IF EXISTS ( SELECT  *
        ...
        BEGIN
            INSERT  INTO #BlitzResults
                    ...
                    SELECT  @@ServerName, 44 AS CheckID ,
                            110 AS Priority ,
                            'Performance' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 45 AS CheckID ,
                    110 AS Priority ,
                    'Performance' AS FindingsGroup ,
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 49 AS CheckID ,
                    200 AS Priority ,
                    'Informational' AS FindingsGroup ,
    ...
    IF @@VERSION NOT LIKE '%Microsoft SQL Server 2000%'
        ...
        BEGIN
            SET @StringToExecute = 'INSERT INTO #BlitzResults (InstanceName, CheckID, Priority, FindingsGroup, Finding, URL, Details)
            SELECT  @@ServerName, 50 AS CheckID ,
                    100 AS Priority ,
                    ''Performance'' AS FindingsGroup ,
    ...
    IF @@VERSION NOT LIKE '%Microsoft SQL Server 2000%'
        ...
        BEGIN
            SET @StringToExecute = 'INSERT INTO #BlitzResults (InstanceName, CheckID, Priority, FindingsGroup, Finding, URL, Details)
            SELECT  @@ServerName, 51 AS CheckID ,
                    1 AS Priority ,
                    ''Performance'' AS FindingsGroup ,
...
/* Thanks to Ali for this check! http://www.alirazeghi.com */
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 55 AS CheckID ,
                    200 AS Priority ,
                    'Security' AS FindingsGroup ,
    ...
    EXEC dbo.sp_MSforeachdb 'INSERT INTO #BlitzResults SELECT @@ServerName, 56, 100, ''Performance'', ''Check Constraint Not Trusted'', ''http://www.BrentOzar.com/blitz/foreign-key-trusted/'', (''The check constraint [?].['' + s.name + ''].['' + o.name + ''].['' + i.name + ''] is not trusted - meaning, it was disabled, data was changed, and then the constraint was enabled again.  Simply enabling the constraint is not enough for the optimizer to use this constraint - we have to alter the table using the WITH CHECK CHECK CONSTRAINT parameter.'') from [?].sys.check_constraints i INNER JOIN [?].sys.objects o ON i.parent_object_id = o.object_id INNER JOIN [?].sys.schemas s ON o.schema_id = s.schema_id WHERE i.is_not_trusted = 1 AND i.is_not_for_replication = 0' ;
    ...
    INSERT  INTO #BlitzResults
            ...
            SELECT  @@ServerName, 57 AS CheckID ,
                    10 AS Priority ,
                    'Security' AS FindingsGroup ,
