# dbo.spAWImport_675_Cost_Merch_Items
...
```mermaid
flowchart LR
    SP["dbo.spAWImport_675_Cost_Merch_Items"]
...
```sql
CREATE PROCEDURE [dbo].[spAWImport_675_Cost_Merch_Items]
-- =============================================================================================================
...
AS
	...
	FROM
		...
		INNER JOIN AW_MAUnitCost amc WITH (NOLOCK)
	...
	FROM
		...
		INNER JOIN AW_MAUnitCost mc WITH (NOLOCK)
