# dbo.spAWImport_750_Generate_Balancing_Tables_Bak20240506
...
```mermaid
flowchart LR
    SP["dbo.spAWImport_750_Generate_Balancing_Tables_Bak20240506"]
...
```sql
CREATE PROCEDURE [dbo].[spAWImport_750_Generate_Balancing_Tables_Bak20240506]
AS
-- =============================================================================================================
	...
	SELECT
		...
		SUM(( 			
					  cast (ln.line_note as numeric(14,4)) *
						CASE
							when pd.style_code is not null and right(pd.subclass_code,8) = ('57-01-01') -- Exclude Bag Fee Items
								then 0
