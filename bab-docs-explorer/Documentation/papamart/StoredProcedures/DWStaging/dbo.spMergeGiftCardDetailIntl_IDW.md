# dbo.spMergeGiftCardDetailIntl_IDW
...
```mermaid
flowchart LR
    SP["dbo.spMergeGiftCardDetailIntl_IDW"]
...
```sql
CREATE proc [dbo].[spMergeGiftCardDetailIntl_IDW]
...
(
select * from papamarttest.dw.dbo.GiftCard_Detail_International where FileID = 11276
)
as source 
on 
	(
