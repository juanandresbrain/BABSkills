# dbo.spDiscountStage_AssignCouponNumbers_BAK20231101
...
```mermaid
flowchart LR
    SP["dbo.spDiscountStage_AssignCouponNumbers_BAK20231101"]
...
CREATE PROCEDURE [dbo].[spDiscountStage_AssignCouponNumbers_BAK20231101]
AS
