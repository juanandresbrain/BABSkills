# dbo.spWebToStoreTransactionLookupStageBAK_20231228
...
```mermaid
flowchart LR
    SP["dbo.spWebToStoreTransactionLookupStageBAK_20231228"]
...
```sql
CREATE proc [dbo].[spWebToStoreTransactionLookupStageBAK_20231228]
...
where b.bSentToAW = 1 
	...
	and datediff(dd, t.dTimeStamp, getdate())<= 60
group by 
	t.sOrderNumber
...
where 1=1
and datediff(dd, os.StatusDate, getdate()) <= 60
