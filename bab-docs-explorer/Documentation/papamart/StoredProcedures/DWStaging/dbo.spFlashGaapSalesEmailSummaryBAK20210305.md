# dbo.spFlashGaapSalesEmailSummaryBAK20210305
...
```mermaid
flowchart LR
    SP["dbo.spFlashGaapSalesEmailSummaryBAK20210305"]
...
```sql
CREATE proc [dbo].[spFlashGaapSalesEmailSummaryBAK20210305]
...
--										Waiting on Scott Patten to verify Sales Plan.
-- =====================================================================================================
   ...
   (select datepart(mi, @PackageStart)) >= 45
			...
			BEGIN
					...
					BEGIN
							...
							exec msdb.dbo.sp_send_dbmail
							@profile_name = 'BIAdmin',
							@recipients = 'ExecutiveSummary@buildabear.com',--'ChiefBears@buildabear.com;ManagingDirectors@buildabear.com;Directors@buildabear.com;SamaraR@buildabear.com;kens@buildabear.com;LindsayMi@buildabear.com;FinancialAnalyst@buildabear.com',
							@copy_recipients = 'biadmin@buildabear.com',
							@body = @BodySummary2,
