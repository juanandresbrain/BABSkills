# Accounting.spMergeSales_GAAP_RawFromStoreServer
...
```mermaid
flowchart LR
    SP["Accounting.spMergeSales_GAAP_RawFromStoreServer"]
...
-- =============================================-- =============================================
CREATE PROCEDURE [Accounting].[spMergeSales_GAAP_RawFromStoreServer]
