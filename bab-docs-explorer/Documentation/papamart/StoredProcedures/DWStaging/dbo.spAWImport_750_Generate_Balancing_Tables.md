# dbo.spAWImport_750_Generate_Balancing_Tables
...
```mermaid
flowchart LR
    SP["dbo.spAWImport_750_Generate_Balancing_Tables"]
...
```sql
CREATE PROCEDURE [dbo].[spAWImport_750_Generate_Balancing_Tables]
AS
-- =============================================================================================================
...
--		Tim Callahan	2024-05-06		Deployment Check In - Changes Related to Bag Fees as related to JIRA BIB881
-- =============================================================================================================
