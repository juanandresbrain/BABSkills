# dbo.spEmailAzureProcessSummary_DailyInventoryValidation
...
```mermaid
flowchart LR
    SP["dbo.spEmailAzureProcessSummary_DailyInventoryValidation"]
...
```sql
CREATE proc [dbo].[spEmailAzureProcessSummary_DailyInventoryValidation]
...
select @Subj= 'Azure Processing Summary - Daily Inventory -' + @Status

if @CountUnProcessed >0
set @text =
	'<font face =arial size = 2><B>Azure Processing Summary - Daily Inventory Report Validation - PROBLEM</B><br>
	...
	<br></font>' +
		...
		'<font face =arial size = 2>' +
			CAST ( ( SELECT 
				...
				'</font></table></font></p></p>
				<br>
				<font face =arial size = 1><B>This report was run from papamart.DWStaging..spEmailAzureProcessSummary_DailyInventoryValidation.</B></font>
				<br>
				<br>
	...
	set @text = 
		'<font face =arial size = 2><B>Azure Processing Summary - Daily Inventory Report Validation - No Problem</B><br>
		<br></font>' +
			'<table border="1">' +
				'<tr bgcolor="black"><th><font face =arial size = 2>TableType</font></th>' +
					'<th><font face =arial size = 2>TableName</font></th>' +
		...
		@recipients = 'biadmin@buildabear.com;RachelS@buildabear.com',
		@body = @text,
		@subject = @Subj,
		@body_format = 'HTML'
```
