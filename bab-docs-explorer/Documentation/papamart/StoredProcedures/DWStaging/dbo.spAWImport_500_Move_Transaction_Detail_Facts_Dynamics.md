# dbo.spAWImport_500_Move_Transaction_Detail_Facts_Dynamics
...
```mermaid
flowchart LR
    SP["dbo.spAWImport_500_Move_Transaction_Detail_Facts_Dynamics"]
    ...
    line_object_action_master_Dynamics(["line_object_action_master_Dynamics"]) --> SP
...
| line_object_action_master_Dynamics |
| dbo.product_dim |
| SALES_TRN_STG_MRCH |
| dbo.store_dim |
| dbo.upc_sa |
...
```sql
CREATE PROCEDURE [dbo].[spAWImport_500_Move_Transaction_Detail_Facts_Dynamics]
-- =============================================================================================================
...
-- Revision History
--		Name:			Date:			Comments:
--		Dan Tweedue		2022-10-24	Created proc for dynamics 
-- =============================================================================================================
AS
					...
					(SELECT
						...
						FROM
							...
							LEFT JOIN aw_Merchandise_Detail amd WITH (NOLOCK)
								...
								INNER JOIN line_object_action_master_Dynamics loam WITH (NOLOCK)
