# dbo.spMergeTransaction_Detail_Facts
...
```mermaid
flowchart LR
    SP["dbo.spMergeTransaction_Detail_Facts"]
...
```sql
CREATE proc [dbo].[spMergeTransaction_Detail_Facts] 
...
--==========================================================================================================================================
-- Dan Tweedie 2020-07-01	Created proc to replace SCD plugin for SSIS 2008 to merge inserts/updates/deletes into transaction_detail_facts
--==========================================================================================================================================
...
into tmpTDFKey
from MinDate md 
join dw.dbo.transaction_detail_facts tdf with (nolock) on tdf.date_key between md.MinDate and md.MaxDate
...
--if there are transaction in transaction_detail_facts which are not in the stage data, but are for the same date range, delete from transaction_detail_facts
...
---======================================
merge into dw.dbo.transaction_detail_facts as target
