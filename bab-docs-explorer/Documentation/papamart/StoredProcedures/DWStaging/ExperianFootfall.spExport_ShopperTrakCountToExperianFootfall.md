# ExperianFootfall.spExport_ShopperTrakCountToExperianFootfall
...
```mermaid
flowchart LR
    SP["ExperianFootfall.spExport_ShopperTrakCountToExperianFootfall"]
...
```sql
-- DROP PROCEDURE ExperianFootfall.spExport_ShopperTrakCountToExperianFootfall
CREATE PROCEDURE [ExperianFootfall].[spExport_ShopperTrakCountToExperianFootfall]
-- =============================================================================================================
-- Revision History
--		Name:			Date:			Comments:
...
-- =============================================================================================================
/* TEST SCRIPT
EXEC [dwstaging].ExperianFootfall.spExport_ShopperTrakCountToExperianFootfall 
	@ac_path = 'I:\ExperianFootfall\'
	, @RecordRange_StartDate = '11/15/2014'
	, @RecordRange_EndDate = '11/30/2014'
*/
    @ac_path VARCHAR(100)
