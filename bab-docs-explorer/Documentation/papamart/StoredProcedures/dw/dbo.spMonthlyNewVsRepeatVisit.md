...
```mermaid
flowchart LR
    SP["dbo.spMonthlyNewVsRepeatVisit"]
...
******************************************************************************/
CREATE
PROCEDURE dbo.spMonthlyNewVsRepeatVisit
	/* ===== ARGUMENTS ===== */
...
JOIN dbo.tdf_rpt tdf (nolock) ON tk.hhkey = tdf.sender_household_key
JOIN date_dim dd ON tdf.date_key = dd.date_key		
...
JOIN dbo.tdf_rpt tdf (nolock) ON tk.hhkey = tdf.recipient_household_key
JOIN date_dim dd ON tdf.date_key = dd.date_key		
