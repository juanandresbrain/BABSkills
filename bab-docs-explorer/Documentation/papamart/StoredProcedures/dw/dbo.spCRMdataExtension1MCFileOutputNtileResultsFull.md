# dbo.spCRMdataExtension1MCFileOutputNtileResultsFull
...
```mermaid
flowchart LR
    SP["dbo.spCRMdataExtension1MCFileOutputNtileResultsFull"]
...
```sql
CREATE proc [dbo].[spCRMdataExtension1MCFileOutputNtileResultsFull]
...
Begin 
		...
		set @ntile_var = (select (count(*)/2375000)+1 as varNumberOfGroups from DW.dbo.CRMde1)
