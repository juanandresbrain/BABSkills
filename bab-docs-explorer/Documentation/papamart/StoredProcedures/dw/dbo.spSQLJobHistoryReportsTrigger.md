# dbo.spSQLJobHistoryReportsTrigger
...
```mermaid
flowchart LR
    SP["dbo.spSQLJobHistoryReportsTrigger"]
...
```sql
CREATE proc spSQLJobHistoryReportsTrigger

--==============================================================================================================================
--Dan Tweedie	2020-02-15	- Create proc, identical to spSQLJobHistoryEmail, except only used before the Finance reports run --
--==============================================================================================================================
			...
			if 
				...
				BEGIN
					exec msdb.dbo.sp_send_dbmail
							...
							@body = 'The automated Finance reports are delayed due to data processing still in progress. The BI team will notify you and/or trigger the reports when ready.',
