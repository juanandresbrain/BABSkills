...
```sql
CREATE         procedure [dbo].[spAuditReload_tranID] @tranID int 
as
...
from transaction_detail_facts tdf
	join Ld_POS_Audits ld on tdf.transaction_id = ld.transaction_id and tdf.transaction_line_seq >0
