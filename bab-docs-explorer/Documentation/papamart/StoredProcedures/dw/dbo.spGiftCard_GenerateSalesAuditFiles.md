# dbo.spGiftCard_GenerateSalesAuditFiles
...
```mermaid
flowchart LR
    SP["dbo.spGiftCard_GenerateSalesAuditFiles"]
    gcd(["gcd"]) --> SP
    ...
    dbo_GiftCard_Header_International(["dbo.GiftCard_Header_International"]) --> SP
...
```sql
CREATE PROCEDURE [dbo].[spGiftCard_GenerateSalesAuditFiles]
AS
...
gch.period_start_date >= '11/23/2004' AND gch.FileID IN
...
--And (
--	(gch.period_start_date between '12/13/2014' and '12/14/2014' and store_id IN (58,291) )
--OR	( gch.period_start_date between '12/7/2014' and '12/8/2014' and Store_ID IN (215,74,144) )
--OR	( gch.period_start_date between '12/15/2014' and '12/16/2014' and Store_ID IN (69,278) )
--OR	( gch.period_start_date between '12/18/2014' and '12/19/2014' and Store_ID IN (65,126, 192) )
--OR	( gch.period_start_date between '12/20/2014' and '12/21/2014' and Store_ID IN (56,162, 211) )
--)
GROUP BY --CONVERT(varchar(10),gch.period_start_date,101), 
period_start_date,
CASE 
