# dbo.spMergeHR_StoreForcePosSalesFactFromJumpMindBACKUP20240219
...
```mermaid
flowchart LR
    SP["dbo.spMergeHR_StoreForcePosSalesFactFromJumpMindBACKUP20240219"]
...
```sql
CREATE proc [dbo].[spMergeHR_StoreForcePosSalesFactFromJumpMindBACKUP20240219]
