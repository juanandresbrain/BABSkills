# dbo.spMergeHR_StoreForcePosSalesFactFromJumpMindBACKUP20230821
...
```mermaid
flowchart LR
    SP["dbo.spMergeHR_StoreForcePosSalesFactFromJumpMindBACKUP20230821"]
...
```sql
CREATE proc [dbo].[spMergeHR_StoreForcePosSalesFactFromJumpMindBACKUP20230821]
...
join #StyleLookup s on s.productnumber=d.item_id -- Added 6/20/2023
