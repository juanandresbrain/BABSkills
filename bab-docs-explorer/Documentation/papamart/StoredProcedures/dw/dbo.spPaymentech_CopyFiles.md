...
```sql
CREATE PROCEDURE [dbo].[spPaymentech_CopyFiles] 
...
set @command = 'net use ' + @destdrive + ' "\\CHESAPP01\trecs\import\Credit Cards\Paymentech" d3v@dm1n /user:bab\devadmin'
insert into ##paymentech_error
exec master..xp_cmdshell @command
