# dbo.spReportPOS_GiftCardUpsell_JumpMindOnly_Bak20241211
...
```mermaid
flowchart LR
    SP["dbo.spReportPOS_GiftCardUpsell_JumpMindOnly_Bak20241211"]
...
-- =====================================================================================================
CREATE PROCEDURE [dbo].[spReportPOS_GiftCardUpsell_JumpMindOnly_Bak20241211]
