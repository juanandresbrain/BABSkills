# dbo.spReportPOS_GiftCardUpsell
...
```mermaid
flowchart LR
    SP["dbo.spReportPOS_GiftCardUpsell"]
...
-- =====================================================================================================
CREATE PROCEDURE [dbo].[spReportPOS_GiftCardUpsell]
...
--AssociateNumber, 
--AssociateName, 
--TotalTransWithGcPromo as TotalTransWithGcPromo
--into #GcTransData2
--from #GcTransData
