# dbo.spRpt_SalesTransactionsByMonthForSelectedStoresSummaryUsedForSalesTaxAudit
...
```mermaid
flowchart LR
    SP["dbo.spRpt_SalesTransactionsByMonthForSelectedStoresSummaryUsedForSalesTaxAudit"]
...
```sql
CREATE PROCEDURE [dbo].[spRpt_SalesTransactionsByMonthForSelectedStoresSummaryUsedForSalesTaxAudit]
	@FiscalYear INT
	, @FiscalPeriod INT
