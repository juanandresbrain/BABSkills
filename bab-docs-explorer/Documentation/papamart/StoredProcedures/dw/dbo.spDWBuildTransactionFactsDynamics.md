# dbo.spDWBuildTransactionFactsDynamics
...
```mermaid
flowchart LR
    SP["dbo.spDWBuildTransactionFactsDynamics"]
...
--		Tim Callahan		2024-05-06		Pre Deployment Check In: Added additional handling related to bag fees and GAAP -- See JIRA BIB881
-- =============================================================================================================

CREATE PROC [dbo].[spDWBuildTransactionFactsDynamics]
AS
	SET NOCOUNT ON;
