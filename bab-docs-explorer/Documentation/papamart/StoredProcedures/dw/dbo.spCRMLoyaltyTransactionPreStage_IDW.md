# dbo.spCRMLoyaltyTransactionPreStage_IDW
...
```mermaid
flowchart LR
    SP["dbo.spCRMLoyaltyTransactionPreStage_IDW"]
...
```sql
CREATE proc [dbo].[spCRMLoyaltyTransactionPreStage_IDW]
@DaysToGoBack int
...
--      Ian Wallace 2022-04-10  - added DaysToGoBack paramater so process can run for fewer days for hourly loyalty feed
--------------------------------------------------------------------------------------------------------------------------------
