# dbo.spReportPOS_JumpMindWebEJ_Header_v1
...
```mermaid
flowchart LR
    SP["dbo.spReportPOS_JumpMindWebEJ_Header_v1"]
...
-- =====================================================================================================
CREATE PROCEDURE [dbo].[spReportPOS_JumpMindWebEJ_Header_v1]
 @BeginDate date,
 @EndDate date ,
...
right(h.device_id,3) as RegisterNumber,
...
AssociateNumber
into #Summary1--into #RawTransData2
from #RawTransData
group by 
TransactionDate, 
StoreNumber, 
