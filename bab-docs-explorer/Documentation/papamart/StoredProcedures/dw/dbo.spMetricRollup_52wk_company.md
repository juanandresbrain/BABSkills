...
```mermaid
flowchart LR
    SP["dbo.spMetricRollup_52wk_company"]
...
/******************************************************************************
**
**	Name:		spMetricRollup_52wk_company
**
...
** 	Returns:	result set
**
**	Examples:	EXEC spMetricRollup_52wk_company
**			
**
**	History:	
**  Date 		Author 		Purpose
...
******************************************************************************/
CREATE                                            PROCEDURE  spMetricRollup_52wk_company
/* ===== ARGUMENTS ===== */	
