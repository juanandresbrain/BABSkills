# dbo.spMergeHR_StoreForcePosSalesFactFromJumpMindBAK20231006
...
```mermaid
flowchart LR
    SP["dbo.spMergeHR_StoreForcePosSalesFactFromJumpMindBAK20231006"]
...
```sql
CREATE proc [dbo].[spMergeHR_StoreForcePosSalesFactFromJumpMindBAK20231006]
