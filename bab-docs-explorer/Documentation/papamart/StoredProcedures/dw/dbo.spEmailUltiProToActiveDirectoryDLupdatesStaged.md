# dbo.spEmailUltiProToActiveDirectoryDLupdatesStaged
...
```mermaid
flowchart LR
    SP["dbo.spEmailUltiProToActiveDirectoryDLupdatesStaged"]
...
```sql
CREATE proc [dbo].[spEmailUltiProToActiveDirectoryDLupdatesStaged] 
	...
	@currentGroupName nvarchar(50),
	@newGroupName nvarchar(255)

--========================================================================================================================
--	2020-11-12	Ian Wallace	- Created proc 				
--========================================================================================================================
...
select @Subj = 'UltiPro to Active Directory Employee DL Update'
	select @recip = 'ianw@buildabear.com'
	--select @recip = 'ianw@buildabear.com;dant@buildabear.com;'
	select @ProvisionText = 'DL update'


select @body = 
'<font face =arial size = 2><B>UltiPro to Active Directory Employee distribution list change</B><br>' +
'The following employee DL was updated. <br> ' +
'</font>' +
	'<table border="1">' +
		'<tr><th><font face =arial size = 2>ProvisioningEvent</font></th>' +
			'<th><font face =arial size = 2>EmployeeID</font></th>' +
			'<th><font face =arial size = 2>Store Number</font></th>' +
			...
			'<th><font face =arial size = 2>previous DL</font></th>' +
			'<th><font face =arial size = 2>new DL</font></th>' +
