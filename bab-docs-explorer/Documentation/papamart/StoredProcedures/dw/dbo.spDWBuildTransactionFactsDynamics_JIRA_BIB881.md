# dbo.spDWBuildTransactionFactsDynamics_JIRA_BIB881
...
```mermaid
flowchart LR
    SP["dbo.spDWBuildTransactionFactsDynamics_JIRA_BIB881"]
...
CREATE PROC [dbo].[spDWBuildTransactionFactsDynamics_JIRA_BIB881]
AS
	SET NOCOUNT ON;
