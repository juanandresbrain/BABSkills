...
```mermaid
flowchart LR
    SP["dbo.spMergeEmailFacts2022"]
    dbo_EmailFact2022(["dbo.EmailFact2022"]) --> SP
...
```sql
CREATE proc [dbo].[spMergeEmailFacts2022]

as 

----------------------------------------------------------------------------------------------------------------
--	Ian Wallace	2022-01-20	Created proc, runs at end of SSIS package to move data from Kodiak.ESPStaging to DW
----------------------------------------------------------------------------------------------------------------
...
merge into dw.dbo.EmailFact2022 as target
Using (
		select 
			ClientID,
			SendID,
