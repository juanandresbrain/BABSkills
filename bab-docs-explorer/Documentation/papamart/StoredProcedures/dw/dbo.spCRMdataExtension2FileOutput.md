# dbo.spCRMdataExtension2FileOutput
...
```mermaid
flowchart LR
    SP["dbo.spCRMdataExtension2FileOutput"]
...
```sql
CREATE proc [dbo].[spCRMdataExtension2FileOutput]
	@path varchar(200),
...
Begin 
		...
		--CREATE FILE USING BCP COMMAND
			SET @selectstmnt = 'select [customerNumber],[bonusClubBdayAttribute]'
