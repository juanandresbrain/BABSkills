# dbo.spEmailAzureMiddlewareAlert
...
```mermaid
flowchart LR
    SP["dbo.spEmailAzureMiddlewareAlert"]
...
```sql
CREATE proc [dbo].[spEmailAzureMiddlewareAlert] 
...
set @Subj = 'Azure middleware alert'
...
select @body = 
'Inbound customer middleware has not run or has been stuck for 3over 3 hours. Please investigate. <br> ' +
    '<br><br>' +
    '<br>
