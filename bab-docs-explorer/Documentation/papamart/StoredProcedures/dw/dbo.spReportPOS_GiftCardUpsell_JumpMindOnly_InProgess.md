# dbo.spReportPOS_GiftCardUpsell_JumpMindOnly_InProgess
...
```mermaid
flowchart LR
    SP["dbo.spReportPOS_GiftCardUpsell_JumpMindOnly_InProgess"]
...
-- =====================================================================================================
CREATE PROCEDURE [dbo].[spReportPOS_GiftCardUpsell_JumpMindOnly_InProgess]
