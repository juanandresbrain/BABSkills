...
```mermaid
flowchart LR
    SP["dbo.spCRMLoyaltyProductStage"]
...
-- Author:		Ian Wallace
-- =============================================
CREATE PROCEDURE [dbo].[spCRMLoyaltyProductStage]
...
SET NOCOUNT ON;
 ...
 --           CASE 
	...
	IF (Object_ID('dw..LoyaltyProducts') IS NOT NULL) DROP TABLE dw.dbo.LoyaltyProducts;
