# dbo.spReportPOS_GiftCardUpsell_Bak20230915
...
```mermaid
flowchart LR
    SP["dbo.spReportPOS_GiftCardUpsell_Bak20230915"]
...
-- =====================================================================================================
CREATE PROCEDURE [dbo].[spReportPOS_GiftCardUpsell_Bak20230915]
...
left join UTAEmployee e (nolock) on right('0000000'+cd.cashier_code,7)=e.Emp_Name
...
left join UTAEmployee e on h.username=e.Emp_Name	
	and e.Calcgrp_ID in ('10005','10004')-- US hourly\salary	
where 1=1
