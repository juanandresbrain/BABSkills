...
```mermaid
flowchart LR
    SP["dbo.spSelectFlashGaapSalesUK"]
...
```sql
CREATE proc [dbo].[spSelectFlashGaapSalesUK]
...
--UK--
IF (Object_ID('tempdb..##tmp_FlashGAAP_UK') IS NOT NULL) DROP TABLE ##tmp_FlashGAAP_UK
SET ANSI_WARNINGS OFF 
SET NOCOUNT ON


select RIGHT(('0000' + CAST(sd.store_id AS VARCHAR)), 4) as Store_Num
