# dbo.spMergeHR_StoreForcePosSalesFactFromJumpMind_BAK20230620
...
```mermaid
flowchart LR
    SP["dbo.spMergeHR_StoreForcePosSalesFactFromJumpMind_BAK20230620"]
...
```sql
CREATE proc [dbo].[spMergeHR_StoreForcePosSalesFactFromJumpMind_BAK20230620]
