...
```sql
CREATE proc [dbo].[spMergeEmailFacts2020]
...
when matched 
	and
		(
			...
			isnull(target.LastPurchaseDate,'3030-12-31')<>isnull(source.LastPurchaseDate,'3030-12-31')  
