...
** 	Returns:	result set
**
**	Examples:	EXEC spMetricRollup_13wk
**			
**
**	History:	
**  Date 		Author 		Purpose
...
******************************************************************************/
CREATE                                         PROCEDURE  spMetricRollup_13wk
/* ===== ARGUMENTS ===== */	
...
Begin
Exec dbo.spMetricRollup_13wk_company
End
Else 
Begin 
