# dbo.spEmail_Report_ESPDataV6_edin
...
```mermaid
flowchart LR
    SP["dbo.spEmail_Report_ESPDataV6_edin"]
...
CREATE PROC [dbo].[spEmail_Report_ESPDataV6_edin]
-- =============================================================================================================
...
--		Edin			08/29/2013		Rewrote proc for better performance
