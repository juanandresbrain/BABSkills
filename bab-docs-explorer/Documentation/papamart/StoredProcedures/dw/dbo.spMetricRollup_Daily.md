...
** 	Returns:	result set
**
**	Examples:	EXEC spMetricRollup_Daily
**			
**
**	History:	
**  Date 		Author 		Purpose
...
******************************************************************************/
CREATE    PROCEDURE  spMetricRollup_Daily
/* ===== ARGUMENTS ===== */	
...
IF (Object_ID('dw..MetricRollup52wk') IS NOT NULL) DROP TABLE MetricRollup52wk
...
---------CREATE INDEXES-----------------
create index idxN_NU_MetricRollup52wk_actual_date on MetricRollup52wk(actual_date)
create index idxN_NU_MetricRollup52wk_store_id on MetricRollup52wk(store_id)





--select * from MetricRollup52wk
```
