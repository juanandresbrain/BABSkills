...
```mermaid
flowchart LR
    SP["dbo.spSkipJackAWTranDetailBAK"]
...
```sql
CREATE PROC spSkipJackAWTranDetailBAK
...
DOMO,spGetFranchiseeTopStylesandAvailability,-- =============================================================================================================
...
-- =============================================
CREATE PROCEDURE [DOMO].[spGetFranchiseeTopStylesandAvailability] 
@startDate date
