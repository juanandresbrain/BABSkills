# dbo.spGiftcardAuditworksVerify
...
```mermaid
flowchart LR
    SP["dbo.spGiftcardAuditworksVerify"]
...
```sql
CREATE PROCEDURE [dbo].[spGiftcardAuditworksVerify] AS
-- =============================================================================================================
...
begin
	...
	set @recipients = 'biadmin@buildabear.com;lindak@buildabear.com'
