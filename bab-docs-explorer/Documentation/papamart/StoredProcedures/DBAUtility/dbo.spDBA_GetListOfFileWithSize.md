...
--		Mike Pelikan	12/03/2014		Increased DECIMAL size on insert into tblDBA_FileSize

DECLARE @Revision DATETIME
SET @Revision = '12/03/2014'
--
SET NOCOUNT ON 
          ...
          BEGIN 
            ...
            ------------------------------------------------------------------------------------------ 
                ...
                SELECT  @@SPID, SYSTEM_USER, 
                        @curdir, 
                        FilePath, 
                        CAST(CAST(FileSize AS DECIMAL(20,2))/ @1MB AS DECIMAL(20,2)), 
                        CAST(CAST(FileSize AS DECIMAL(20,2))/ @1KB AS DECIMAL(20,2)),
                        ModifiedDate 
