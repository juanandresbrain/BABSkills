...
```mermaid
flowchart LR
    SP["dbo.usp_SaveDelimitedColumns"]
...
http://virtualobjectives.com.au/sqlserver/saving_to_csv.htm
...
CREATE PROCEDURE [dbo].[usp_SaveDelimitedColumns]
