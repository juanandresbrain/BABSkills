...
--		Gary Derikito	06/17/2009		remove reference to linked server
...
exec spDBA_JobStatusCheck @DaysBack = 7 , @SQLVersion = 'SQL2000', @ResultsToTable = 'N'
...
BEGIN
	...
	BEGIN
		...
		-- Final Logic 
		INSERT INTO DBAUtility.dbo.JOB_HIST(
				SERVER_NM
				, JOB_NM
				, STEP_NM
				, STEP_ID
