...
```sql
CREATE VIEW [dbo].[vwDW_Product_Dim_V3]
AS -- =============================================================================================================
...
SELECT cast(prd.product_key AS VARCHAR(50)) AS product_key
	 ...
	 , CASE
		   WHEN substring(department_code,7,2) IN (

				/* Excluded Products */

				'65','70','51','60','45','46','47','50','75','80' 
...
FROM
	product_dim prd WITH (NOLOCK)
	INNER JOIN vwDW_Product_Common cmn WITH (NOLOCK)
