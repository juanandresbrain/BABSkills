...
```sql
CREATE VIEW [Azure].[vwStoreCompDim] AS
-- =============================================================================================================
-- Name: [Azure].[vwStoreCompDim] 
--
-- Description: Store dimension by date.
--				StoreKey is the 'User Friendly' store number.  We send this as the StoreKey to Azure to be used in joins.
...
--      John Eck			8/23/2018		Added Warehosue data
-- =============================================================================================================
...
INNER JOIN StoreAttributesByDate sa
	...
	SELECT	 
		...
		,'N/A' as AreaManager	
from DOMO.vwMA_WarehouseDim wd
