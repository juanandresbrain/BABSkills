...
```sql
CREATE     VIEW [dbo].[vwLoadCompareAW_wk]
as 
/**************************************************************************
...
from 
		...
		from 	(
				...
				FROM 	POSDbsSA.auditworks.dbo.transaction_header a, 
					POSDbsSA.auditworks.dbo.transaction_line b 
				WHERE a.transaction_id=b.transaction_id 
				    AND (a.transaction_date Between   CONVERT(char,DATEADD(day,-7,GETDATE()),101) and   CONVERT(char,DATEADD(day,-1,GETDATE()),101)
		...
		left join 
				...
				FROM 	POSDbsSA.auditworks.dbo.transaction_header a, 
					POSDbsSA.auditworks.dbo.transaction_line b, 
					POSDbsSA.auditworks.dbo.sv_merchandise_detail c 
				WHERE 	a.transaction_id=b.transaction_id  
 ...
 left join 
			...
			where dd.actual_date between CONVERT(char,DATEADD(day,-7,GETDATE()),101)and   CONVERT(char,DATEADD(day,-1,GETDATE()),101)
