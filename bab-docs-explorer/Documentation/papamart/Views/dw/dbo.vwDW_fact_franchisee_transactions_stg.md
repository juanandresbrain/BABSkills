# dbo.vwDW_fact_franchisee_transactions_stg
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_fact_franchisee_transactions_stg"]
...
```sql
CREATE VIEW [dbo].[vwDW_fact_franchisee_transactions_stg]
AS

/*
select top 100 * from franchisee_sales_facts

select top 100 * from [vwDW_Transactions]
