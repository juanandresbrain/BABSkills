...
```sql
CREATE view [dbo].[vwBO_Product_Dim_v2]
as
/*
...
select Product_Group + ' ' + Division as division_key
	, department + ' ' + department_code as department_key
