...
```sql
CREATE VIEW [DOMO].[vwWebSalesHourly]

AS
-- =============================================================================================================
-- Name: [DOMO].[vwWebSalesHourly]
--
-- Description: Web Sales grouped by date and hour.
-- 
--
--
-- Dependencies: Web hourly Sales
--
-- Revision History
--		Name:				Date:			Comments:
--		Brian Byas			6/10/2016		Initial creation
--		Brian Byas			8/19/2016		Added last Year Expressions for Orders, GAAP and Cash Sales
-- =============================================================================================================
...
WITH Orders (actual_date,OrderHour,TotalOrders) AS (
		...
		*/
		...
		AND PO.[ProductionOrderSiteCode] = 'BABW_US'
...
FROM Orders O WITH (NOLOCK) RIGHT OUTER JOIN
	...
	GAAPSalesAmount GAP WITH (NOLOCK) ON
		CAST(O.actual_date AS DATE) = CAST(GAP.actual_date AS DATE) AND O.OrderHour = GAP.OrderHour LEFT OUTER JOIN
	...
	CASH C ON
		CAST(O.actual_date AS DATE) = CAST(C.actual_date AS DATE) AND O.OrderHour = C.OrderHour LEFT OUTER JOIN
	CASHLY CLY ON
