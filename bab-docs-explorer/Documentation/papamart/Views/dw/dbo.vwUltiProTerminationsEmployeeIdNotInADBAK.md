# dbo.vwUltiProTerminationsEmployeeIdNotInADBAK
...
```mermaid
flowchart LR
    VIEW["dbo.vwUltiProTerminationsEmployeeIdNotInADBAK"]
...
```sql
CREATE view [dbo].[vwUltiProTerminationsEmployeeIdNotInADBAK]
