# dbo.xxx_vwDW_fact_franchisee_transactions_BU_PreGoLove_20080205
...
```mermaid
flowchart LR
    VIEW["dbo.xxx_vwDW_fact_franchisee_transactions_BU_PreGoLove_20080205"]
...
```sql
create VIEW [dbo].[vwDW_fact_franchisee_transactions_BU_PreGoLove_20080205]
AS
