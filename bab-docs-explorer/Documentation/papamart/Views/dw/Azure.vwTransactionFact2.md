...
```sql
CREATE view [Azure].[vwTransactionFact2]
...
--		Tim Bytnar			4/4/2018		Alterations for including Franchisee TransactionFact data
--
-- =============================================================================================================


SELECT CaST(tff.[transaction_id] AS varchAR(20)) AS TransactionID
...
SELECT	Cast(Date_key as varchar(20))  as TransactionID,
		ds.StoreKey AS StoreKey,
		CONVERT(DATE,dd.actual_date) AS TransactionDate,
