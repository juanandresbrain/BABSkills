...
```sql
CREATE view [dbo].[vwBO_line_object_dim]
as
...
select lo.[Line_Object_Key]
	...
	(290,295,1600,1610,1611,1615,1618,1802,1803,1806,1809) THEN 'Marketing Discounts'
	WHEN lo.line_object in (1700,1750,1900) THEN 'Employee Discounts'
	...
	WHEN lo.line_object in (1604,1612) THEN 'Party Discounts'
	WHEN lo.line_object in (1601,1607,1614,1617,1620,1805,1808) THEN 'Promotional Discounts'
	WHEN lo.line_object in (101,292) THEN 'Donations'
	WHEN lo.line_object in (291) THEN 'Cub Cash Fees'
	WHEN lo.line_object in (296) THEN 'Customer Service Fees'
	WHEN lo.line_object in (700,701,710,711,712,713,714) THEN 'Paid Out Fees'
	WHEN lo.line_object in (200,203) THEN 'Shipping Fees'
	WHEN lo.line_object in (210,250) THEN 'Stuffing And Supplies Fees'
