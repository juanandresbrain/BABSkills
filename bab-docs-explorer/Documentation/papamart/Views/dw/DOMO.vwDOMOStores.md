...
```sql
CREATE VIEW [DOMO].[vwDOMOStores] AS
-- =============================================================================================================
-- Name: [DOMO].[vwDOMOStores]
--
-- Description: Stores to include in DOMO feed.
--				StoreID is the 'User Friendly' store number.  We send this to DOMO as 'StoreKey'.
--				StoreNumber is the 'Display' store number padded with zeros (i.e. store 1 is 0001).
--				StoreKey is the DW store_key for joining to DW Facts and only send for stores in this view; 
--						For corporate stores this is PAPAMART.dw.dbo.store_dim.store_key
--						For franchisees this is KODIAK.FranchMstrData.dbo.Store.StoreID
--
--
-- Dependencies: 
--
-- Revision History
--		Name:				Date:			Comments:
--		Anthony Delgado		12/16/2015		Initial Creation
--		Anthony Delgado		4/19/2016		Hard-coding 470 corporate sales.  This should be added to store MDM!!
--		Anthony Delgado		06/07/2016		Added China "CN" to Trading Group
-- =============================================================================================================
-- Corporate Stores
