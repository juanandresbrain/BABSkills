# dbo.vwDW_SFSGsts_biapp01_BAK_20181009
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_SFSGsts_biapp01_BAK_20181009"]
    date_dim(["date_dim"]) --> VIEW
    dbo_vwDW_CRM_TRN_SUM_FACT(["dbo.vwDW_CRM_TRN_SUM_FACT"]) --> VIEW
```
...
**********************************************************************************************/
create VIEW [dbo].[vwDW_SFSGsts_biapp01_BAK_20181009]
AS
/***********************************
