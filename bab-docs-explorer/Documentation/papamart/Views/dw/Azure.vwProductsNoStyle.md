...
/* =============================================================================================================
 ...
 Revision History
		Name:				Date:			Comments:
		Dan Tweedie			2021-11-09		Created to catch what azure.vwProducts does NOT -- NULL or n/a Style --  for use with our CRMTransactionRollups view for ssis
		
*/


CREATE VIEW [Azure].[vwProductsNoStyle]
AS
