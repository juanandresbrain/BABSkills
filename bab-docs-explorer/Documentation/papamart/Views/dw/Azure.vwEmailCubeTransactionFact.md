# Azure.vwEmailCubeTransactionFact
...
```mermaid
flowchart LR
    VIEW["Azure.vwEmailCubeTransactionFact"]
...
```sql
CREATE view [Azure].[vwEmailCubeTransactionFact]

AS
-- =============================================================================================================
-- Name: [Azure].[vwEmailCubeTransactionFact]
--
