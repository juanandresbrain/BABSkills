# dbo.vwDW_ShopperTrak_Cube_V3_d
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_ShopperTrak_Cube_V3_d"]
...
```sql
CREATE view [dbo].[vwDW_ShopperTrak_Cube_V3_d] --WITH SCHEMABINDING
as
-- =============================================================================================================
...
SELECT StoreKey AS store_key
	 ...
	 , cast(isnull(SCDLY.isShopperTrakCompTY,0) as Integer) as isSTCompLastYear
...
left join StoreCompDetail_Dim SCDLY WITH (NOLOCK)
		ON cmp.store_key = SCDLY.store_key
		AND sttf.DateKey-365=SCDLY.date_key
