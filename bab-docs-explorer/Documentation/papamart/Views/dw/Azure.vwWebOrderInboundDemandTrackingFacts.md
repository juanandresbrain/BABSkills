# Azure.vwWebOrderInboundDemandTrackingFacts
...
```mermaid
flowchart LR
    VIEW["Azure.vwWebOrderInboundDemandTrackingFacts"]
...
```sql
CREATE view [Azure].[vwWebOrderInboundDemandTrackingFacts] 
...
SELECT [OrderDate]
	 ...
	 ,[InsertDate]
  FROM [dbo].[WebOrderInboundDemandTrackingFactsV2] f
