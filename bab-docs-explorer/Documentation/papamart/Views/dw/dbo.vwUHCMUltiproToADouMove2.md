...
```mermaid
flowchart LR
    VIEW["dbo.vwUHCMUltiproToADouMove2"]
...
CREATE View [dbo].[vwUHCMUltiproToADouMove2]
AS
...
--where samaccountname in ('DanikaG','Sarahm','GeorgeW','Georgias')
),
uhcmEmps as
(
...
--and e.EepEEID = '0051216'
and e.EepEEID in ('2003511', '2016117', '2014852')
	-- limit results to records updated in past x days
--and (datediff(dd, e.UpdateDate, getdate()) < 2 or datediff(dd, e.InsertDate, getdate()) < 2)
