# dbo.vwDW_ShopperTrak_Cube_V3_backup_20230418
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_ShopperTrak_Cube_V3_backup_20230418"]
...
```sql
CREATE view [dbo].[vwDW_ShopperTrak_Cube_V3_backup_20230418] --WITH SCHEMABINDING
as
-- =============================================================================================================
