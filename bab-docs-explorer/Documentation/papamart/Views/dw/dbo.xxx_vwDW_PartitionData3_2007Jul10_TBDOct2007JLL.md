# dbo.xxx_vwDW_PartitionData3_2007Jul10_TBDOct2007JLL
...
```mermaid
flowchart LR
    VIEW["dbo.xxx_vwDW_PartitionData3_2007Jul10_TBDOct2007JLL"]
...
```sql
CREATE VIEW [dbo].[vwDW_PartitionData3_2007Jul10_TBDOct2007JLL]
AS
SELECT 'BAB DW' AS DataSourceID, 'Papa Mart' AS CubeName, 'Papa Mart' AS CubeID, 
			...
			'SELECT [dbo].[vwDW_Transactions].[date_key],[dbo].[vwDW_Transactions].[store_key],[dbo].[vwDW_Transactions].[transaction_id],[dbo].[vwDW_Transactions].[PartyFlag],[dbo].[vwDW_Transactions].[tender_group_key],[dbo].[vwDW_Transactions].[LineCount],[dbo].[vwDW_Transactions].[transaction_key],[dbo].[vwDW_Transactions].[GAAPTransactionFlag],[dbo].[vwDW_Transactions].[currency_key],[dbo].[vwDW_Transactions].[unit_net_amount],[dbo].[vwDW_Transactions].[Animal_UGA],[dbo].[vwDW_Transactions].[Non_Animal_UGA],[dbo].[vwDW_Transactions].[Footwear_UGA],[dbo].[vwDW_Transactions].[Accessories_UGA],[dbo].[vwDW_Transactions].[Sounds_UGA],[dbo].[vwDW_Transactions].[Clothing_UGA],[dbo].[vwDW_Transactions].[Other_UGA],[dbo].[vwDW_Transactions].[GaapSales],[dbo].[vwDW_Transactions].[GiftCardDiscount],[dbo].[vwDW_Transactions].[GiftCardsSoldUga],[dbo].[vwDW_Transactions].[MerchandiseUnits],[dbo].[vwDW_Transactions].[MerchandiseUga],[dbo].[vwDW_Transactions].[DonationsUga],[dbo].[vwDW_Transactions].[StuffingAndSuppliesUGA],[dbo].[vwDW_Transactions].[ShippingUGA],[dbo].[vwDW_Transactions].[OtherFeesUGA],[dbo].[vwDW_Transactions].[CubCashUGA],[dbo].[vwDW_Transactions].[PartyDepositUGA],[dbo].[vwDW_Transactions].[RewardCertificate],[dbo].[vwDW_Transactions].[BuyStuff],[dbo].[vwDW_Transactions].[Tax],[dbo].[vwDW_Transactions].[Redemptions],[dbo].[vwDW_Transactions].[CouponDiscount],[dbo].[vwDW_Transactions].[TotalDiscount],[dbo].[vwDW_Transactions].[AnimalUnits],[dbo].[vwDW_Transactions].[ShoeUnits],[dbo].[vwDW_Transactions].[SoundUnits],[dbo].[vwDW_Transactions].[UnitGrossAmount],[dbo].[vwDW_Transactions].[UnitDiscAmount],[dbo].[vwDW_Transactions].[NetSales],[dbo].[vwDW_Transactions].[CompGaapSales],[dbo].[vwDW_Transactions].[CompGAAPTransactionFlag],[dbo].[vwDW_Transactions].[CompAnimalUnits],[dbo].[vwDW_Transactions].[CompSoundUnits],[dbo].[vwDW_Transactions].[CompShoeUnits],[dbo].[vwDW_Transactions].[CompAnimal_UGA],[dbo].[vwDW_Transactions].[CompPartyFlag],[dbo].[vwDW_Transactions].[CompMerchandiseUnits],[dbo].[vwDW_Transactions].[GaapSalesForCompLY],[dbo].[vwDW_Transactions].[GAAPTransactionFlagForCompLY],[dbo].[vwDW_Transactions].[AnimalUnitsForCompLY],[dbo].[vwDW_Transactions].[SoundUnitsForCompLY],[dbo].[vwDW_Transactions].[ShoeUnitsForCompLY],[dbo].[vwDW_Transactions].[Animal_UGAForCompLY],[dbo].[vwDW_Transactions].[PartyFlagForCompLY],[dbo].[vwDW_Transactions].[MerchandiseUnitsForCompLY], FranchiseePartyCount, FranchiseePartySales, FranchiseeCompPartyCount, FranchiseePartyCountForCompLY FROM [dbo].[vwDW_Transactions] @WHERE_CLAUSE@ ' AS SQL,
