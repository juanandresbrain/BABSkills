...
```sql
CREATE VIEW [DOMO].[vwStoreDateDim] AS
-- =============================================================================================================
-- Name: [DOMO].[vwStoreDateDim] 
--
-- Description: Store dimension by date.
...
-- Revision History
--		Name:				Date:			Comments:
--		Anthony Delgado		11/11/2015		Initial creation
--		Dan Tweedie			11/30/2015		Added StoreKey to Stores CTE and changed StoreNumber to have leading 0's (0001 for example instead of 1)
--		Anthony Delgado		02/16/2016		Added PermCloseStatus
--		Anthony Delgado		03/04/2016		Added date_dim filter to only give stores through yesterday; GETDATE()-1
-- =============================================================================================================
