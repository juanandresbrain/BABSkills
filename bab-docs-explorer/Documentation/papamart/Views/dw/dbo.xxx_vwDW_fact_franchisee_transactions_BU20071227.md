# dbo.xxx_vwDW_fact_franchisee_transactions_BU20071227
...
```mermaid
flowchart LR
    VIEW["dbo.xxx_vwDW_fact_franchisee_transactions_BU20071227"]
...
```sql
create VIEW [dbo].[vwDW_fact_franchisee_transactions_BU20071227]
AS
