...
```mermaid
flowchart LR
    VIEW["Azure.vwMerchTopStyleSummary"]
...
```sql
CREATE view [Azure].[vwMerchTopStyleSummary]
...
DateDim as 
	...
	s AS (
		 Select distinct 	[TradingGroup] ,[DepartmentRank] ,[DepartmentRankPreviousWeek]
      ,[ConsumerGroupRank]      ,[ConsumerGroupRankPreviousWeek]      ,[YearToDateRank]      ,[ConsumerGroup] ,[Style]     ,[Non_PromoRetail_US_CA]
      ,[MSTAT]      ,[SalesUnits1WeekAgo]      ,[SalesUnits2WeeksAgo]      ,[SalesUnits3WeeksAgo]      ,[SalesUnitsThisYear]      ,[SalesRetailTE1WeekAgo]
      ,[AvgUnitRetail]      ,[AvgNonCLR_Markdown]      ,[Velocity]      ,[InStoreSellThroughPercentage]      ,[ChainInventory]      ,[OutletInventory]
      ,[WebInventory]      ,[Ohio980Inventory]      ,[OhioLocked1000Inventory]      ,[WC960Inventory]      ,[UK2970Inventory]      ,[DoorCount]
      ,[PastDuePlusCurrent]      ,[OnOrderNextPeriod]      ,[OnOrderNextPeriod2]      ,[OnOrderNextPeriod3]      ,[OnOrderNextPeriod4n5]
      ,[Aged]      ,[InDate]      ,[OutDate]      ,[OutDateNote]      ,[MerchWeek]      ,[ChainCode]      ,[ChainLabel]
      ,[DivisionCode]      ,[DivisionLabel]      ,[DepartmentCode]      ,[DepartmentLabel]      ,[ClassCode]
      ,[ClassLabel]      ,[SubClassCode]      ,[SubClassLabel]      ,[OutletStyles]      ,[OutletMerchandiseStatus]
      ,[WholesaleMerchandiseStatus]      ,[UnitCost]      ,[WebUSAvgUnitRetail]      ,[WebUKAvgUnitRetail]
      ,[USWebNetSalesUnits1WeekAgo]      ,[USWebNetSalesUnits2WeeksAgo]      ,[USWebNetSalesUnits3WeeksAgo]      ,[USWebNetSalesRetailTe1WeekAgo]
      ,[USWebNetSalesUnitsThisYear]      ,[UKWebNetSalesUnits1WeekAgo]      ,[UKWebNetSalesUnits2WeeksAgo]      ,[UKWebNetSalesUnits3WeeksAgo]
      ,[UKWebNetSalesRetailTe1WeekAgo]      ,[UKWebNetSalesUnitsThisYear]
	  from dwstaging.dbo.TopStyleDomoStage
	),
	ProdKey as
	(
		Select Style,Min(ProductKey) AS ProductKey
...
select 
	...
	dd.WeekEndingDate
from  s
inner  join ProdKey on S.Style = ProdKey.Style
join DateDim dd 
