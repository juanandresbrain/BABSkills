...
```mermaid
flowchart LR
    VIEW["dbo.vwBO_Transaction_Facts"]
...
```sql
-- =============================================================================================================
-- Name: [dbo].[vwBO_Transaction_Facts]
--
-- Description: ???
--
-- Dependencies: ???
...
--      ,tf.tender_amt
    ...
    from dw.dbo.tender_facts tf with (nolock)
     --changed from tender_group_dim to tender_facts  10/25/2011
...
--   changed reference from tender_grou_dim to tender_facts	-- comment
