# dbo.vwDW_ShopperTrak_Cube_V3_BACKUP20240321
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_ShopperTrak_Cube_V3_BACKUP20240321"]
...
```sql
CREATE view [dbo].[vwDW_ShopperTrak_Cube_V3_BACKUP20240321] --WITH SCHEMABINDING
as
-- =============================================================================================================
