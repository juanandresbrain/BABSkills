# dbo.vwDW_Transactions_Cube_V3_BACKUP20181008
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_Transactions_Cube_V3_BACKUP20181008"]
...
```sql
CREATE VIEW [dbo].[vwDW_Transactions_Cube_V3_BACKUP20181008]
AS
-- =============================================================================================================
...
/*  CTE removed for performance reasons
WITH hasTraf as
	(
		select 
...
FROM
	...
	INNER JOIN time_dim td WITH (NOLOCK)
		...
		--Uncomment below line and comment out net line to return to using CTE
