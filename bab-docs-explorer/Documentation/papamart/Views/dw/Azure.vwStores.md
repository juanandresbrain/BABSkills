...
```sql
CREATE VIEW [Azure].[vwStores] AS
-- =============================================================================================================
-- Name: [Azure].[vwStores]
--
-- Description: Stores to include in Azure feed.
...
--      John Eck			4/5/2018		Add company level and bear range
--      John Eck			8/23/2018        Add Warehouses
--		Ian Wallace			2/23/2021		Added CTEs for US and Franchise StoreDesign
-- =============================================================================================================
-- Corporate Stores
...
select
  ...
  FROM [dw].[DOMO].[vwMA_WarehouseDim]
	LEFT OUTER JOIN azure.StoreAttributes sa 
