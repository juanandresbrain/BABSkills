# dbo.vwDW_ShopperTrak_Cube_V3_backup_20260521
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_ShopperTrak_Cube_V3_backup_20260521"]
...
```sql
CREATE view [dbo].[vwDW_ShopperTrak_Cube_V3_backup_20260521] --WITH SCHEMABINDING
as
-- =============================================================================================================
