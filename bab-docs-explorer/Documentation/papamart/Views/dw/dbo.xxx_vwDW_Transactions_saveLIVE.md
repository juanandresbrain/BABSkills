# dbo.xxx_vwDW_Transactions_saveLIVE
...
```mermaid
flowchart LR
    VIEW["dbo.xxx_vwDW_Transactions_saveLIVE"]
...
```sql
CREATE VIEW [dbo].[vwDW_Transactions_saveLIVE]
AS
/***********************************
vwDW_Transactions_saveLIVE  as of 3/13/07
************************************/
SELECT temp.*
