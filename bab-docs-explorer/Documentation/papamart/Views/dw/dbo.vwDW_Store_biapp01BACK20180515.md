# dbo.vwDW_Store_biapp01BACK20180515
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_Store_biapp01BACK20180515"]
...
```sql
CREATE VIEW [dbo].[vwDW_Store_biapp01BACK20180515]
-- =============================================================================================================
-- Name: [dbo].[vwDW_Store_biapp01]
--
-- Description: 
--
-- Dependencies: 
...
--		Name:			Date:			Comments:
--		Gary Murrish	10/14/2013		Changed the UK Top stores per Gary Roberts.
--		Gary Murrish	10/14/2013		Removed store 255 as a Hispanic store
--		Gary Murrish	9/23/2015		Added store 255 as a Hispanic and Hispanic - Non-Mexican store per Keith Missey
--		Gary Murrish	4/5/2013		Changed CompDate Join to pull a date so that it is not null
--		Gary Murrish	4/3/2013		Completely rewrote Company section to pull from Store_dim from Store MDM
--		Gary Murrish	1/13/2015		Included DK as a company country
--		Kevin Shyr		2/18/2015		Changed UK Top store per Roger Parry
--		Brian Byas		2/12/2016		Changed UK Top store per Santiago Beltran
--		Brian Byas		5/31/2016		Changed LocationType, CompanyLevel, BearRange, JurisdictionCode for China Shanghai
--		Dan Tweedie		2018-01-23		Changed list for 'Top 7 UK Stores' per Roger Parry
-- =============================================================================================================
		...
		FROM
			(SELECT
					...
					CASE
						...
						WHEN sd.store_id in (2020,2001,2019,2022,2017,2052,2067,2051,2066,2034) THEN 'Top 7 UK Stores' --NEW LIST FROM ROGER PARRY 2018-01-23 - DAN TWEEDIE
						WHEN sd.store_id IN (2018, 2027, 2034, 2036, 2037, 2033,2045) THEN 'Other Top UK Stores' -- 2052, 2051
