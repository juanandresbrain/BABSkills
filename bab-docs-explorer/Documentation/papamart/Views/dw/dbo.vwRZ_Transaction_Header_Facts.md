# dbo.vwRZ_Transaction_Header_Facts
...
```mermaid
flowchart LR
    VIEW["dbo.vwRZ_Transaction_Header_Facts"]
...
*/
CREATE view [dbo].[vwRZ_Transaction_Header_Facts]

--alter view [dbo].[vwBABW_Transaction_Header_Facts]
as
SELECT
	/*Common Fields*/ 
	   thf.[TRN_Header_ID]
...
/*Merchandise*/ 
	...
	/*Calculated Metrics*/ 
	  ...
	  ,CASE WHEN thd.[GAAP_TRN_Flag] = 1 then thf.[Merchandise_Unit] / thd.[GAAP_TRN_Flag] ELSE 0 END  as BAGS
	  ,CASE WHEN thd.[GAAP_TRN_Flag] = 1 then thf.[GAAP_Sale] / thd.[GAAP_TRN_Flag]  ELSE 0 END  as HPG
...
/* 
  /**********BABW Product Group Metrics for Strategic Planning Start *******************/
