...
Dan Tweedie	2018-10-09	Updated view to select from new vwCRMTransactionFactSum view, crm_trn_sum_fact is being decommissioned

**********************************************************************************************/
CREATE VIEW [dbo].[vwDW_SFSGsts_biapp01]
AS
/***********************************
