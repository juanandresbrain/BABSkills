# dbo.vwDW_FlashGaapSalesByHourTYBACKUP2017
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_FlashGaapSalesByHourTYBACKUP2017"]
...
```sql
CREATE view [dbo].[vwDW_FlashGaapSalesByHourTYBACKUP2017] 
...
select 
	...
	rt.BusinessHour,  
	rt.TYGaapByHour,
	rt.TYTransactionCount as TYTransCountByHour,
