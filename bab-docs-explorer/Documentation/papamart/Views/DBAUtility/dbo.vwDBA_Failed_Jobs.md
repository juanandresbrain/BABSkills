...
```mermaid
flowchart LR
    VIEW["dbo.vwDBA_Failed_Jobs"]
    dbo_sysjobhistory(["dbo.sysjobhistory"]) --> VIEW
    dbo_sysjobs(["dbo.sysjobs"]) --> VIEW
    dbo_sysjobsteps(["dbo.sysjobsteps"]) --> VIEW
```
