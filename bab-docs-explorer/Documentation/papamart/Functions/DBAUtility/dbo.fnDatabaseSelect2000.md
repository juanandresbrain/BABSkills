...
```sql
CREATE FUNCTION [dbo].[fnDatabaseSelect2000] (@DatabaseList nvarchar(1000))

RETURNS @Database TABLE(DatabaseName nvarchar(1000) NOT NULL )

AS
-- =============================================================================================================
-- Name: fnDatabaseSelect2000
--
...
/*
select * from fnDatabaseSelect2000('DBAUtility')
select * from fnDatabaseSelect2000('USER_DATABASES, -DBAUtility')
select * from fnDatabaseSelect2000('trecs, UPCS')
select * from fnDatabaseSelect2000('USER_DATABASES, -DBAUtility, -pubs')

select * from fnDatabaseSelect2000('SYSTEM_DATABASES')
select * from fnDatabaseSelect2000('SYSTEM_DATABASES, -msdb')

select * from fnDatabaseSelect2000('SYSTEM_DATABASES, USER_DATABASES, -DBAUtility, -pubs')
