...
-- =============================================================================================================
CREATE function [dbo].[fnEmailCleansing](
	@InEmailAddress varchar(100))
returns varchar(100)
as
begin
...
--	or @OutEmailAddress like 'everyone@%'  -- appears to be used in vanity domains
	...
	or @OutEmailAddress like 'webmaster%'
	or @OutEmailAddress like '%nospam%'
	or @OutEmailAddress like 'spam%'
	or @OutEmailAddress like 'junk%'

	or @OutEmailAddress like 'noemail%'
	or @OutEmailAddress like 'unk@%'
	or @OutEmailAddress like 'unknown@%'
	or @OutEmailAddress like 'doesnothaveone%'
	or @OutEmailAddress like 'doesnthaveone%'
	or @OutEmailAddress like 'refuse@%'
