...
| StoreNameRaw | nvarchar | 510 | 1 |  |  |  |
| WeekEndingDateRaw | nvarchar | 200 | 1 |  |  |  |
| FranchiseeName | nvarchar | 100 | 1 |  |  |  |
| IsGoodRecord | bit | 1 | 1 |  |  |  |
| IsNewList | bit | 1 | 1 |  |  |  |
| IsManualList | bit | 1 | 1 |  |  |  |
