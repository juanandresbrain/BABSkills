...
**Report ID:** e65e47e9-eee2-4c12-be08-dee7d0c9c74f  
**Dataset ID:** 459ad959-d71a-481e-ae77-34987085c611  
**Web URL:** https://app.powerbi.com/groups/e996caff-15ec-41d5-ae2b-cc9137531fb6/reports/e65e47e9-eee2-4c12-be08-dee7d0c9c74f  
...
flowchart LR
    ...
    Retail_Line_Discounts__JumpMind__TransactionKey(["Retail Line Discounts (JumpMind).TransactionKey"]) --> REPORT
...
| Retail Line Discounts (JumpMind).TransactionKey |
...
| Page | Visuals |
|---|---|
| Duplicate of SA - Coupons-StrDateRef#Detail | 34 |
| Page 1 | 1 |
| SA - Coupons-StrDateRef#Detail | 34 |

## Visuals

### Duplicate of SA - Coupons-StrDateRef#Detail

| Visual | Type | Fields |
|---|---|---|
| 774f175ab9b5ee0dd78e | tableEx | Transactions (JumpMind).Business Unit Id, Calendar.Actual Date, Retail Line Discounts (JumpMind).Promo Code Id, Transactions (JumpMind).Username Id, Sum(Retail Line Discounts (JumpMind).GrossLineAmt), Sum(Retail Line Discounts (JumpMind).CouponValue), Transactions (JumpMind).eCommOrderType, Tender Lines (JumpMind).Balance Tender Amount (Native), Retail Line Discounts (JumpMind).TransactionKey |
| 2fcde05d7f52dba9282c | unknown |  |
| b17d1e37f1bf85285032 | slicer | Transactions (JumpMind).Transaction Key |
| 667f01f0f12d59160163 | slicer | Transactions (JumpMind).retail_transaction_id |
| b6c6c54dbde9b57db3c9 | slicer | Transactions (JumpMind).Username Id |
| 13b27a2eae94e9a3065c | slicer | Retail Line Discounts (JumpMind).Promo Code Id |
| 7b211e94e4cff01957bd | slicer | Transactions (JumpMind).Business Unit Id |
| 009380d165e825321860 | textbox |  |
| cfc591a92420555ef54e | unknown |  |
| 26bd6651987dc01def3b | textbox |  |
| b5c1cbc9217b7a547939 | textbox |  |
| ed498d092df8dac2ceff | image |  |
| b378e0781feebc1f40f5 | textbox |  |
| 924582cd1d4d3a874b54 | actionButton |  |
| c09d54b4b39626048594 | unknown |  |
| 0c182040c3a132119c85 | slicer | Locations (Store MDM).Active |
| 724377bc68c74bf854a6 | slicer | Locations (Store MDM).Country |
| ecce576ba2900ec0bce2 | slicer | Locations (Store MDM).Location Line |
| 04b83953cc73ce9a7c68 | slicer | Calendar.Fiscal Year (Header), Calendar.Fiscal Quarter (Header), Calendar.Fiscal Month (Header), Calendar.Fiscal Week (Header), Calendar.Actual Date |
| 9708d349159cfe8a887c | slicer | Products (PLM).Subclass, Products (PLM).Class |
| 1e0eeb11a2549a279292 | slicer | Products (PLM).Department |
| 4f27a550513fd964b1ed | unknown |  |
| 541501083e9d847e3580 | bookmarkNavigator |  |
| f0ffc5d9971d48644571 | slicer | Calendar.Calendar Year (Header), Calendar.Calendar Quarter (Header), Calendar.Calendar Month (Header), Calendar.Calendar Week (Header) |
| 985fdf9b0f71c397bd02 | slicer | Calendar.Actual Date |
| 91bb75dd34631e9d066d | unknown |  |
| ac97a9361bfb49e7507e | bookmarkNavigator |  |
| ee8ada85cbbd3b4874fa | slicer | Locations (Store MDM).Country name, Locations (Store MDM).State/Province name, Locations (Store MDM).City |
| bc0d4b0a265890fbbdac | textbox |  |
| 773cc6f18fee1e93481d | slicer | Retail Lines (JumpMind).Line Item Type |
| cff82574ab528cef276f | slicer | Retail Lines (JumpMind).Item Type |
| d3ec0826f5a07fb02dce | slicer | Products (PLM).Item Line |
| 457ff988871d48a9402d | slicer | Products (PLM).Licensed Collection |
| 7ff836f4e4312824176d | slicer | Products (PLM).Key Story |

### Page 1

| Visual | Type | Fields |
|---|---|---|
| 3aeda5dec536fd95d7c0 | tableEx | Transactions (JumpMind).Business Unit Id, Calendar.Actual Date, Retail Line Discounts (JumpMind).Promo Code Id, Transactions (JumpMind).Username Id, Sum(Retail Line Discounts (JumpMind).GrossLineAmt), Sum(Retail Line Discounts (JumpMind).CouponValue), Transactions (JumpMind).eCommOrderType, Tender Lines (JumpMind).Balance Tender Amount (Native), Retail Line Discounts (JumpMind).TransactionKey |

### SA - Coupons-StrDateRef#Detail

| Visual | Type | Fields |
|---|---|---|
| 39db280e87d5b63b451c | tableEx | Transactions (JumpMind).Business Unit Id, Calendar.Actual Date, Retail Line Discounts (JumpMind).Promo Code Id, Transactions (JumpMind).Username Id, Sum(Retail Line Discounts (JumpMind).GrossLineAmt), Sum(Retail Line Discounts (JumpMind).CouponValue), Transactions (JumpMind).eCommOrderType, Transactions (JumpMind).Transaction Key, Transactions (JumpMind).retail_transaction_id, Tender Lines (JumpMind).Balance Tender Amount (Native), Retail Line Discounts (JumpMind).TransactionKey |
