...
**Report ID:** 6f22968e-6096-437a-82ac-b1de01bf580f  
**Dataset ID:** 459ad959-d71a-481e-ae77-34987085c611  
**Web URL:** https://app.powerbi.com/groups/e996caff-15ec-41d5-ae2b-cc9137531fb6/reports/6f22968e-6096-437a-82ac-b1de01bf580f  
...
```mermaid
flowchart LR
    REPORT["Gift Card Redemptions Report"]
    ...
    Measure_Table_Redeemed_Gift_Card_Units(["Measure Table.Redeemed Gift Card Units"]) --> REPORT
...
| 9a7956cae86f44783ec2 | slicer | Transactions (JumpMind).Capture Date CST |
...
| a5210cecc0160b36c8b4 | tableEx | Transactions (JumpMind).Business Unit Id, Transactions (JumpMind).Till Id, Transactions (JumpMind).Begin Time, Measure Table.Redeemed Gift Card Units, Measure Table.Redeemed Gift Card Tender Amount (Native), Tender Lines (JumpMind).ISO Currency Code, Transactions (JumpMind).Transaction Key, Locations (Store MDM).Legal Entity (D365), Transactions (JumpMind).Username Id, Transactions (JumpMind).retail_transaction_id, Tender Card Lines (JumpMind).Card Number, Transactions (JumpMind).Capture Date CST |
| 3907067465cb97118580 | textbox |  |
| 172c32e50b240ce9090b | slicer | Transactions (JumpMind).Associate Work Group |
| 9a867bcecd3d326e700a | slicer | Tender Card Lines (JumpMind).Card Number |
