...
**Report ID:** a5e3c07a-90e5-48db-a0b5-7b30e6da164d  
**Dataset ID:** 459ad959-d71a-481e-ae77-34987085c611  
**Web URL:** https://app.powerbi.com/groups/e996caff-15ec-41d5-ae2b-cc9137531fb6/reports/a5e3c07a-90e5-48db-a0b5-7b30e6da164d  
...
flowchart LR
    ...
    Measure_Table_Transaction_Number1(["Measure Table.Transaction Number1"]) --> REPORT
...
| Measure Table.Transaction Number1 |
...
| e25d54e0e04c65f98c34 | tableEx | Calendar.Actual Date, Transactions (JumpMind).Business Unit Id, Transactions (JumpMind).Username Id, Sum(Retail Lines (JumpMind).Total Tender Amount (Native Currency)), Retail Transactions (JumpMind).Loyalty Card Number, Retail Transactions (JumpMind).Customer Name, Locations (Store MDM).Address line 1, Locations (Store MDM).Address line 2, Locations (Store MDM).City, Locations (Store MDM).State/Province name, Locations (Store MDM).Postal code, Measure Table.Transaction Number1 |
