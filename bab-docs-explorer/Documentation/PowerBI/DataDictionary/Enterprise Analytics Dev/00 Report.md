...
**Report ID:** dc309f6b-018d-4b09-95d6-2a5acf35508b  
**Dataset ID:** 05daff4b-5e80-4cd4-94ba-90a3110d5e14  
**Web URL:** https://app.powerbi.com/groups/109bd275-5f44-4366-b343-9b41b5cfb040/reports/dc309f6b-018d-4b09-95d6-2a5acf35508b  
...
| 8c625018213a68a7c8ed | slicer | InventJourTransView.IB Inventory ID |
...
| cca534870a339e0a3de8 | slicer | product_dim_le.color_code |
| cca8d761cff72ee6b8d5 | bookmarkNavigator |  |
| d986b5ee6dd8555a4031 | slicer | d365LocationMapping_View.inventlocationid |
| e0290b3bdcd982dcae6f | tableEx | product_dim_le.style_code, product_dim_le.style_desc, InventJourTransView.Inventory Trans Date, product_dim_le.department_code, InventJourTransView.Inventory Document Number, Sum(InventJourTransView.InventoryTrans Units), Sum(InventJourTransView.Inventory Trans Cost), product_dim_le.color_code, InventJourTransView.Inventory Status Description, InventJourTransView.Inventory Trans Type Code, InventJourTransView.Inventory Trans Type Desc, InventJourTransView.IB Inventory ID, Sum(InventJourTransView.Inventory Trans Retail), select, InventJourTransView.Inventory Status Code, d365LocationMapping_View.inventlocationid |
