...
**Report ID:** 5fc7f334-ffe1-4e8b-b466-192b465a1e3a  
**Dataset ID:** 4a998365-013a-45f6-8e8d-7d5b7881b943  
**Web URL:** https://app.powerbi.com/groups/00856575-de9c-435b-ad8d-2ac43b338e3d/reports/5fc7f334-ffe1-4e8b-b466-192b465a1e3a  
...
flowchart LR
    ...
    Retail_Lines__JumpMind__Returned_Tender_Amount__Native_(["Retail Lines (JumpMind).Returned Tender Amount (Native)"]) --> REPORT
...
| 71767577d6c77c4ea9c3 | tableEx | Calendar.Actual Date, Transactions (JumpMind).Business Unit Id, Transactions (JumpMind).Username Id, Retail Transactions (JumpMind).Loyalty Card Number, Retail Transactions (JumpMind).Customer Name, Retail Lines (JumpMind).Returned Tender Amount (Native), Retail Lines (JumpMind).ISO Currency Code, Transactions (JumpMind).Transaction Key, Transactions (JumpMind).Till Id |
