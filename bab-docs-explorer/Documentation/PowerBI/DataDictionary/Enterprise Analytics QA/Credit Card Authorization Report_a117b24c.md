...
**Report ID:** a117b24c-d11a-4c38-b9c4-362850396b6c  
**Dataset ID:** 4a998365-013a-45f6-8e8d-7d5b7881b943  
**Web URL:** https://app.powerbi.com/groups/00856575-de9c-435b-ad8d-2ac43b338e3d/reports/a117b24c-d11a-4c38-b9c4-362850396b6c  
...
flowchart LR
    ...
    Tender_Card_Lines__JumpMind__Brand(["Tender Card Lines (JumpMind).Brand"]) --> REPORT
...
| Tender Card Lines (JumpMind).Brand |
...
| 80a7d99c534dd0a90cd2 | tableEx | Calendar.Actual Date, Transactions (JumpMind).Business Unit Id, Sum(Tender Lines (JumpMind).Tender Amount (Native Currency)), Tender Card Lines (JumpMind).Masked Card Number, Tender Lines (JumpMind).ISO Currency Code, Tender Card Lines (JumpMind).Brand, Tender Card Lines (JumpMind).Expiration Date, Tender Card Lines (JumpMind).Entry Mode, Tender Card Lines (JumpMind).Tender Type Code, Transactions (JumpMind).Transaction Key, Transactions (JumpMind).Till Id, Transaction Summaries (JumpMind).Tender1 Authorization Code |
