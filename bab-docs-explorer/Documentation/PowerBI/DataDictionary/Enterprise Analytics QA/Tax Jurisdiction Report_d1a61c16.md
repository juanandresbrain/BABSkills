...
**Report ID:** d1a61c16-c573-4984-9df4-f1e3843b21b1  
**Dataset ID:** 4a998365-013a-45f6-8e8d-7d5b7881b943  
**Web URL:** https://app.powerbi.com/groups/00856575-de9c-435b-ad8d-2ac43b338e3d/reports/d1a61c16-c573-4984-9df4-f1e3843b21b1  
...
```mermaid
flowchart LR
    REPORT["Tax Jurisdiction Report"]
...
| 8ab16bd6a290b5a76eb5 | pivotTable | Measure Table.Money Tax Amount (Native), Min(Tax Lines (JumpMind).ISO Currency Code), Tax Lines (JumpMind).Rule Name, CountNonNull(Tax Lines (JumpMind).Tax Percentage), Measure Table.Taxable Amount (Native) \| Merchandise, Measure Table.Taxable Amount (Native) \| Fees, Tax Lines (JumpMind).Tax Type, Measure Table.Non-Taxable Amount (Native) \| Merchandise, Measure Table.Non-Taxable Amount (Native) \| Fees, Measure Table.Tax Amount (Native), Locations (Store MDM).Country name, Locations (Store MDM).State/Province name, Locations (Store MDM).Location Line |
