...
**Report ID:** d58da231-94d5-4b42-8dac-cfe3e20ecafc  
**Dataset ID:** 4a998365-013a-45f6-8e8d-7d5b7881b943  
**Web URL:** https://app.powerbi.com/groups/00856575-de9c-435b-ad8d-2ac43b338e3d/reports/d58da231-94d5-4b42-8dac-cfe3e20ecafc  
...
| Visual | Type | Fields |
|---|---|---|
| 3614449496953b977290 | tableEx | Calendar.Actual Date, Transactions (JumpMind).Business Unit Id, Sum(Tender Lines (JumpMind).Tender Amount (Native Currency)), Tender Lines (JumpMind).Tender Code, Tender Lines (JumpMind).Tender Type Code, Tender Lines (JumpMind).ISO Currency Code, Transactions (JumpMind).Transaction Key, Transactions (JumpMind).Till Id |
