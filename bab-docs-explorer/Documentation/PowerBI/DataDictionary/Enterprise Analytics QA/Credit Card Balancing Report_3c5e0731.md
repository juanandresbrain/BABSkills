...
**Report ID:** 3c5e0731-9c25-4709-bbe0-3b73e9e34989  
**Dataset ID:** 4a998365-013a-45f6-8e8d-7d5b7881b943  
**Web URL:** https://app.powerbi.com/groups/00856575-de9c-435b-ad8d-2ac43b338e3d/reports/3c5e0731-9c25-4709-bbe0-3b73e9e34989  
...
```mermaid
flowchart LR
    REPORT["Credit Card Balancing Report"]
    ...
    Measure_Table_Total_Visa_Payment_Amount__Native_(["Measure Table.Total Visa Payment Amount (Native)"]) --> REPORT
    Measure_Table_Total_MasterCard_Payment_Amount__Native_(["Measure Table.Total MasterCard Payment Amount (Native)"]) --> REPORT
    Measure_Table_Total_Visa_MasterCard_Payment_Amount__Native_(["Measure Table.Total Visa/MasterCard Payment Amount (Native)"]) --> REPORT
    Measure_Table_Total_Debit___Credit_Payment_Amount__Native_(["Measure Table.Total Debit & Credit Payment Amount (Native)"]) --> REPORT
    Measure_Table_Total_E_Wallet_Payment_Amount__Native_(["Measure Table.Total E-Wallet Payment Amount (Native)"]) --> REPORT
    Measure_Table_Total_Electronic_Payment_Amount__Native_(["Measure Table.Total Electronic Payment Amount (Native)"]) --> REPORT
    ...
    Measure_Table_Total_Discover_Payment_Amount__Native_(["Measure Table.Total Discover Payment Amount (Native)"]) --> REPORT
    Measure_Table_Total_American_Express_Payment_Amount__Native_(["Measure Table.Total American Express Payment Amount (Native)"]) --> REPORT
...
| fee107c9627d1e0ad329 | tableEx | Calendar.Actual Date, Transactions (JumpMind).Business Unit Id, Measure Table.Total Visa Payment Amount (Native), Measure Table.Total MasterCard Payment Amount (Native), Measure Table.Total Visa/MasterCard Payment Amount (Native), Measure Table.Total Debit & Credit Payment Amount (Native), Measure Table.Total E-Wallet Payment Amount (Native), Measure Table.Total Electronic Payment Amount (Native), Tender Lines (JumpMind).ISO Currency Code, Transactions (JumpMind).Till Id, Measure Table.Total Discover Payment Amount (Native), Measure Table.Total American Express Payment Amount (Native), Business Units (JumpMind).Business Unit Name, Locations (Store MDM).Legal Entity (D365) |
