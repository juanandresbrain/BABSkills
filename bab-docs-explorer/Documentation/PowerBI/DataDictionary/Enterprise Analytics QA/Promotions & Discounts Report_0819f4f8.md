# Promotions & Discounts Report

**Workspace:** Enterprise Analytics QA  
**Report ID:** 0819f4f8-4dad-4ca7-80a4-56b7eb54c602  
**Dataset ID:** 4a998365-013a-45f6-8e8d-7d5b7881b943  
**Web URL:** https://app.powerbi.com/groups/00856575-de9c-435b-ad8d-2ac43b338e3d/reports/0819f4f8-4dad-4ca7-80a4-56b7eb54c602  
...
```mermaid
flowchart LR
    REPORT["Promotions & Discounts Report"]
    ...
    Retail_Line_Discounts__JumpMind__Discount_Line_Type(["Retail Line Discounts (JumpMind).Discount Line Type"]) --> REPORT
    Retail_Line_Discounts__JumpMind__Modification_Amount__Native____Returns(["Retail Line Discounts (JumpMind).Modification Amount (Native) | Returns"]) --> REPORT
    Retail_Line_Discounts__JumpMind__Modification_Amount__Native____Sales(["Retail Line Discounts (JumpMind).Modification Amount (Native) | Sales"]) --> REPORT
    Retail_Line_Discounts__JumpMind__Modification_Amount__Native_(["Retail Line Discounts (JumpMind).Modification Amount (Native)"]) --> REPORT
    Retail_Line_Discounts__JumpMind__Description(["Retail Line Discounts (JumpMind).Description"]) --> REPORT
    Retail_Line_Discounts__JumpMind__Promotion_Type(["Retail Line Discounts (JumpMind).Promotion Type"]) --> REPORT
    Retail_Line_Discounts__JumpMind__ISO_Currency_Code(["Retail Line Discounts (JumpMind).ISO Currency Code"]) --> REPORT
```
...
| Retail Line Discounts (JumpMind).Discount Line Type |
...
| Retail Line Discounts (JumpMind).Description |
| Retail Line Discounts (JumpMind).Promotion Type |
| Retail Line Discounts (JumpMind).ISO Currency Code |
...
| aec4ebc52927b608c302 | pivotTable | Retail Line Discounts (JumpMind).Discount Line Type, Retail Line Discounts (JumpMind).Modification Amount (Native) \| Returns, Retail Line Discounts (JumpMind).Modification Amount (Native) \| Sales, Retail Line Discounts (JumpMind).Modification Amount (Native), Retail Line Discounts (JumpMind).Description, Retail Line Discounts (JumpMind).Promotion Type, Retail Line Discounts (JumpMind).ISO Currency Code |
