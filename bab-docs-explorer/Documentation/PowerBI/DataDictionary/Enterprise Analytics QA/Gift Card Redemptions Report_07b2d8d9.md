...
**Report ID:** 07b2d8d9-f123-4f8a-8b69-25c09d92ba95  
**Dataset ID:** 4a998365-013a-45f6-8e8d-7d5b7881b943  
**Web URL:** https://app.powerbi.com/groups/00856575-de9c-435b-ad8d-2ac43b338e3d/reports/07b2d8d9-f123-4f8a-8b69-25c09d92ba95  
...
| a5210cecc0160b36c8b4 | tableEx | Calendar.Actual Date, Transactions (JumpMind).Business Unit Id, Transactions (JumpMind).Till Id, Tender Card Lines (JumpMind).Card Number, Transactions (JumpMind).Begin Time, Measure Table.Redeemed Gift Card Units, Measure Table.Redeemed Gift Card Tender Amount (Native), Tender Lines (JumpMind).ISO Currency Code, Transactions (JumpMind).Transaction Key, Locations (Store MDM).Legal Entity (D365), Transactions (JumpMind).Username Id |
