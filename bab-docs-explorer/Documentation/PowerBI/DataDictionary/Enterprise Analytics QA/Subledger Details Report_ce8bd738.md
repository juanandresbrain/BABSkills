# Subledger Details Report

**Workspace:** Enterprise Analytics QA  
**Report ID:** ce8bd738-238d-47c3-a87a-29e5f5840949  
**Dataset ID:** 4a998365-013a-45f6-8e8d-7d5b7881b943  
**Web URL:** https://app.powerbi.com/groups/00856575-de9c-435b-ad8d-2ac43b338e3d/reports/ce8bd738-238d-47c3-a87a-29e5f5840949  
...
```mermaid
flowchart LR
    REPORT["Subledger Details Report"]
    ...
    Tender_Lines__JumpMind__Debit_Tender_Amount__Native_(["Tender Lines (JumpMind).Debit Tender Amount (Native)"]) --> REPORT
    Tender_Lines__JumpMind__Credit_Tender_Amount__Native_(["Tender Lines (JumpMind).Credit Tender Amount (Native)"]) --> REPORT
    ...
    Tender_Lines__JumpMind__Tender_Object_Action(["Tender Lines (JumpMind).Tender Object-Action"]) --> REPORT
```
...
| select |
| Tender Lines (JumpMind).Tender Object-Action |
...
| 987cf8ad961adced7472 | pivotTable | Business Units (JumpMind).Location Line, Tender Lines (JumpMind).Debit Tender Amount (Native), Tender Lines (JumpMind).Credit Tender Amount (Native), Tender Lines (JumpMind).Balance Tender Amount (Native), select, Tender Lines (JumpMind).Tender Object-Action |
