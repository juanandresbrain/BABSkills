...
**Report ID:** bd7d8747-87c7-4e19-bb80-f66fbb2b06a7  
**Dataset ID:** 4a998365-013a-45f6-8e8d-7d5b7881b943  
**Web URL:** https://app.powerbi.com/groups/00856575-de9c-435b-ad8d-2ac43b338e3d/reports/bd7d8747-87c7-4e19-bb80-f66fbb2b06a7  
...
```mermaid
flowchart LR
    REPORT["Transaction Lookup Report"]
    ...
    Measure_Table_Receipt_Quantity(["Measure Table.Receipt Quantity"]) --> REPORT
```
...
| ce609736ce723b0610a6 | pivotTable | Retail Lines (JumpMind).Transaction Key, Retail Lines (JumpMind).Item Line, Sum(Retail Lines (JumpMind).Total Tender Amount (Native Currency)), Sum(Retail Lines (JumpMind).Actual Sales Amount TE (Native Currency)), Sum(Retail Lines (JumpMind).Tax Amount (Native Currency)), Retail Lines (JumpMind).ISO Currency Code, Measure Table.Receipt Quantity |
