...
**Report ID:** 8963e58e-8480-43ca-8186-6ad3ae925215  
**Dataset ID:** 4a998365-013a-45f6-8e8d-7d5b7881b943  
**Web URL:** https://app.powerbi.com/groups/00856575-de9c-435b-ad8d-2ac43b338e3d/reports/8963e58e-8480-43ca-8186-6ad3ae925215  
...
| bb1c4600a0d02dd677c9 | tableEx | Calendar.Actual Date, Transactions (JumpMind).Business Unit Id, Transactions (JumpMind).Username Id, Sum(Retail Lines (JumpMind).Total Tender Amount (Native Currency)), Retail Lines (JumpMind).ISO Currency Code, Retail Transactions (JumpMind).Loyalty Card Number, Retail Transactions (JumpMind).Customer Name, Transactions (JumpMind).Transaction Key, Transactions (JumpMind).Associate Name, Business Units (JumpMind).Business Unit Name |
