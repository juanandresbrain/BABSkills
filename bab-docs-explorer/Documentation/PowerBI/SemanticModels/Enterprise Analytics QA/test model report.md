...
|---|---|---|
| powerbi://api.powerbi.com/v1.0/myorg/Enterprise%20Analytics%20QA | Sales Audit Data Model | [Enterprise Analytics QA/Sales Audit Data Model](../Enterprise Analytics QA/Sales Audit Data Model.md) _(PowerBI composite-model link, not a SQL source)_ |
