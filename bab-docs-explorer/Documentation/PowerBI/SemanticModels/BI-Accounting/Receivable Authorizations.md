...
**Dataset ID:** 491f288a-c29b-48b9-aaed-a6b3fd034c04  
...
```sql
let
    Source = Sql.Database("4db76rlxaxcuvmuh5kw37wbnqq-ovsykae43znuhlmnflcdwm4ohu.datawarehouse.fabric.microsoft.com", "LH_Source", [CreateNavigationProperties=false, Query="select * FROM [dbo].[rpt_receivable_authorizations]"]),
