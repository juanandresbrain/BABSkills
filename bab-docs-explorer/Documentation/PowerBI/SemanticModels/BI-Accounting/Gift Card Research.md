...
**Dataset ID:** d58c8f5b-4dc9-4d90-954b-e7b3f11086bd  
...
| GCResearch | 28 | 0 |  |
| LocalDateTable_40036606-0332-4311-85a8-b20fc578afd8 | 8 | 0 | Yes |
...
```sql
let
    Source = Sql.Database("4db76rlxaxcuvmuh5kw37wbnqq-ovsykae43znuhlmnflcdwm4ohu.datawarehouse.fabric.microsoft.com", "LH_Source", [CreateNavigationProperties=false, Query="select *  FROM  rpt_gc_transaction_details"]),
    #"Changed Type" = Table.TransformColumnTypes(Source,{{"Business Date", type date}})
in
    #"Changed Type"
```

### LocalDateTable_40036606-0332-4311-85a8-b20fc578afd8

```sql
Calendar(Date(Year(MIN('GCResearch'[Entry DateTime])), 1, 1), Date(Year(MAX('GCResearch'[Entry DateTime])), 12, 31))
```
