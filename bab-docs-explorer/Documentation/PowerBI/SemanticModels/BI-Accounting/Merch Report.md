...
**Dataset ID:** aea233fb-bce7-451a-aa22-27d1397206bc  
...
```sql
let
    Source = Sql.Database("4db76rlxaxcuvmuh5kw37wbnqq-ovsykae43znuhlmnflcdwm4ohu.datawarehouse.fabric.microsoft.com", "LH_Source", [CreateNavigationProperties=false, Query="select * from dbo.rpt_merch_report"]),
