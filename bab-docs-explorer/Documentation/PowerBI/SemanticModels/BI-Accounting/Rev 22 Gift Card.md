...
**Dataset ID:** 495f992e-ae53-44c2-8180-d11c5c591643  
...
| Rev22 | 13 | 0 |  |
| LocalDateTable_b1644269-1947-4b25-90f8-eea0221260be | 8 | 0 | Yes |
...
```sql
let
    Source = Sql.Database("4db76rlxaxcuvmuh5kw37wbnqq-ovsykae43znuhlmnflcdwm4ohu.datawarehouse.fabric.microsoft.com", "LH_Source", [CreateNavigationProperties=false, Query="select * from dbo.rpt_rev_22"]),
    #"Changed Type1" = Table.TransformColumnTypes(Source,{{"Activation Date", type date}, {"Last Positive Transaction Date", type date}})
in
    #"Changed Type1"
```

### LocalDateTable_b1644269-1947-4b25-90f8-eea0221260be

```sql
Calendar(Date(Year(MIN('Rev22'[Last Positive Transaction Date])), 1, 1), Date(Year(MAX('Rev22'[Last Positive Transaction Date])), 12, 31))
```
