...
| MerchBearRangeKey | float | 8 | 1 |  |  |  |
| MerchCountryKey | float | 8 | 1 |  |  |  |
| MerchRegionKey | float | 8 | 1 |  |  |  |
| MerchBearitoryKey | float | 8 | 1 |  |  |  |
| CountryKey | float | 8 | 1 |  |  |  |
| RankedCompanyLevelKey | float | 8 | 1 |  |  |  |
| RankedBearRangeKey | float | 8 | 1 |  |  |  |
| RankedRegionKey | float | 8 | 1 |  |  |  |
| RankedBearitoryKey | float | 8 | 1 |  |  |  |
| BearRangeKey | float | 8 | 1 |  |  |  |
| RegionKey | float | 8 | 1 |  |  |  |
| BearitoryKey | float | 8 | 1 |  |  |  |
| city_key | float | 8 | 1 |  |  |  |
| city_display | varchar | 8000 | 1 |  |  |  |
| postal_code_key | float | 8 | 1 |  |  |  |
| postal_code_display | varchar | 8000 | 1 |  |  |  |
| GeographyParentCountryKey | float | 8 | 1 |  |  |  |
| GeographyRegionKey | float | 8 | 1 |  |  |  |
