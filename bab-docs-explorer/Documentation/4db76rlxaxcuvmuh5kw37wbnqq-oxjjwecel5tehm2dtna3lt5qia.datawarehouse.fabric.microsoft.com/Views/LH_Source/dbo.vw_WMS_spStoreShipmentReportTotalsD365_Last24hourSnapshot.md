# dbo.vw_WMS_spStoreShipmentReportTotalsD365_Last24hourSnapshot
...
```mermaid
flowchart LR
    VIEW["dbo.vw_WMS_spStoreShipmentReportTotalsD365_Last24hourSnapshot"]
...
```sql
CREATE view dbo.vw_WMS_spStoreShipmentReportTotalsD365_Last24hourSnapshot
as 
with totals1 as
(
...
where DATEDIFF(hh, ShipConfirmUTCDateTime, getdate()) <= 32  
