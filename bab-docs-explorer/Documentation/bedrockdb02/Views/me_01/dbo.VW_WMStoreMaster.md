...
```sql
CREATE view [dbo].[VW_WMStoreMaster]
...
select 	'980' as WHSE,
	...
	case 
		...
		when l.location_code in ('0420','0421','0422','0423','0424','0425','0443','0444','0445','0446','0447','0448','0449','0451','0452','0453','0454','0457','0458','0459','0466','0467','0468')  --Changed by Lizzy T on 10/01/2019 per request of Santiago Beltran
			then 'Walmart/Build-A-Bear #' + l.location_code
		else
