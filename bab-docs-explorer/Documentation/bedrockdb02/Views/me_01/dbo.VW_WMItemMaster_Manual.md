...
```mermaid
flowchart LR
    VIEW["dbo.VW_WMItemMaster_Manual"]
...
```sql
CREATE view [dbo].[VW_WMItemMaster_Manual]
as
select m.*
from
...
where m.style in ('055663','055664','055665','055666','055667','055668')
```
