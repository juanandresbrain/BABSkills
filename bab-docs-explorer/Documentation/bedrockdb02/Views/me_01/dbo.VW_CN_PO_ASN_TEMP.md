...
```sql
CREATE view [dbo].[VW_CN_PO_ASN_TEMP]
...
WITH view1 (po_id, po_line_id, line_no, expected_receipt_date, color_code, location_code, location_name, style_code, long_desc, total_line_loc_ordered_units) 
	...
	as (
		SELECT 
			...
			--	else	cast( (j.ordered_units / s.distribution_multiple) as int)
		...
		where l1.location_code in ('3980')
		and j.ordered_units <> 0
		--and datediff(dd, f.expected_receipt_date, getdate()+7) = 0 
		--and cast(f.expected_receipt_date as date) < cast(getdate()+7 as date)
		)
select cast((cast(PurchaseOrder as varchar) + FactoryCode) as nvarchar) ASN,
	   ...
	   cast(isnull(replace(Units, ',', '') , '') as nvarchar) Units,  
...
from Summary
where PurchaseOrder in ('1062982','1062984','1062987','1062989','1062990','1062994','1062996','1062998','1063000','1063007','1063008','1063009','1063010','1063015','1063022','1063140','1063191','1063278','1063302','1063305','1063306','1063307','1063373','1063384','1063386','1063387','1063388','1063389','1063390','1063391','1063392','1063393','1063394','1063397','1063398','1063399','1063400','1063401','1063403','1063404','1063405','1063406','1063410','1063411','1063412','1063414','1063415','1063416','1063417','1063418','1063419','1063420','1063434')
```
