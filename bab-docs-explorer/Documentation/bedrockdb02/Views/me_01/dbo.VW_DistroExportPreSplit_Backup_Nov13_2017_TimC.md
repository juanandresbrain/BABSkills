# dbo.VW_DistroExportPreSplit_Backup_Nov13_2017_TimC
...
```mermaid
flowchart LR
    VIEW["dbo.VW_DistroExportPreSplit_Backup_Nov13_2017_TimC"]
...
```sql
CREATE view [dbo].[VW_DistroExportPreSplit_Backup_Nov13_2017_TimC]
as 
...
--	or l2.location_code = '0312'-- Only to specific store when distro specially requests
		)
union all
select	l1.location_code as sourceid,
		l2.location_code as destid,
