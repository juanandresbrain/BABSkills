...
```sql
create view dbo.view_imrd_rtv_no_po 
...
FROM dbo.inv_move_req_from_loc,dbo.inventory_move_request, dbo.vendor
...
AND inventory_move_request.po_id IS NULL
```
