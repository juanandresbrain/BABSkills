# dbo.vw_StationConfiguration_Styles_BJB20190114
...
```mermaid
flowchart LR
    VIEW["dbo.vw_StationConfiguration_Styles_BJB20190114"]
...
```sql
CREATE VIEW [dbo].[vw_StationConfiguration_Styles_BJB20190114]
AS
