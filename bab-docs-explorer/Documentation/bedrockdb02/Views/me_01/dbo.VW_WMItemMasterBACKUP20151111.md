# dbo.VW_WMItemMasterBACKUP20151111
...
```mermaid
flowchart LR
    VIEW["dbo.VW_WMItemMasterBACKUP20151111"]
...
```sql
CREATE view [dbo].[VW_WMItemMasterBACKUP20151111]
as
select m.*
from
	...
	(select '001' as CO,
		...
		replace(replace(s.short_desc,'"',' ') ,'[',' ') as SKU_DESC,
		'' as CARTON_TYPE,
