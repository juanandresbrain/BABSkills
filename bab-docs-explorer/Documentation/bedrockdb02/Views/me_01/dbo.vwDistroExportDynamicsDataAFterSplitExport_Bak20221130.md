# dbo.vwDistroExportDynamicsDataAFterSplitExport_Bak20221130
...
```mermaid
flowchart LR
    VIEW["dbo.vwDistroExportDynamicsDataAFterSplitExport_Bak20221130"]
...
```sql
CREATE view [dbo].[vwDistroExportDynamicsDataAFterSplitExport_Bak20221130]
...
(
	select		
		...
		case 
			when SourceID in ('3970','8502','3980','8505')
			then 
				case 
...
select 
	...
	DynId, 
	SourceID,
	cast(DestID as varchar (5)) as Destid,
	rec_type,
	message,
	style_code,
	quantity, 
