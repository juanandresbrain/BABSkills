# dbo.VW_DistroExportPreSplit_manual
...
```mermaid
flowchart LR
    VIEW["dbo.VW_DistroExportPreSplit_manual"]
...
```sql
CREATE view [dbo].[VW_DistroExportPreSplit_manual]
as 
...
and		(isnull(ats.attribute_set_code,1) >= 50
	...
	or l2.location_code in ('0015','0153')-- Only to specific store when distro specially requests
		)
*/
union all
select	l1.location_code as sourceid,
