...
```sql
create view dbo.view_carton_transfer 	(doc_type,
	doc_no,
	from_location_id,
	to_location_id,
	create_date,
...
FROM carton_document_map, transfer
WHERE document_type = 1
AND document_id = transfer_id
AND document_status IN (3, 4)
```
