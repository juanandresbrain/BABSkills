# dbo.vwWMSPOStagedForDynamicsBACKUP20210628
...
```mermaid
flowchart LR
    VIEW["dbo.vwWMSPOStagedForDynamicsBACKUP20210628"]
...
```sql
create view [dbo].[vwWMSPOStagedForDynamicsBACKUP20210628] as
