# dbo.vwWMSPOStagedForDynamicsBAK20230328
...
```mermaid
flowchart LR
    VIEW["dbo.vwWMSPOStagedForDynamicsBAK20230328"]
...
```sql
CREATE view  [dbo].[vwWMSPOStagedForDynamicsBAK20230328] as
...
where 1=1
and po.ShipToID in (980,960,13,2970,3970,3980,2991)
