# dbo.vwItem_BABWSupplyItems_CN_V2
...
```mermaid
flowchart LR
    VIEW["dbo.vwItem_BABWSupplyItems_CN_V2"]
...
```sql
CREATE VIEW [dbo].[vwItem_BABWSupplyItems_CN_V2]
AS
...
AS
(
	SELECT TOP 100 PERCENT RIGHT('000000' + RIGHT(a.PRODUCTNUMBER, 6), 12) AS 'upc_number'
	...
	WHERE a.Entity = 1100 AND a.PRODUCTNUMBER LIKE 'S8[0-9][0-9][0-9][0-9][0-9]'
	GROUP BY a.PRODUCTNUMBER, d.PRODUCTNAME, a.UNITCOST--, c2.FACTOR
