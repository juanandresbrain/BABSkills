...
```mermaid
flowchart LR
    VIEW["dbo.vwPOSOutbound_Promotions"]
...
```sql
CREATE view [dbo].[vwPOSOutbound_Promotions]

--------------------------------------------------------------------------------------------------------------------------------------
--	Ian Wallace		2022-12-11	--	Created view for Jumpmind POS postgres Promotions table  
--	Tim Callahan	2023-07-20	--	Added Case Statement To  DealTierDef_DiscType
--	Tim Callahan	2023-12-07	--	Added Document Status To Filtering Condition 
...
and s2.enum not in ('0','1','5') -- Exclude Documents in New, Preliminary and Canceled Statuses -- Query for all statuses here:  select * from enum_price_chg_doc_status -- Added 12/07/2023
and 
	(
...
where 1=1
--and pds.deal_no not in ('012007','012010', '012004','012003','012002','012001') -- Hard Coded List To Exclude Until We Add Doc Status Filtering Condition -- Remarked out on 12/7/2023
--and pds.deal_no  in ('012007','012010', '012004','012003','012002','012001') -- Testing Only:  Known Cancelled Documents 
--order by 3, 1 
