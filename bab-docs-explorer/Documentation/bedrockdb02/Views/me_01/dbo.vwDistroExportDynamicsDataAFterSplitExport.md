# dbo.vwDistroExportDynamicsDataAFterSplitExport
...
```mermaid
flowchart LR
    VIEW["dbo.vwDistroExportDynamicsDataAFterSplitExport"]
...
```sql
CREATE view [dbo].[vwDistroExportDynamicsDataAFterSplitExport]
