...
```sql
CREATE view [dbo].[VW_WMItemMaster]
as
select m.*
from
	...
	and substring(hg.hierarchy_group_code,7,2)<>'60' --EXCLUDES SUPPLIES, THESE ARE SENT FROM DYNAMICS IN SEPARATE FILE
	UNION
	select 	'001' as CO,
		'001' as DIV,
		s.style_code as STYLE,
...
where m.style in --('026865','026864','026907','026808','025862','025855','025854','025861','026805','026837','026866','026919','026838')
