# dbo.vwDistroExportTransferOrderCreateBAK20210301
...
```mermaid
flowchart LR
    VIEW["dbo.vwDistroExportTransferOrderCreateBAK20210301"]
...
```sql
CREATE view [dbo].[vwDistroExportTransferOrderCreateBAK20210301] 
