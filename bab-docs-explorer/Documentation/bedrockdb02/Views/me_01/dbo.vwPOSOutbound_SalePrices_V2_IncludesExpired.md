...
```mermaid
flowchart LR
    VIEW["dbo.vwPOSOutbound_SalePrices_V2_IncludesExpired"]
...
```sql
CREATE view [dbo].[vwPOSOutbound_SalePrices_V2_IncludesExpired]
...
or pc.price_change_status in (6) --  0 = New; 1 = Preliminary; 2 = Submitted; 3 = Issued; 4 = Effective; 5 = Canceled; 6 = Completed
