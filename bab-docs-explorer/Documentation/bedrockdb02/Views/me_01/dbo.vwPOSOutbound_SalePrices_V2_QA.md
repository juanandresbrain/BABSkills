...
```mermaid
flowchart LR
    VIEW["dbo.vwPOSOutbound_SalePrices_V2_QA"]
...
(
 pc.price_change_status in (3) --  0 = New; 1 = Preliminary; 2 = Submitted; 3 = Issued; 4 = Effective; 5 = Canceled; 6 = Completed
	and 
 pc.price_change_no in ('0008506','0008507','0008508','0008509') -- Documents We want to flow early for testing 
)
)
...
deal_name, 
deal_description, 
case when s.deal_no in ('0008344','0008345','0008343','0008346') 
		then '2024-03-20 00:00:00'
	when s.deal_no in ('0008388') 
		then '2024-05-15 00:00:00'
	when s.deal_no in ('0008399','0008400','0008401') 
		then '2024-05-29 00:00:00'
	when s.deal_no in ('0008402','0008412','0008405','0008413')
		then '2024-06-10 00:00:00'
	when s.deal_no in ('0008415','0008416','0008417')
		then '2024-06-13 00:00:00'
	when s.deal_no in ('0008506','0008507','0008508','0008509')
		then '2024-08-21'
	when s.deal_no in ('0008581','0008582','0008583','0008584')
		then '2024-11-06'
		else DealStartDate
	end as DealStartDate, 
