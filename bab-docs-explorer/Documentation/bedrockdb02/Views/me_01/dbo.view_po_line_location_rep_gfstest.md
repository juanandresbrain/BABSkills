# dbo.view_po_line_location_rep_gfstest
...
```mermaid
flowchart LR
    VIEW["dbo.view_po_line_location_rep_gfstest"]
...
```sql
CREATE view [dbo].[view_po_line_location_rep_gfstest]

AS

/*
View name: view_po_line_location_rep_gfstest
