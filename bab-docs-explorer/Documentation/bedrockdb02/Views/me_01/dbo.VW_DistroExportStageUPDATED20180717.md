# dbo.VW_DistroExportStageUPDATED20180717
...
```mermaid
flowchart LR
    VIEW["dbo.VW_DistroExportStageUPDATED20180717"]
...
```sql
CREATE view [dbo].[VW_DistroExportStageUPDATED20180717]
as
...
from distribution_data_after_split ddas with (nolock)
inner join rec_type rt with (nolock) on	ddas.rec_type = rt.rectype
left join WestCoastStores wc on left(ddas.destid,4) = wc.location_code
