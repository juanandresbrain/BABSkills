...
```mermaid
flowchart LR
    VIEW["dbo.view_oh_style_loctype_li"]
    dbo_hist_oh_style_loc_li(["dbo.hist_oh_style_loc_li"]) --> VIEW
...
```sql
create view dbo.view_oh_style_loctype_li 
as
select h.style_id, h.inventory_status_id, h.price_status_id ,
...
from hist_oh_style_loc_li h, location l
where h.location_id = l.location_id
group by  h.style_id, h.inventory_status_id, h.price_status_id , h.location_id, l.location_type
```
