...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_styleclr_loc_yr"]
    dbo_hierarchy_group(["dbo.hierarchy_group"]) --> VIEW
    dbo_hist_styleclr_loc_yr(["dbo.hist_styleclr_loc_yr"]) --> VIEW
...
```sql
CREATE VIEW dbo.view_hist_styleclr_loc_yr
