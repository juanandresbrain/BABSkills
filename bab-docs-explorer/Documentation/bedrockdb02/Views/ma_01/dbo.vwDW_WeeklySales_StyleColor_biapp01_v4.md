# dbo.vwDW_WeeklySales_StyleColor_biapp01_v4
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_WeeklySales_StyleColor_biapp01_v4"]
...
```sql
--select count(*) from [dbo].[vwDW_WeeklySales_StyleColor_biapp01_v3]  -- 95,247,583
...
CREATE VIEW [dbo].[vwDW_WeeklySales_StyleColor_biapp01_v4]
AS
