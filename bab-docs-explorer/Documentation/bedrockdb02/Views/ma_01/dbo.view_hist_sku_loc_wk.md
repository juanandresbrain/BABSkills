...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_sku_loc_wk"]
    dbo_hist_sku_loc_wk(["dbo.hist_sku_loc_wk"]) --> VIEW
...
```sql
CREATE VIEW dbo.view_hist_sku_loc_wk
