...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_sku_chn_yr"]
    dbo_hist_sku_chn_yr(["dbo.hist_sku_chn_yr"]) --> VIEW
...
```sql
CREATE VIEW dbo.view_hist_sku_chn_yr
