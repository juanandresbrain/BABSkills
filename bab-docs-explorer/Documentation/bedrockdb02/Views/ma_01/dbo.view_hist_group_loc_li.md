...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_group_loc_li"]
    dbo_hierarchy_group(["dbo.hierarchy_group"]) --> VIEW
    dbo_hist_group_loc_li(["dbo.hist_group_loc_li"]) --> VIEW
```
...
```sql
CREATE VIEW dbo.view_hist_group_loc_li
