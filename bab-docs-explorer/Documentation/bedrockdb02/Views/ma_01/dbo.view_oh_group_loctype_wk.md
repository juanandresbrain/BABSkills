...
```mermaid
flowchart LR
    VIEW["dbo.view_oh_group_loctype_wk"]
...
```sql
create view dbo.view_oh_group_loctype_wk 
as
select h.hierarchy_group_id,  h.merch_year_wk, h.inventory_status_id,
...
from hist_oh_group_loc_wk h, location l
where h.location_id = l.location_id
group by h.hierarchy_group_id,   h.merch_year_wk, h.inventory_status_id,
h.price_status_id , h.location_id, l.location_type
```
