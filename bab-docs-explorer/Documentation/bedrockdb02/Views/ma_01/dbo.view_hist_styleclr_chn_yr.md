...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_styleclr_chn_yr"]
    dbo_hierarchy_group(["dbo.hierarchy_group"]) --> VIEW
    dbo_hist_styleclr_chn_yr(["dbo.hist_styleclr_chn_yr"]) --> VIEW
...
```sql
CREATE VIEW dbo.view_hist_styleclr_chn_yr
...
SELECT
	...
	,h.sales_total_cost, h.return_units
	,h.return_retail
	,h.return_cost
