...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_styleclr_chn_wk"]
    dbo_hierarchy_group(["dbo.hierarchy_group"]) --> VIEW
    dbo_hist_styleclr_chn_wk(["dbo.hist_styleclr_chn_wk"]) --> VIEW
...
```sql
CREATE VIEW dbo.view_hist_styleclr_chn_wk
