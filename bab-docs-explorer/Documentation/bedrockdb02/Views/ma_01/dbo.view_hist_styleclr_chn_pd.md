...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_styleclr_chn_pd"]
    dbo_hierarchy_group(["dbo.hierarchy_group"]) --> VIEW
    dbo_hist_styleclr_chn_pd(["dbo.hist_styleclr_chn_pd"]) --> VIEW
...
```sql
CREATE VIEW dbo.view_hist_styleclr_chn_pd
