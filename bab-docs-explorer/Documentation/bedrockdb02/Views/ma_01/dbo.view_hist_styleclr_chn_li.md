...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_styleclr_chn_li"]
    dbo_hierarchy_group(["dbo.hierarchy_group"]) --> VIEW
    dbo_hist_styleclr_chn_li(["dbo.hist_styleclr_chn_li"]) --> VIEW
...
```sql
CREATE VIEW dbo.view_hist_styleclr_chn_li
