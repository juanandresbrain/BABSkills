...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_sku_loc_pd"]
    dbo_hist_sku_loc_pd(["dbo.hist_sku_loc_pd"]) --> VIEW
...
```sql
CREATE VIEW dbo.view_hist_sku_loc_pd
