...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_sku_chn_li"]
    dbo_hist_sku_chn_li(["dbo.hist_sku_chn_li"]) --> VIEW
...
```sql
CREATE VIEW dbo.view_hist_sku_chn_li
