...
```mermaid
flowchart LR
    VIEW["dbo.view_otb_proj_reductions"]
    dbo_plan_element(["dbo.plan_element"]) --> VIEW
    dbo_plan_group_chn_wk(["dbo.plan_group_chn_wk"]) --> VIEW
    ...
    dbo_view_otb_proj_additions(["dbo.view_otb_proj_additions"]) --> VIEW
```
...
| dbo.view_otb_proj_additions |

## View Code

```sql
create view dbo.view_otb_proj_reductions



as
select a.hierarchy_group_id, a.merch_year_pd,
...
view_otb_proj_additions a,
( select distinct a.hierarchy_group_id, w.merch_year_pd,w.relative_period,
...
from plan_group_chn_wk a,post_parameter pv, plan_element p, plan_version v ,view_calendar_merch_pd_wk_rel w
where
pv.parameter_id =23
...
group by a.hierarchy_group_id, w.merch_year_pd, w.relative_period)
 b
...
group by
a.hierarchy_group_id,a.merch_year_pd
```
