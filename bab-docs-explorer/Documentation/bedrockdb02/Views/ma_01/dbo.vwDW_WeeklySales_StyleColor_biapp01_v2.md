# dbo.vwDW_WeeklySales_StyleColor_biapp01_v2
...
```mermaid
flowchart LR
    VIEW["dbo.vwDW_WeeklySales_StyleColor_biapp01_v2"]
...
CREATE VIEW [dbo].[vwDW_WeeklySales_StyleColor_biapp01_v2]
AS
SELECT -- dimension keys
	s.style_id, s.style_code,
