...
```mermaid
flowchart LR
    VIEW["dbo.view_hist_group_loc_pd"]
    dbo_hierarchy_group(["dbo.hierarchy_group"]) --> VIEW
    dbo_hist_group_loc_pd(["dbo.hist_group_loc_pd"]) --> VIEW
```
...
```sql
CREATE VIEW dbo.view_hist_group_loc_pd
