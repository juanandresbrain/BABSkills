...
```mermaid
flowchart LR
    VIEW["dbo.syscollector_execution_log_full"]
    dbo_fn_syscollector_get_execution_log_tree(["dbo.fn_syscollector_get_execution_log_tree"]) --> VIEW
    dbo_syscollector_collection_sets(["dbo.syscollector_collection_sets"]) --> VIEW
    dbo_syscollector_execution_log_internal(["dbo.syscollector_execution_log_internal"]) --> VIEW
    dbo_sysssispackages(["dbo.sysssispackages"]) --> VIEW
```
...
| Referenced Table |
|---|
| dbo.fn_syscollector_get_execution_log_tree |
