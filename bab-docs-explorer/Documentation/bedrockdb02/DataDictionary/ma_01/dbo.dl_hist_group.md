...
|---|---|---|---|---|---|---|
| dl_hist_group_id | bigint | 8 | 0 | YES |  |  |
...
| inventory_reductions_cost | decimal | 9 | 0 |  |  |  |
| shrink_total_cost | decimal | 9 | 0 |  |  |  |
| markdown_cost | decimal | 9 | 0 |  |  |  |
| markdown_promo_cost | decimal | 9 | 0 |  |  |  |
| valid_flag | bit | 1 | 0 |  |  |  |
