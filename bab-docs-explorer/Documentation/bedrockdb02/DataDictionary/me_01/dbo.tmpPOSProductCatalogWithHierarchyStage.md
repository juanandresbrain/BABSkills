...
| DepartmentHierarchyGroupID | int | 4 | 0 |  |  |  |
| ClassHierarchyGroupID | int | 4 | 0 |  |  |  |
| SubClassHierarchyGroupID | int | 4 | 0 |  |  |  |
| ClassParentGroupID | int | 4 | 1 |  |  |  |
| SubClassParentGroupID | int | 4 | 1 |  |  |  |
| StyleParentGroupID | int | 4 | 0 |  |  |  |
| BaseID | varchar | 6 | 1 |  |  |  |
| Shoes | int | 4 | 1 |  |  |  |
| Sound | int | 4 | 1 |  |  |  |
...
| isReturnEligible | varchar | 1 | 0 |  |  |  |
| ItemDescription | varchar | 120 | 1 |  |  |  |
| ProductDescription | varchar | 120 | 1 |  |  |  |
| ItemName | varchar | 120 | 1 |  |  |  |
| isCashierEnterQty | varchar | 1 | 0 |  |  |  |
| isCashierEntersPrice | varchar | 1 | 0 |  |  |  |
...
- [me_01: dbo.spPosStagePOSProductCatalogWithHierarchyStage](../../StoredProcedures/me_01/dbo.spPosStagePOSProductCatalogWithHierarchyStage.md)
