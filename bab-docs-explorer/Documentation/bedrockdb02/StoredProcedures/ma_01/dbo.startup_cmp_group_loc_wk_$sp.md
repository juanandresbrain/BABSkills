...
```mermaid
flowchart LR
    SP["dbo.startup_cmp_group_loc_wk_$sp"]
    dbo_calendar_date(["dbo.calendar_date"]) --> SP
    dbo_calendar_merch_week(["dbo.calendar_merch_week"]) --> SP
    dbo_cmp_group_currency_rate(["dbo.cmp_group_currency_rate"]) --> SP
    dbo_dummy_hist_cmp_group_loc_wk(["dbo.dummy_hist_cmp_group_loc_wk"]) --> SP
