# MerchandisingPlanning.spTXTDataLoad_Measure_hs Inv Ch Tfr Value_SingleFiscalWeek
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Inv Ch Tfr Value_SingleFiscalWeek"]
