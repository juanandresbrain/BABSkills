# MerchandisingPlanning.spTXTDataLoad_Measure_hs Receipts Value_SingleFiscalWeek
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Receipts Value_SingleFiscalWeek"]
