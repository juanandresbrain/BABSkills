# MerchandisingPlanning.spTXTDataLoad_Measure_hs Sales Value Local_SingleFiscalWeek_Validation
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Sales Value Local_SingleFiscalWeek_Validation"]
