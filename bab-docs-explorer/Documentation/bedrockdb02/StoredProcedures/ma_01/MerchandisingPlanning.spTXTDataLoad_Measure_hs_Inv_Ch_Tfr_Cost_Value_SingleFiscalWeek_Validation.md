# MerchandisingPlanning.spTXTDataLoad_Measure_hs Inv Ch Tfr Cost Value_SingleFiscalWeek_Validation
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Inv Ch Tfr Cost Value_SingleFiscalWeek_Validation"]
