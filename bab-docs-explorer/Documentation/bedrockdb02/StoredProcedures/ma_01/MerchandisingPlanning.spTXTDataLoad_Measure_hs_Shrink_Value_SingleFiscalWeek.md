# MerchandisingPlanning.spTXTDataLoad_Measure_hs Shrink Value_SingleFiscalWeek
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Shrink Value_SingleFiscalWeek"]
