# MerchandisingPlanning.spTXTDataLoad_Measure_hs Shrink Value_SingleFiscalWeek_Validation
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Shrink Value_SingleFiscalWeek_Validation"]
