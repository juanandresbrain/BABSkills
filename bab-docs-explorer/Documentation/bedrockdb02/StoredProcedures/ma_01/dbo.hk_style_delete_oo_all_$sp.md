# dbo.hk_style_delete_oo_all_$sp
...
```mermaid
flowchart LR
    SP["dbo.hk_style_delete_oo_all_$sp"]
    ...
    dbo_oo_all_styleclr_chn_wk(["dbo.oo_all_styleclr_chn_wk"]) --> SP
    dbo_oo_all_styleclr_chn_yr(["dbo.oo_all_styleclr_chn_yr"]) --> SP
    dbo_oo_all_styleclr_loc_li(["dbo.oo_all_styleclr_loc_li"]) --> SP
    dbo_oo_all_styleclr_loc_pd(["dbo.oo_all_styleclr_loc_pd"]) --> SP
    dbo_oo_all_styleclr_loc_wk(["dbo.oo_all_styleclr_loc_wk"]) --> SP
    dbo_oo_all_styleclr_loc_yr(["dbo.oo_all_styleclr_loc_yr"]) --> SP
```
