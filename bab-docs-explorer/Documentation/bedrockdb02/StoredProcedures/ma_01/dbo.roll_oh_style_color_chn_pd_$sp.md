# dbo.roll_oh_style_color_chn_pd_$sp
...
```mermaid
flowchart LR
    SP["dbo.roll_oh_style_color_chn_pd_$sp"]
    ...
    dbo_wrk_roll_oh_styleclr_chn_pd(["dbo.wrk_roll_oh_styleclr_chn_pd"]) --> SP
```
...
| dbo.wrk_roll_oh_styleclr_chn_pd |
