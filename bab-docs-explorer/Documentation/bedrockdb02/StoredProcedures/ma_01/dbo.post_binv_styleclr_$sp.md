...
flowchart LR
    ...
    dbo_hist_oh_styleclr_chn_yr(["dbo.hist_oh_styleclr_chn_yr"]) --> SP
    dbo_hist_oh_styleclr_loc_li(["dbo.hist_oh_styleclr_loc_li"]) --> SP
    dbo_hist_oh_styleclr_loc_pd(["dbo.hist_oh_styleclr_loc_pd"]) --> SP
    dbo_hist_oh_styleclr_loc_wk(["dbo.hist_oh_styleclr_loc_wk"]) --> SP
    dbo_hist_oh_styleclr_loc_yr(["dbo.hist_oh_styleclr_loc_yr"]) --> SP
    dbo_post_binv_styleclr_adj(["dbo.post_binv_styleclr_adj"]) --> SP
```
...
```sql
CREATE proc [dbo].[post_binv_styleclr_$sp]
```
