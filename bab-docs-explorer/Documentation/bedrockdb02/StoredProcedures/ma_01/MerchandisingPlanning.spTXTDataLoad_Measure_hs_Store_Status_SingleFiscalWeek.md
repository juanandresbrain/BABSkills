# MerchandisingPlanning.spTXTDataLoad_Measure_hs Store Status_SingleFiscalWeek
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Store Status_SingleFiscalWeek"]
