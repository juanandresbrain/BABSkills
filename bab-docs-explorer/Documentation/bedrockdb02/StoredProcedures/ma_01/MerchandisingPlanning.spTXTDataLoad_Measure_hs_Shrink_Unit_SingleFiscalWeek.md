# MerchandisingPlanning.spTXTDataLoad_Measure_hs Shrink Unit_SingleFiscalWeek
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Shrink Unit_SingleFiscalWeek"]
