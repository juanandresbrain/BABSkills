# MerchandisingPlanning.spTXTDataLoad_Measure_hs On Order Value_SingleFiscalWeek_V2
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs On Order Value_SingleFiscalWeek_V2"]
