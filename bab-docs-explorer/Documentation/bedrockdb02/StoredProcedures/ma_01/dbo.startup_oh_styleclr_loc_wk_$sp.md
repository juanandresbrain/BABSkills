...
```mermaid
flowchart LR
    SP["dbo.startup_oh_styleclr_loc_wk_$sp"]
    dbo_calendar_date(["dbo.calendar_date"]) --> SP
    dbo_calendar_merch_week(["dbo.calendar_merch_week"]) --> SP
    dbo_dummy_hist_oh_styleclr_loc_wk(["dbo.dummy_hist_oh_styleclr_loc_wk"]) --> SP
    ...
    dbo_oh_styleclr_currency_rate(["dbo.oh_styleclr_currency_rate"]) --> SP
