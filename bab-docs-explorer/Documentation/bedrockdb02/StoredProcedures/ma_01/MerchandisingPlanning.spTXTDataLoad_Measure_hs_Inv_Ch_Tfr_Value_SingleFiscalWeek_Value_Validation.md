# MerchandisingPlanning.spTXTDataLoad_Measure_hs Inv Ch Tfr Value_SingleFiscalWeek_Value_Validation
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Inv Ch Tfr Value_SingleFiscalWeek_Value_Validation"]
