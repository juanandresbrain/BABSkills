# MerchandisingPlanning.spTXTDataLoad_Measure_hs Store Status_SingleFiscalWeek_V2
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Store Status_SingleFiscalWeek_V2"]
