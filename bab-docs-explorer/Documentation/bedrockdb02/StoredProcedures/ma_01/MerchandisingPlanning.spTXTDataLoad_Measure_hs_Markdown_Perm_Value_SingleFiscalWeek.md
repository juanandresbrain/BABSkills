# MerchandisingPlanning.spTXTDataLoad_Measure_hs Markdown Perm Value_SingleFiscalWeek
...
```mermaid
flowchart LR
    SP["MerchandisingPlanning.spTXTDataLoad_Measure_hs Markdown Perm Value_SingleFiscalWeek"]
