...
flowchart LR
    ...
    dbo_rc_style_chn_li(["dbo.rc_style_chn_li"]) --> SP
    dbo_rc_style_chn_pd(["dbo.rc_style_chn_pd"]) --> SP
    dbo_rc_style_chn_wk(["dbo.rc_style_chn_wk"]) --> SP
    dbo_rc_style_chn_yr(["dbo.rc_style_chn_yr"]) --> SP
    dbo_rc_style_loc_li(["dbo.rc_style_loc_li"]) --> SP
    dbo_rc_style_loc_pd(["dbo.rc_style_loc_pd"]) --> SP
    dbo_rc_style_loc_wk(["dbo.rc_style_loc_wk"]) --> SP
    dbo_rc_style_loc_yr(["dbo.rc_style_loc_yr"]) --> SP
