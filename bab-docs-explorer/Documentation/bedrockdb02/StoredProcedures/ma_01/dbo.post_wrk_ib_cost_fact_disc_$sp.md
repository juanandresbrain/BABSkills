# dbo.post_wrk_ib_cost_fact_disc_$sp
...
```mermaid
flowchart LR
    SP["dbo.post_wrk_ib_cost_fact_disc_$sp"]
    dbo_job_error_handler__sp(["dbo.job_error_handler_$sp"]) --> SP
    dbo_job_header(["dbo.job_header"]) --> SP
    dbo_job_progress_handler__sp(["dbo.job_progress_handler_$sp"]) --> SP
    dbo_return_debug_flag__sp(["dbo.return_debug_flag_$sp"]) --> SP
    dbo_syn_ib_cost_factor_discount(["dbo.syn_ib_cost_factor_discount"]) --> SP
...
| dbo.syn_ib_cost_factor_discount |
| dbo.syn_sku |
| dbo.syn_style_color |
| dbo.syn_style_group |
| dbo.syn_style_size |
