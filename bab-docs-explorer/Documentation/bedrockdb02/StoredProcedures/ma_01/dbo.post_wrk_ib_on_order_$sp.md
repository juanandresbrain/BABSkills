...
```mermaid
flowchart LR
    SP["dbo.post_wrk_ib_on_order_$sp"]
    dbo_is_tax_exclusive__sp(["dbo.is_tax_exclusive_$sp"]) --> SP
    dbo_job_error_handler__sp(["dbo.job_error_handler_$sp"]) --> SP
    dbo_job_header(["dbo.job_header"]) --> SP
    dbo_job_progress_handler__sp(["dbo.job_progress_handler_$sp"]) --> SP
    dbo_return_debug_flag__sp(["dbo.return_debug_flag_$sp"]) --> SP
    dbo_syn_ib_on_order(["dbo.syn_ib_on_order"]) --> SP
    dbo_syn_ib_oo_notax_retail_work(["dbo.syn_ib_oo_notax_retail_work"]) --> SP
...
| dbo.syn_ib_on_order |
| dbo.syn_ib_oo_notax_retail_work |
| dbo.syn_sku |
| dbo.syn_style_color |
| dbo.syn_style_group |
| dbo.syn_style_size |
