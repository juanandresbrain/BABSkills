# dbo.import_hist_cmp_styleclr_$sp
...
```mermaid
flowchart LR
    SP["dbo.import_hist_cmp_styleclr_$sp"]
    ...
    dbo_imp_cd_hist_cmp_styleclr(["dbo.imp_cd_hist_cmp_styleclr"]) --> SP
    dbo_imp_cd_hist_cmp_styleclr_home(["dbo.imp_cd_hist_cmp_styleclr_home"]) --> SP
    dbo_imp_cd_hist_cmp_styleclr_local(["dbo.imp_cd_hist_cmp_styleclr_local"]) --> SP
    dbo_imp_id_hist_cmp_styleclr(["dbo.imp_id_hist_cmp_styleclr"]) --> SP
    ...
    dbo_styleclr_currency_rate(["dbo.styleclr_currency_rate"]) --> SP
