# dbo.roll_oh_style_color_loc_wk_$sp
...
```mermaid
flowchart LR
    SP["dbo.roll_oh_style_color_loc_wk_$sp"]
    ...
    dbo_wrk_roll_oh_styleclr_loc_wk(["dbo.wrk_roll_oh_styleclr_loc_wk"]) --> SP
```
...
| dbo.wrk_roll_oh_styleclr_loc_wk |
