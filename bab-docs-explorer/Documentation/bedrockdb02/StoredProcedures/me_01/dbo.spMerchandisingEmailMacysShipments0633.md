# dbo.spMerchandisingEmailMacysShipments0633
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingEmailMacysShipments0633"]
...
```sql
CREATE proc [dbo].[spMerchandisingEmailMacysShipments0633]
...
-- =====================================================================================================
-- Name: spMerchandisingEmailMacysShipments0633
--
-- Description:	Sends a daily running log of unrecived shipments to store 0633 
--
-- Input: NA
--
...
where right('0000' + cast(s.STR_NUM as varchar(4)), 4) = '0633'
ORDER BY 1
...
begin
	...
	@body = @text,
	@subject= 'STORE SHIPMENTS FOR 0633', 
	@body_format = 'HTML'
