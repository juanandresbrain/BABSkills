# dbo.ib_populate_notax_retails_$sp_modified_fast
...
```mermaid
flowchart LR
    SP["dbo.ib_populate_notax_retails_$sp_modified_fast"]
...
```sql
CREATE PROCEDURE [dbo].[ib_populate_notax_retails_$sp_modified_fast]
