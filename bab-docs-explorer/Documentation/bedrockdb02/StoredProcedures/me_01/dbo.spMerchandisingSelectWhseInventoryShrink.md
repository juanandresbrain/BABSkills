# dbo.spMerchandisingSelectWhseInventoryShrink
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingSelectWhseInventoryShrink"]
...
```sql
CREATE proc [dbo].[spMerchandisingSelectWhseInventoryShrink]
as
...
--		Tim Callahan	2023-12-19		Someone modified this proc at 2023-09-11 13:18:11.160 to exclude 2970 warehouse for PI 
--										On Decmber 19,2023 Maria Sharma requested the Data Engineering Team undo this and add 2970 back in as they claim to have no internal team knowledge of ever doing this before 
--										I also backed up the proc before "rolling back" their changes [dbo].[spMerchandisingSelectWhseInventoryShrink_Bak20231219]
--										For anyone who reads this in the future see section with  "Easiest way to exclude a location"
--											This would be an easier way to exclude a location in the future 
-- =====================================================================================================
