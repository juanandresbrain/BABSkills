# dbo.spMerchandisingEmailMacysShipments0634
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingEmailMacysShipments0634"]
...
```sql
CREATE proc [dbo].[spMerchandisingEmailMacysShipments0634]
...
-- =====================================================================================================
-- Name: spMerchandisingEmailMacysShipments0634
--
-- Description:	Sends a daily running log of unrecived shipments to store 0634 
--
-- Input: NA
--
...
where right('0000' + cast(s.STR_NUM as varchar(4)), 4) = '0634'
ORDER BY 1
...
begin
	...
	@body = @text,
	@subject= 'STORE SHIPMENTS FOR 0634', 
	@body_format = 'HTML'
