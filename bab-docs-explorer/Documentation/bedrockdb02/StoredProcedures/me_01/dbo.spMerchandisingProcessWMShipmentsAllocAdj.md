# dbo.spMerchandisingProcessWMShipmentsAllocAdj
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingProcessWMShipmentsAllocAdj"]
...
```sql
CREATE proc  [dbo].[spMerchandisingProcessWMShipmentsAllocAdj]
...
--		Tim Callahan	07/03/2018		Added logic to purge D365 distros from #ss staging table 
-- =====================================================================================================
...
delete
from #ss
where distribution_no like 'SO%'
or distribution_no like 'TO%'
