# dbo.ins_missing_skus_enterpr_$sp
...
```mermaid
flowchart LR
    SP["dbo.ins_missing_skus_enterpr_$sp"]
...
```sql
create proc dbo.ins_missing_skus_enterpr_$sp 
	...
	FROM
		...
		( 
			...
			FROM
				...
				sku
			WHERE
				inv_control_merch.hierarchy_group_id = merch_group_parent.parent_hierarchy_group_id	
