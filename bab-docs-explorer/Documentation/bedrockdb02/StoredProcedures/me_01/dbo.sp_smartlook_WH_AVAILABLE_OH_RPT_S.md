# dbo.sp_smartlook_WH_AVAILABLE_OH_RPT_S
...
```mermaid
flowchart LR
    SP["dbo.sp_smartlook_WH_AVAILABLE_OH_RPT_S"]
...
```sql
CREATE proc [dbo].[sp_smartlook_WH_AVAILABLE_OH_RPT_S] (@location_code varchar(4))
...
and left(hg.hierarchy_group_code,1)  = 'R'
