# dbo.spMerchandisingExportStoreDistributionsUK
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingExportStoreDistributionsUK"]
...
```sql
CREATE proc [dbo].[spMerchandisingExportStoreDistributionsUK]
...
--		Tim Callahan	10/08/2018		Updated Code to export the left 6 (previously 4) characters of the ddas.destid field to the store_shipment_export table
-- =====================================================================================================
