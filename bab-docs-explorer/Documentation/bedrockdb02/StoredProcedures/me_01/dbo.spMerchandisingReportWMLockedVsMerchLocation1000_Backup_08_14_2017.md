...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingReportWMLockedVsMerchLocation1000_Backup_08_14_2017"]
...
```sql
CREATE proc [dbo].[spMerchandisingReportWMLockedVsMerchLocation1000_Backup_08_14_2017]
...
begin
	...
	set @text = '<font face =arial size = 2>' + 
			...
			'<br>'+
				...
				@recipients = 'tamib@buildabear.com;physicalinventory@buildabear.com;EricD@buildabear.com;ShaunS@buildabear.com;DennisH@buildabear.com;CandaceS@buildabear.com',
