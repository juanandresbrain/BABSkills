...
```sql
CREATE PROCEDURE [dbo].[get_lookup_enum_$sp]
	@enum_type		NVARCHAR(30)
AS

/*
Proc name: 	get_lookup_enum_$sp
Description: Get a dataset with enumerations for an enumeration type

HISTORY: 
Date            Name					Desc
May 15, 2013    Gurpreet Kaur	        Creation
Jul  2, 2013	Maria Van Geeteruyen	Adding sort sequence 
*/


SELECT enum, resource_name, sort_sequence 
