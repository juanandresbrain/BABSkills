# dbo.spMerchandisingReportEOMUnitsOHbyLoc_Manual
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingReportEOMUnitsOHbyLoc_Manual"]
...
-- =============================================
CREATE PROCEDURE [dbo].[spMerchandisingReportEOMUnitsOHbyLoc_Manual]
...
DROP TABLE #SVWORKV3_2  
		...
		declare @query varchar(1000),
  		...
  		select @max = max(date_closed) from gl_period
				...
				+ '<br> -> ' + @file + '<br><br><br>This report was generated by BEDROCKDBO2.me_01.dbo.sp_MerchandisingReportEOMUnitsOHbyLoc'
