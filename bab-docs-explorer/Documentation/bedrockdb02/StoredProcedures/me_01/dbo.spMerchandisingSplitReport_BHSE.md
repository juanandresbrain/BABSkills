# dbo.spMerchandisingSplitReport_BHSE
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingSplitReport_BHSE"]
...
```sql
CREATE proc [dbo].[spMerchandisingSplitReport_BHSE]

as 


-- =====================================================================================================
-- Name: spMerchandisingSplitReport_BHSE
--
