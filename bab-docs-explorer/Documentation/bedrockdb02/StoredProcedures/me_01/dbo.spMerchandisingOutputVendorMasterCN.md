# dbo.spMerchandisingOutputVendorMasterCN
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingOutputVendorMasterCN"]
...
```sql
CREATE proc [dbo].[spMerchandisingOutputVendorMasterCN]


as

-- =====================================================================================================
-- Name: spMerchandisingOutputVendorMasterCN
--
-- Description:	Outputs CSV file for CN Vendor Master
--
-- Revision History
--		Name:			Date:			Comments:
...
select @query = 'set nocount on select * from me_01.dbo.VW_CNVendorMaster order by vendor_name, address_name'
...
select @filelocation = '\\kermode\FileRepository\MERCHANDISING\CN_Distro\OUTBOUND\VendorMaster\'
select @filename = 'CN_VENDOR_MASTER_' + @date + '.csv'
