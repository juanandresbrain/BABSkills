# dbo.spMerchandisingDBSchenkerPOExport_7_Export
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingDBSchenkerPOExport_7_Export"]
...
```sql
CREATE proc [dbo].[spMerchandisingDBSchenkerPOExport_7_Export]
