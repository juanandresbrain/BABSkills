# dbo.spMerchandisingFtpWCDistroWinSCP
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingFtpWCDistroWinSCP"]
...
```sql
CREATE proc [dbo].[spMerchandisingFtpWCDistroWinSCP]
...
--insert #DEL exec master..xp_cmdshell 'dir \\kermode\FileRepository\MERCHANDISING\WC_Distro\FTP\WinSCP\Logs\Outbound\DistroUpload.log /B' -- Remarked out on 9/12/2022
