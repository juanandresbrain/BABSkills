# dbo.spMerchandisingExportStoreDistributionsWC_BACKUP20180712
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingExportStoreDistributionsWC_BACKUP20180712"]
...
```sql
CREATE proc [dbo].[spMerchandisingExportStoreDistributionsWC_BACKUP20180712]
