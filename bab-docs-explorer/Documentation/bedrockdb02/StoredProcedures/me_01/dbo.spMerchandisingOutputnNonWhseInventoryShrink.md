# dbo.spMerchandisingOutputnNonWhseInventoryShrink
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingOutputnNonWhseInventoryShrink"]
...
```sql
CREATE proc [dbo].[spMerchandisingOutputnNonWhseInventoryShrink]
as
-- =====================================================================================================
...
select @whses = count(distinct location_code) from tmpNightlyNonWhseInventoryShrink
while @whses > 0
begin
	select @whse = min(location_code) from tmpNightlyNonWhseInventoryShrink
