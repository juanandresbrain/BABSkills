# dbo.spMerchandisingProcessWCShipmentsAllocAdj_BAK20230414
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingProcessWCShipmentsAllocAdj_BAK20230414"]
...
```sql
CREATE proc [dbo].[spMerchandisingProcessWCShipmentsAllocAdj_BAK20230414]
