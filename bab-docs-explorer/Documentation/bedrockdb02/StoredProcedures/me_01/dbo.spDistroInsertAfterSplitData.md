# dbo.spDistroInsertAfterSplitData
...
```mermaid
flowchart LR
    SP["dbo.spDistroInsertAfterSplitData"]
...
```sql
CREATE procEDURE [dbo].[spDistroInsertAfterSplitData]
	(
		@id bigint, 
...
AS
	INSERT INTO   distribution_data_after_split( Id, SourceID, DestID, style_code, quantity, rec_Type, sequencenbr, distribution_number, ref_field_1, release_date, active_pick_flag)
