...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingSelectStoreDistributions"]
...
```sql
CREATE proc [dbo].[spMerchandisingSelectStoreDistributions]
as
-- =====================================================================================================
...
--		Dan Tweedie		2022-04-18		Added handling for reticketing skus for the email that is sent at the end
-- =====================================================================================================
set nocount on
