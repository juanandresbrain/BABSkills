# dbo.spMerchandisingOutputCNStyleVendor_BAK_20180305
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingOutputCNStyleVendor_BAK_20180305"]
...
-- =====================================================================================================
CREATE PROCEDURE [dbo].[spMerchandisingOutputCNStyleVendor_BAK_20180305]
...
AND	sv.vendor_id = v.vendor_id
AND s.style_code between '800000' and '899999'
AND v.vendor_code IN ('CENTHFF', 'DANBSTF', 'DANUANF', 'DRMCHTF', 'DRMLISF', 'ELNTPWF', 'JINSDZF', 'VXPRTWF', 'JSHWLIF', 'RPACSUP')
ORDER BY 1
...
AND	sv.currency_id = cu.currency_id
AND s.style_code between '800000' and '899999'
AND	v.vendor_code IN ('CENTURY', 'DANDEEE', 'DANDEES', 'DANUINT', 'DREAMAN', 'DREAMIN', 'ELANPOL', 'JINSOLL', 'VOICEEX', 'JSHOLLY', 'RPACHKL')
AND NOT EXISTS (
