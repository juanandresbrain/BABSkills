# dbo.spWEBSelectProductCatalogMasterAttributesBAK20171005
...
```mermaid
flowchart LR
    SP["dbo.spWEBSelectProductCatalogMasterAttributesBAK20171005"]
...
```sql
CREATE proc [dbo].[spWEBSelectProductCatalogMasterAttributesBAK20171005]
