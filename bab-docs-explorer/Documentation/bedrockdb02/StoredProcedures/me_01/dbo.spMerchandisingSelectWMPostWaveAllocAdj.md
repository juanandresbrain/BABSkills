# dbo.spMerchandisingSelectWMPostWaveAllocAdj
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingSelectWMPostWaveAllocAdj"]
...
```sql
CREATE proc [dbo].[spMerchandisingSelectWMPostWaveAllocAdj]
...
--		Tim Callahan	07/03/2018		Add logic to exclude D365 Distros
-- =====================================================================================================
...
and sd.po_nbr not like 'SO%'  -- Added 07/03/2018
and sd.po_nbr not  like 'TO%' -- Added 07/03/2018
