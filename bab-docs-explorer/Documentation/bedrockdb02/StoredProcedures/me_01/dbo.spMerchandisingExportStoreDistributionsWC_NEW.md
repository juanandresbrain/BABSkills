# dbo.spMerchandisingExportStoreDistributionsWC_NEW
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingExportStoreDistributionsWC_NEW"]
...
```sql
CREATE proc [dbo].[spMerchandisingExportStoreDistributionsWC_NEW]
