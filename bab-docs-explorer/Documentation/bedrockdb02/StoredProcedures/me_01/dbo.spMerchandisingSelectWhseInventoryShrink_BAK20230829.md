# dbo.spMerchandisingSelectWhseInventoryShrink_BAK20230829
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingSelectWhseInventoryShrink_BAK20230829"]
...
```sql
CREATE proc [dbo].[spMerchandisingSelectWhseInventoryShrink_BAK20230829]
as
