# dbo.spMerchandisingOutputTPMPoXML
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingOutputTPMPoXML"]
...
```sql
CREATE proc [dbo].[spMerchandisingOutputTPMPoXML]
...
--		Dan Tweedie		2020-2-15		Commented out 7 procs, now called from SSIS, so this proc will just output the xml file to tpm
-- =====================================================================================================
