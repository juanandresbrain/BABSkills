# dbo.spBABWOverShortBAK20130131
...
```mermaid
flowchart LR
    SP["dbo.spBABWOverShortBAK20130131"]
...
CREATE procEDURE [dbo].[spBABWOverShortBAK20130131]
...
sum(ssd.units_sent) as 'Units Sent',
sum(ssd.units_received) as 'Units Received',
sum(ssd.units_sent-ssd.units_received) as 'Discrepancy Units', 
