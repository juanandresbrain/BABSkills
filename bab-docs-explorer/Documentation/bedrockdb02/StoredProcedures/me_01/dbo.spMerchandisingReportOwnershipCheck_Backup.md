# dbo.spMerchandisingReportOwnershipCheck_Backup
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingReportOwnershipCheck_Backup"]
...
```sql
CREATE procEDURE [dbo].[spMerchandisingReportOwnershipCheck_Backup]
AS
SET NOCOUNT ON

-- =====================================================================================================
-- Name: spMerchandisingReportOwnershipCheck_Backup
--
--				 
-- Revision History
...
--		Tim Callahan	02/16/2016		Backed up as I feel this Proc has never worked. 
-- =====================================================================================================
...
BEGIN
	...
	SELECT @1query_text = 'set nocount on select * from ##MAHITEMP16US_TXT'

	SET @2query = @1query_text
...
BEGIN
	...
	SELECT @3query_text = 'set nocount on select * from ##MAHITEMP16CAN_TXT'

	SET @3query = @1query_text
