# dbo.spMerchandisingProcessWCShipmentsAllocAdj
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingProcessWCShipmentsAllocAdj"]
...
```sql
CREATE proc [dbo].[spMerchandisingProcessWCShipmentsAllocAdj]
