...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingToUKDistroExportNotification"]
...
```sql
CREATE proc [dbo].[spMerchandisingToUKDistroExportNotification]

as

-- =====================================================================================================
-- Name: spMerchandisingToUKDistroExportNotification
--
...
-- Revision History
--		Name:			Date:			Comments:
--		Dan Tweedie		10/18/2012		Created proc
-- =====================================================================================================
...
--output summary of distros exported to wm
	...
	select @subj = 'Merch-to-UK Distro Export: ' + cast(getdate() as varchar)
	
	set @text = '<font face =arial size = 2></font>' + 
		'<font face =arial size = 2>' + 
		'The Merch-to-UK Distro Export Process Has Completed.' +
		'<br>'+
		...
		'Job Step:  12 <br>' +
		'Stored Proc:  [BEDROCKDB02].[me_01].[dbo].[spMerchandisingToUKDistroExportNotification] <br>' +
	...
	if datepart(hh, getdate()) >= 18 and (@distro_transfers > 0 or @distros > 0 or @distro_split > 0 or @distro_after_split > 0)
							-- Modified line above from 18 to 19 to accomodate late distro cutoff during 4th quarter
	begin
	select @recip = 'EnterpriseSystemsAlerts@buildabear.com'
	select @subj = 'UK Distro Export Error'
