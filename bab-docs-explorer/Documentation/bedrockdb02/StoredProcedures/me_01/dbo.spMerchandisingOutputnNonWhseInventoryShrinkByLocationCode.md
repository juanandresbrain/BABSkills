# dbo.spMerchandisingOutputnNonWhseInventoryShrinkByLocationCode
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingOutputnNonWhseInventoryShrinkByLocationCode"]
...
```sql
CREATE proc [dbo].[spMerchandisingOutputnNonWhseInventoryShrinkByLocationCode]
@LocationCode int 
as
