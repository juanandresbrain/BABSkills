# dbo.spMerchandisingEmailFAOShipments
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingEmailFAOShipments"]
...
```sql
CREATE proc [dbo].[spMerchandisingEmailFAOShipments]
as

-- =====================================================================================================
-- Name: spMerchandisingEmailFAOShipments
--
-- Description:	Sends a daily running log of unrecived shipments to store 0311 (inside FAO Schwarz) 
--
-- Input: NA
--
...
-- Revision History
--		Name:			Date:			Comments:
--		Dan Tweedie		10/21/2013		Created proc
--		Dan Tweedie		1/22/2015		Added truckingservices@buildabear.com to the email
-- =====================================================================================================
...
where right('0000' + cast(s.STR_NUM as varchar(4)), 4) = '0311'
ORDER BY 1
...
begin
	...
	set @text = '<font face =arial size = 2> ' +
					...
					'<tr><th>SHIPMENT</th><th>SHIP DATE</th><th>STYLE</th><th>DESCRIPTION</th><th>CARTONS</th><th>UNITS SHIPPED</th><th>UNITS RECEIVED</th><th>Rec Type</th>' +
						...
						'</font></table></font></p></p>
						<br>
						<font face =arial size = 1>This report was run from bedrockdb02.me_01.dbo.spMerchandisingEmailFAOShipments.</font>
						<br>
						<br>'
	...
	@copy_recipients = 'distrobears@buildabear.com;purchasing@buildabear.com;truckingservices@buildabear.com',
	@body = @text,
	@subject= 'STORE SHIPMENTS FOR 0311', 
	@body_format = 'HTML'
