# dbo.spWEBSelectProductCatalogMasterAttributes_backup20221102
...
```mermaid
flowchart LR
    SP["dbo.spWEBSelectProductCatalogMasterAttributes_backup20221102"]
...
```sql
CREATE proc [dbo].[spWEBSelectProductCatalogMasterAttributes_backup20221102]
