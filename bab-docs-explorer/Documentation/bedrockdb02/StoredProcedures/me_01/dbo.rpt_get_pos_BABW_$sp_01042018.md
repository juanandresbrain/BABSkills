# dbo.rpt_get_pos_BABW_$sp_01042018
...
```mermaid
flowchart LR
    SP["dbo.rpt_get_pos_BABW_$sp_01042018"]
...
```sql
create PROCEDURE [dbo].[rpt_get_pos_BABW_$sp_01042018] @report_no TINYINT
...
case when location_code ='3970' then 'CH1' 
...
where l.location_code in ('3970','3980')
