# dbo.spMerchandising_Select_NewStyleUDAPlus
...
```mermaid
flowchart LR
    SP["dbo.spMerchandising_Select_NewStyleUDAPlus"]
...
```sql
CREATE proc [dbo].[spMerchandising_Select_NewStyleUDAPlus]
-- =====================================================================================================
-- Name: spMerchandising_Select_NewStyleUDAPlus
--
...
--				 spMerchandising_Select_NewStyleUDAMinus
--
-- Revision History
--		Name:			Date:			Comments:
--		Dan Tweedie		05/27/2010		Created proc.	
--		Dan Tweedie		06/10/2015		Added blank column at end of detail row, per Epicor's new spec
-- =====================================================================================================
as 
set nocount on
...
select @docnbr = convert(varchar, datestamp) + convert(varchar, id) + 'A' from styles_uda
				
declare style cursor for 
						select ('000000' + style)
						from styles_uda
						order by style
print 'H' + '	' + 'A' + '	' + @docnbr + '	' + @date + '	' + 'U' + '	' + 'MerchAdmin' + '	' + 'NewStyle' + '	' + '3' + '	' + 'NewStyleUDAProc'
