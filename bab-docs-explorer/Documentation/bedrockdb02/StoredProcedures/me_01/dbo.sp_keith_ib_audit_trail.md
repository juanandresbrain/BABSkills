...
```mermaid
flowchart LR
    SP["dbo.sp_keith_ib_audit_trail"]
...
```sql
CREATE procedure [dbo].[sp_keith_ib_audit_trail]
...
--and	l.location_code in ('0980','0470','2970','0975','0960','3970','3980','8502','8505','0013','2991') -- Added China Warehouses 3970, 3980 , 8502, 8505
and	(
