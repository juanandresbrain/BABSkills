# dbo.spMerchandisingEmail1DaysPastERDWarning_BAK
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingEmail1DaysPastERDWarning_BAK"]
...
```sql
CREATE proc [dbo].[spMerchandisingEmail1DaysPastERDWarning_BAK]
