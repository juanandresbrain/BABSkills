# dbo.spMerchandisingStageDistrosToStoreShipments
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingStageDistrosToStoreShipments"]
...
```sql
CREATE proc [dbo].[spMerchandisingStageDistrosToStoreShipments]
...
--		Dan Tweedie		2020-08-27		Added code to include SourceID and to include all warehouses (980,960,2970,3970)
-- =====================================================================================================
...
where ddas.sourceid in ('0980','0960','2970','3970')
and	ddas.released is null
--and left(ddas.distribution_number,2) not in ('TO', 'SO')
and isnumeric(ddas.distribution_number) = 1 -- SHOULD EXCLUDE DISTROS STAGED FROM DYNAMICS
