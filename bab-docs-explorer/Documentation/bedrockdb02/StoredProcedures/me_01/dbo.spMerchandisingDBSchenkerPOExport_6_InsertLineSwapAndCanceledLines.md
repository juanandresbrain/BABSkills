# dbo.spMerchandisingDBSchenkerPOExport_6_InsertLineSwapAndCanceledLines
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingDBSchenkerPOExport_6_InsertLineSwapAndCanceledLines"]
...
```sql
CREATE proc [dbo].[spMerchandisingDBSchenkerPOExport_6_InsertLineSwapAndCanceledLines]
as
-- =====================================================================================================
...
begin
	...
	case 
		...
		then 
			...
			case 
				when l1.location_code in ('3970','3980','9942','8502','8505') -- Changed from = '0975' aka Canada on 2/15/2016
				then 
					case 
						when substring(hg.hierarchy_group_code,7,2)= '60'
	...
	-- and i.upc_number < '000001000000' -- Removed on 3/22/2016 due to conflict with "true" UPC's
		...
		*/
		and (	a.import_flag = 1 --ensures we only capture non-domestic vendors
				and l1.location_code in ('0980','0960','0013','9999','0975','2970','2999','2013','1971','1972','3970','3980','9942','8502','8505')
