...
```mermaid
flowchart LR
    SP["dbo.spPOSSelectProductCatalogMasterAttributes"]
...
```sql
CREATE proc [dbo].[spPOSSelectProductCatalogMasterAttributes]
...
--		Dan Tweedie		2024-03-13		Added more columns
-- =====================================================================================================
...
select 
	...
	case when h.DepartmentCode in 
				(
					...
					'R-B-D-57',
					'R-B-U-57'
				) and s.style_code not in ('083500','083501','183500','483500','183501','483501','080725','080726','080727','080728','080729','080744','080742') --party play card -- should get discounts, per Mike Dalton and team -- also gift card activate item for jm -- Added Two PLAYMAZE  styles on Apr 3 2025
