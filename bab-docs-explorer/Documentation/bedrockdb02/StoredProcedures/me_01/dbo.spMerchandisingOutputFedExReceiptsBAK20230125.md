# dbo.spMerchandisingOutputFedExReceiptsBAK20230125
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingOutputFedExReceiptsBAK20230125"]
...
```sql
CREATE proc [dbo].[spMerchandisingOutputFedExReceiptsBAK20230125]
as
