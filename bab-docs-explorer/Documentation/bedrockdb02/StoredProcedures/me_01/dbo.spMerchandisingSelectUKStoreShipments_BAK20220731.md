# dbo.spMerchandisingSelectUKStoreShipments_BAK20220731
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingSelectUKStoreShipments_BAK20220731"]
...
```sql
CREATE proc [dbo].[spMerchandisingSelectUKStoreShipments_BAK20220731]
