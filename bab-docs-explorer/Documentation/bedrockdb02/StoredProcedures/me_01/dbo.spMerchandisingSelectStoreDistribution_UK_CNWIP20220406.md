# dbo.spMerchandisingSelectStoreDistribution_UK_CNWIP20220406
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingSelectStoreDistribution_UK_CNWIP20220406"]
...
```sql
CREATE proc [dbo].[spMerchandisingSelectStoreDistribution_UK_CNWIP20220406]
as
			...
			--email report
				...
				set @text = '
					...
					exec msdb.dbo.sp_send_dbmail
						...
						@recipients = 'dant@buildabear.com',--@recip, 
						@body = @text,
						@subject = @subj,
