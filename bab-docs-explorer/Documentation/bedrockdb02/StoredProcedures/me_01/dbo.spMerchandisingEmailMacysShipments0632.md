# dbo.spMerchandisingEmailMacysShipments0632
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingEmailMacysShipments0632"]
...
```sql
CREATE proc [dbo].[spMerchandisingEmailMacysShipments0632]
...
-- =====================================================================================================
-- Name: spMerchandisingEmailMacysShipments0632
--
-- Description:	Sends a daily running log of unrecived shipments to store 0632 
--
-- Input: NA
--
...
where right('0000' + cast(s.STR_NUM as varchar(4)), 4) = '0632'
ORDER BY 1
...
begin
	...
	@body = @text,
	@subject= 'STORE SHIPMENTS FOR 0632', 
	@body_format = 'HTML'
