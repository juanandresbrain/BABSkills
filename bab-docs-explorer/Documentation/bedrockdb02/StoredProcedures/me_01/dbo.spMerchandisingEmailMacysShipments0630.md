# dbo.spMerchandisingEmailMacysShipments0630
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingEmailMacysShipments0630"]
...
```sql
CREATE proc [dbo].[spMerchandisingEmailMacysShipments0630]
...
-- =====================================================================================================
-- Name: spMerchandisingEmailMacysShipments0630
--
-- Description:	Sends a daily running log of unrecived shipments to store 0630 
--
-- Input: NA
--
...
where right('0000' + cast(s.STR_NUM as varchar(4)), 4) = '0630'
ORDER BY 1
...
begin
	...
	@body = @text,
	@subject= 'STORE SHIPMENTS FOR 0630', 
	@body_format = 'HTML'
