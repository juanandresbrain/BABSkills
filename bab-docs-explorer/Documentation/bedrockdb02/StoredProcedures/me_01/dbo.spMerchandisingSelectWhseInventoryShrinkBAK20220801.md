# dbo.spMerchandisingSelectWhseInventoryShrinkBAK20220801
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingSelectWhseInventoryShrinkBAK20220801"]
...
```sql
create proc [dbo].[spMerchandisingSelectWhseInventoryShrinkBAK20220801]
as
