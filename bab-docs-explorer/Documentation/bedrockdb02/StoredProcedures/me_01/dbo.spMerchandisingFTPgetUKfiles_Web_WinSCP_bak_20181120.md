# dbo.spMerchandisingFTPgetUKfiles_Web_WinSCP_bak_20181120
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingFTPgetUKfiles_Web_WinSCP_bak_20181120"]
...
```sql
CREATE proc [dbo].[spMerchandisingFTPgetUKfiles_Web_WinSCP_bak_20181120] -- Stored Proc name
as
-- =====================================================================================================
...
--declare and set ftp variables 
					...
					select
							@winSCP = '"\\babwscore01\C$\Program Files (x86)\WinSCP\winscp.com"',
...
-------------------------------------------------------------------------------------------------------------------------------------
	...
	set @text = '<font face =arial size = 2>' + 
			...
			'<br><br>' +
			'<table border="1">' +
			'<tr><th>CBR</th><th>RECEIPT</th><th>ADJUSTMENT</th><th>INVENTORY</th></tr>' +
			CAST ( ( SELECT td = @cbr,'',
							td = @rcpt, '',
							td = @adj, '',
							td = @inv, ''
