# dbo.spMerchandisingOutputnNonWhseInventoryShrinkBatched_bak
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingOutputnNonWhseInventoryShrinkBatched_bak"]
...
```sql
CREATE proc [dbo].[spMerchandisingOutputnNonWhseInventoryShrinkBatched_bak]
@LocationCode int 
as
