# dbo.spMerchandisingReportStyleList
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingReportStyleList"]
...
```sql
CREATE procedure [dbo].[spMerchandisingReportStyleList]
as
set nocount on
-- =====================================================================================================
...
--		Keith Lee			05/13/2020		Removed Jennifer D and added Anjali Khosla as per Request ID# 21627 and added technical details
-- =====================================================================================================
...
BEGIN 
             ...
             DECLARE @1query varchar(1000),
					 ...
					 set @1body = 'If you have any problems with this report, please contact EntSysSupport@buildabear.com.
					
					Technical Details: <br>' +
		'<font face =arial size = 1 color="Black">' +
		'<br><br><br><br>' +
		'Server:  BEDROCKDB02 <br>' +
		'Job Name:  MERCHANDISING - Report - Merchandising Style List <br>' +
		'Stored Proc:  BEDROCKDB02.me_01.dbo.spMerchandisingReportStyleList <br>' +
		'Created by:  Dan Tweedie <br>' +
		'Team Ownership:  Enterprise Systems <br>'
			...
			EXEC   msdb.dbo.sp_send_dbmail
					...
					@recipients = 'AnjaliK@buildabear.com;BQTransfers@buildabear.com;distrobears@buildabear.com;plannerb@buildabear.com;BABWmerch@buildabear.com;uklogistics@buildabear.com;purchasing@buildabear.com;wcdclogistics@buildabear.com;physicalinventory@buildabear.com;shelih@buildabear.com;mistyj@buildabear.com;chadv@buildabear.com;devonp@buildabear.com;lindak@buildabear.com;rebeccae@buildabear.com',
