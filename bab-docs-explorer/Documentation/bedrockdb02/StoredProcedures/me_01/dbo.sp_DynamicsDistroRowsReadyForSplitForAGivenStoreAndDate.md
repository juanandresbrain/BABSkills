# dbo.sp_DynamicsDistroRowsReadyForSplitForAGivenStoreAndDate
...
```mermaid
flowchart LR
    SP["dbo.sp_DynamicsDistroRowsReadyForSplitForAGivenStoreAndDate"]
...
```sql
--===============================================================================================================================================
---Dan Tweedie	-	2020-09-01	-	Created proc from sp_DistroRowsReadyForSplitForAGivenStoreAndDate, 
--										updated to only include where isnumeric(distribution_number)=0 so it only includes Dynamics, not Aptos
--===============================================================================================================================================


CREATE proc  [dbo].[sp_DynamicsDistroRowsReadyForSplitForAGivenStoreAndDate] 
	(@storeNum  int,
	 @warehouseNum int)
...
FROM (SELECT 
	...
	--AND LEFT(distribution_split.[distribution_number],1)  IN ('T','S') --DYNAMICS TRANFERS -- Changed to IN on 8/10/2022
	and
		destid = @storeNum
	AND 
