# dbo.spMerchandisingSelectUKStoreShipments_Backup_06132017
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingSelectUKStoreShipments_Backup_06132017"]
...
```sql
CREATE proc [dbo].[spMerchandisingSelectUKStoreShipments_Backup_06132017]
