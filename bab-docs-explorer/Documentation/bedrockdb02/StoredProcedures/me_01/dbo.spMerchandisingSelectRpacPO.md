# dbo.spMerchandisingSelectRpacPO
...
```mermaid
flowchart LR
    SP["dbo.spMerchandisingSelectRpacPO"]
...
```sql
CREATE proc [dbo].[spMerchandisingSelectRpacPO]
...
--		Tim Callahan	02/28/2018		Step #2 was inserting the label "Number of units in a pack" rather than custom property value
--										This  was causing Step #6 and #9 to fail because the steps could not convert the string to an integer 
-- =====================================================================================================
...
CASE WHEN substring(hg.hierarchy_group_code,7,2) = '60' THEN 'SUP' ELSE 'MER' END AS MerchOrSupply,
ecp.custom_property_value SupPackQty, -- Changed from "cp.cust_prop_label SupPackQty" on 2/28/2018
