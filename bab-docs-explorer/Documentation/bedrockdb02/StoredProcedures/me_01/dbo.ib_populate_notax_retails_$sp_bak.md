# dbo.ib_populate_notax_retails_$sp_bak
...
```mermaid
flowchart LR
    SP["dbo.ib_populate_notax_retails_$sp_bak"]
...
```sql
CREATE PROCEDURE [dbo].[ib_populate_notax_retails_$sp_bak]
...
BEGIN 
 ...
 WHERE ii.transaction_type_code BETWEEN 300 AND 309
 UNION ALL
 SELECT ii.*
 FROM ib_inventory ii
  INNER JOIN
 ...
 ON  ii.document_number = iw.document_number
 WHERE ii.transaction_type_code BETWEEN 400 AND 409
