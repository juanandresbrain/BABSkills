# dbo.sp_smartlook_WH_AVAILABLE_OH_RPT_W
...
```mermaid
flowchart LR
    SP["dbo.sp_smartlook_WH_AVAILABLE_OH_RPT_W"]
...
```sql
CREATE proc [dbo].[sp_smartlook_WH_AVAILABLE_OH_RPT_W] (@location_code varchar(4))
