# dbo.spMerchStyleValidation_GetProductForValidationByStyle
...
```mermaid
flowchart LR
    SP["dbo.spMerchStyleValidation_GetProductForValidationByStyle"]
...
```sql
CREATE PROCEDURE [dbo].[spMerchStyleValidation_GetProductForValidationByStyle] 
...
-- =============================================
	...
	SELECT s.style_code as styleCode
		  ...
		  LEFT JOIN (
			...
			GROUP BY s.style_code, hg4.hierarchy_group_code, att.attribute_set_label, hg3.hierarchy_group_code
