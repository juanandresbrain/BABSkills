# dbo.sp_sysutility_ucp_calculate_health
...
```mermaid
flowchart LR
    SP["dbo.sp_sysutility_ucp_calculate_health"]
    ...
    dbo_sp_sysutility_ucp_calculate_computer_health(["dbo.sp_sysutility_ucp_calculate_computer_health"]) --> SP
    dbo_sp_sysutility_ucp_calculate_dac_health(["dbo.sp_sysutility_ucp_calculate_dac_health"]) --> SP
    dbo_sp_sysutility_ucp_calculate_filegroups_with_policy_violations(["dbo.sp_sysutility_ucp_calculate_filegroups_with_policy_violations"]) --> SP
    dbo_sp_sysutility_ucp_calculate_mi_health(["dbo.sp_sysutility_ucp_calculate_mi_health"]) --> SP
    dbo_sp_sysutility_ucp_get_policy_violations(["dbo.sp_sysutility_ucp_get_policy_violations"]) --> SP
...
| dbo.sp_sysutility_ucp_calculate_filegroups_with_policy_violations |
| dbo.sp_sysutility_ucp_calculate_mi_health |
| dbo.sp_sysutility_ucp_get_policy_violations |
