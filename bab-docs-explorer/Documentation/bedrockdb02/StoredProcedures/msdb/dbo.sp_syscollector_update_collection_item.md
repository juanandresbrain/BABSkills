...
```mermaid
flowchart LR
    SP["dbo.sp_syscollector_update_collection_item"]
    ...
    dbo_sp_syscollector_update_collection_item_internal(["dbo.sp_syscollector_update_collection_item_internal"]) --> SP
    dbo_sp_syscollector_validate_xml(["dbo.sp_syscollector_validate_xml"]) --> SP
...
| dbo.sp_syscollector_update_collection_item_internal |
| dbo.sp_syscollector_validate_xml |
