# dbo.sp_sysutility_mi_initialize_collection
...
```mermaid
flowchart LR
    SP["dbo.sp_sysutility_mi_initialize_collection"]
    dbo_fn_sysutility_mi_get_collect_script(["dbo.fn_sysutility_mi_get_collect_script"]) --> SP
    dbo_fn_sysutility_ucp_get_instance_is_mi(["dbo.fn_sysutility_ucp_get_instance_is_mi"]) --> SP
    dbo_sp_add_category(["dbo.sp_add_category"]) --> SP
    ...
    dbo_sp_delete_jobstep(["dbo.sp_delete_jobstep"]) --> SP
    dbo_sp_start_job(["dbo.sp_start_job"]) --> SP
    dbo_sp_sysutility_mi_collect_dac_execution_statistics_internal(["dbo.sp_sysutility_mi_collect_dac_execution_statistics_internal"]) --> SP
...
| Referenced Table |
|---|
| dbo.fn_sysutility_mi_get_collect_script |
