...
```mermaid
flowchart LR
    SP["dbo.sp_sysutility_ucp_remove"]
    core_source_info_internal(["core.source_info_internal"]) --> SP
    dbo_fn_sysutility_get_is_instance_ucp(["dbo.fn_sysutility_get_is_instance_ucp"]) --> SP
    dbo_sp_delete_job(["dbo.sp_delete_job"]) --> SP
    dbo_sp_syspolicy_delete_condition(["dbo.sp_syspolicy_delete_condition"]) --> SP
    dbo_sp_syspolicy_delete_object_set(["dbo.sp_syspolicy_delete_object_set"]) --> SP
    dbo_sp_syspolicy_delete_policy(["dbo.sp_syspolicy_delete_policy"]) --> SP
    dbo_sp_syspolicy_mark_system(["dbo.sp_syspolicy_mark_system"]) --> SP
    ...
    dbo_sysutility_ucp_computer_cpu_health_internal(["dbo.sysutility_ucp_computer_cpu_health_internal"]) --> SP
    dbo_sysutility_ucp_configuration_internal(["dbo.sysutility_ucp_configuration_internal"]) --> SP
    dbo_sysutility_ucp_dac_file_space_health_internal(["dbo.sysutility_ucp_dac_file_space_health_internal"]) --> SP
    dbo_sysutility_ucp_dac_health_internal(["dbo.sysutility_ucp_dac_health_internal"]) --> SP
    dbo_sysutility_ucp_filegroups_with_policy_violations_internal(["dbo.sysutility_ucp_filegroups_with_policy_violations_internal"]) --> SP
    dbo_sysutility_ucp_health_policies_internal(["dbo.sysutility_ucp_health_policies_internal"]) --> SP
    dbo_sysutility_ucp_managed_instances(["dbo.sysutility_ucp_managed_instances"]) --> SP
    dbo_sysutility_ucp_mi_database_health_internal(["dbo.sysutility_ucp_mi_database_health_internal"]) --> SP
    dbo_sysutility_ucp_mi_file_space_health_internal(["dbo.sysutility_ucp_mi_file_space_health_internal"]) --> SP
    dbo_sysutility_ucp_mi_health_internal(["dbo.sysutility_ucp_mi_health_internal"]) --> SP
    dbo_sysutility_ucp_mi_volume_space_health_internal(["dbo.sysutility_ucp_mi_volume_space_health_internal"]) --> SP
    dbo_sysutility_ucp_policies(["dbo.sysutility_ucp_policies"]) --> SP
    dbo_sysutility_ucp_policy_violations_internal(["dbo.sysutility_ucp_policy_violations_internal"]) --> SP
    dbo_sysutility_ucp_processing_state_internal(["dbo.sysutility_ucp_processing_state_internal"]) --> SP
    dbo_sysutility_ucp_snapshot_partitions_internal(["dbo.sysutility_ucp_snapshot_partitions_internal"]) --> SP
    ...
    sysutility_ucp_misc_utility_objects_internal(["sysutility_ucp_misc.utility_objects_internal"]) --> SP
```
...
| dbo.sysutility_ucp_computer_cpu_health_internal |
...
| dbo.sysutility_ucp_managed_instances |
| dbo.sysutility_ucp_mi_database_health_internal |
...
| sysutility_ucp_misc.utility_objects_internal |
