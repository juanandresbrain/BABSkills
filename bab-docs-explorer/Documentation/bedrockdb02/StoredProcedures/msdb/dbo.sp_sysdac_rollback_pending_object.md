...
```mermaid
flowchart LR
    SP["dbo.sp_sysdac_rollback_pending_object"]
    dbo_sp_sysdac_resolve_pending_entry(["dbo.sp_sysdac_resolve_pending_entry"]) --> SP
    dbo_sp_sysdac_rollback_committed_step(["dbo.sp_sysdac_rollback_committed_step"]) --> SP
...
| Referenced Table |
|---|
| dbo.sp_sysdac_resolve_pending_entry |
