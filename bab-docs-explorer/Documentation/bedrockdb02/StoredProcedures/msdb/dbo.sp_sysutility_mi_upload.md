...
```mermaid
flowchart LR
    SP["dbo.sp_sysutility_mi_upload"]
    ...
    dbo_sp_syscollector_run_collection_set(["dbo.sp_syscollector_run_collection_set"]) --> SP
    ...
    dbo_syscollector_execution_log_internal(["dbo.syscollector_execution_log_internal"]) --> SP
```
