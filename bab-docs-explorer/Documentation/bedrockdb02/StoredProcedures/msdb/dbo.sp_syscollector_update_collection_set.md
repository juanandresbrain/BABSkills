...
```mermaid
flowchart LR
    SP["dbo.sp_syscollector_update_collection_set"]
    dbo_sp_syscollector_start_collection_set(["dbo.sp_syscollector_start_collection_set"]) --> SP
    dbo_sp_syscollector_stop_collection_set(["dbo.sp_syscollector_stop_collection_set"]) --> SP
    dbo_sp_syscollector_update_collection_set_internal(["dbo.sp_syscollector_update_collection_set_internal"]) --> SP
    dbo_sp_syscollector_verify_collection_set(["dbo.sp_syscollector_verify_collection_set"]) --> SP
...
| dbo.sp_syscollector_verify_collection_set |
