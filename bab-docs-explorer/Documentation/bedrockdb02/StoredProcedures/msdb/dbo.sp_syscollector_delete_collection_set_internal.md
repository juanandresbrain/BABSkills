# dbo.sp_syscollector_delete_collection_set_internal
...
```mermaid
flowchart LR
    SP["dbo.sp_syscollector_delete_collection_set_internal"]
    dbo_sp_syscollector_delete_execution_log_tree(["dbo.sp_syscollector_delete_execution_log_tree"]) --> SP
