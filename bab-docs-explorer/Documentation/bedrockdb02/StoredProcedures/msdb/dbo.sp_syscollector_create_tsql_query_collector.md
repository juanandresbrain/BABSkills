# dbo.sp_syscollector_create_tsql_query_collector
...
```mermaid
flowchart LR
    SP["dbo.sp_syscollector_create_tsql_query_collector"]
    dbo_sp_ssis_setpackageroles(["dbo.sp_ssis_setpackageroles"]) --> SP
    ...
    dbo_syscollector_tsql_query_collector(["dbo.syscollector_tsql_query_collector"]) --> SP
