# dbo.sp_syscollector_update_collection_set_internal
...
```mermaid
flowchart LR
    SP["dbo.sp_syscollector_update_collection_set_internal"]
    dbo_sp_attach_schedule(["dbo.sp_attach_schedule"]) --> SP
    dbo_sp_detach_schedule(["dbo.sp_detach_schedule"]) --> SP
    dbo_sp_syscollector_create_jobs(["dbo.sp_syscollector_create_jobs"]) --> SP
    dbo_sp_syscollector_delete_jobs(["dbo.sp_syscollector_delete_jobs"]) --> SP
    dbo_sp_syscollector_update_job_proxy(["dbo.sp_syscollector_update_job_proxy"]) --> SP
    dbo_syscollector_collection_sets(["dbo.syscollector_collection_sets"]) --> SP
    dbo_syscollector_collection_sets_internal(["dbo.syscollector_collection_sets_internal"]) --> SP
...
| dbo.sp_syscollector_create_jobs |
| dbo.sp_syscollector_delete_jobs |
| dbo.sp_syscollector_update_job_proxy |
