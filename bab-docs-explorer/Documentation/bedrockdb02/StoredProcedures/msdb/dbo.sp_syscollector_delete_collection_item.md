...
```mermaid
flowchart LR
    SP["dbo.sp_syscollector_delete_collection_item"]
    dbo_sp_syscollector_delete_collection_item_internal(["dbo.sp_syscollector_delete_collection_item_internal"]) --> SP
...
| Referenced Table |
|---|
| dbo.sp_syscollector_delete_collection_item_internal |
