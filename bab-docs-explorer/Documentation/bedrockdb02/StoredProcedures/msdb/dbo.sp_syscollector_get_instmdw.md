# dbo.sp_syscollector_get_instmdw
...
```mermaid
flowchart LR
    SP["dbo.sp_syscollector_get_instmdw"]
    dbo_sp_syscollector_upload_instmdw(["dbo.sp_syscollector_upload_instmdw"]) --> SP
    dbo_syscollector_blobs_internal(["dbo.syscollector_blobs_internal"]) --> SP
```
...
| Referenced Table |
|---|
| dbo.sp_syscollector_upload_instmdw |
