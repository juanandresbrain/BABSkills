...
```mermaid
flowchart LR
    SP["dbo.sp_syspolicy_create_job"]
    dbo_fn_syspolicy_get_ps_command(["dbo.fn_syspolicy_get_ps_command"]) --> SP
    ...
    dbo_sp_update_jobstep(["dbo.sp_update_jobstep"]) --> SP
...
| Referenced Table |
|---|
| dbo.fn_syspolicy_get_ps_command |
| dbo.sp_add_job |
