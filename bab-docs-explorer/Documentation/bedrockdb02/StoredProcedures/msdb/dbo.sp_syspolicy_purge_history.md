# dbo.sp_syspolicy_purge_history
...
```mermaid
flowchart LR
    SP["dbo.sp_syspolicy_purge_history"]
    dbo_sp_syspolicy_check_membership(["dbo.sp_syspolicy_check_membership"]) --> SP
    dbo_syspolicy_configuration(["dbo.syspolicy_configuration"]) --> SP
    dbo_syspolicy_policies(["dbo.syspolicy_policies"]) --> SP
    dbo_syspolicy_policy_category_subscriptions_internal(["dbo.syspolicy_policy_category_subscriptions_internal"]) --> SP
