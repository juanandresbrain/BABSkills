# dbo.sp_sysdac_rollback_committed_step
...
```mermaid
flowchart LR
    SP["dbo.sp_sysdac_rollback_committed_step"]
    dbo_sp_sysdac_delete_instance(["dbo.sp_sysdac_delete_instance"]) --> SP
    dbo_sp_sysdac_drop_database(["dbo.sp_sysdac_drop_database"]) --> SP
    dbo_sp_sysdac_rename_database(["dbo.sp_sysdac_rename_database"]) --> SP
    dbo_sp_sysdac_setreadonly_database(["dbo.sp_sysdac_setreadonly_database"]) --> SP
