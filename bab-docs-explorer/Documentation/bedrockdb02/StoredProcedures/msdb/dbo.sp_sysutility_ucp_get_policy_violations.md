...
```mermaid
flowchart LR
    SP["dbo.sp_sysutility_ucp_get_policy_violations"]
    ...
    dbo_sysutility_ucp_policy_configuration(["dbo.sysutility_ucp_policy_configuration"]) --> SP
...
| dbo.sysutility_ucp_policy_configuration |
