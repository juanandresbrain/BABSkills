...
```mermaid
flowchart LR
    SP["dbo.sp_syscollector_delete_execution_log_tree"]
    dbo_fn_syscollector_find_collection_set_root(["dbo.fn_syscollector_find_collection_set_root"]) --> SP
...
| Referenced Table |
|---|
| dbo.fn_syscollector_find_collection_set_root |
