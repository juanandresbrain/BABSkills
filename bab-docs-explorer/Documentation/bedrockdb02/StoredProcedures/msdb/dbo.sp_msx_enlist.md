...
```mermaid
flowchart LR
    SP["dbo.sp_msx_enlist"]
    dbo_sp_delete_all_msx_jobs(["dbo.sp_delete_all_msx_jobs"]) --> SP
    dbo_sp_generate_server_description(["dbo.sp_generate_server_description"]) --> SP
    dbo_sp_msx_defect(["dbo.sp_msx_defect"]) --> SP
    dbo_sqlagent_info(["dbo.sqlagent_info"]) --> SP
    dbo_sysoriginatingservers(["dbo.sysoriginatingservers"]) --> SP
    ...
    dbo_xp_msx_enlist(["dbo.xp_msx_enlist"]) --> SP
