...
```mermaid
flowchart LR
    SP["dbo.sp_verify_proxy_permissions"]
    dbo_get_principal_id(["dbo.get_principal_id"]) --> SP
    dbo_sp_sqlagent_is_member(["dbo.sp_sqlagent_is_member"]) --> SP
    dbo_sp_sqlagent_is_srvrolemember(["dbo.sp_sqlagent_is_srvrolemember"]) --> SP
    dbo_sysproxies(["dbo.sysproxies"]) --> SP
    dbo_sysproxyloginsubsystem_view(["dbo.sysproxyloginsubsystem_view"]) --> SP
...
| dbo.sysproxies |
| dbo.sysproxyloginsubsystem_view |
