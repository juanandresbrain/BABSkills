...
```mermaid
flowchart LR
    SP["dbo.sp_syscollector_update_collector_type"]
    dbo_sp_syscollector_verify_collector_type(["dbo.sp_syscollector_verify_collector_type"]) --> SP
    dbo_syscollector_collector_types(["dbo.syscollector_collector_types"]) --> SP
    dbo_syscollector_collector_types_internal(["dbo.syscollector_collector_types_internal"]) --> SP
...
| Referenced Table |
|---|
| dbo.sp_syscollector_verify_collector_type |
