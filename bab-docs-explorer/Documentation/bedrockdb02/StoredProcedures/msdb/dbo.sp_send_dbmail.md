...
flowchart LR
    ...
    dbo_get_principal_id(["dbo.get_principal_id"]) --> SP
    dbo_sp_GetAttachmentData(["dbo.sp_GetAttachmentData"]) --> SP
    dbo_sp_RunMailQuery(["dbo.sp_RunMailQuery"]) --> SP
    dbo_sp_SendMailQueues(["dbo.sp_SendMailQueues"]) --> SP
    dbo_sp_validate_user(["dbo.sp_validate_user"]) --> SP
    dbo_sysmail_attachments(["dbo.sysmail_attachments"]) --> SP
    dbo_sysmail_attachments_transfer(["dbo.sysmail_attachments_transfer"]) --> SP
    dbo_sysmail_mailitems(["dbo.sysmail_mailitems"]) --> SP
    dbo_sysmail_principalprofile(["dbo.sysmail_principalprofile"]) --> SP
    dbo_sysmail_query_transfer(["dbo.sysmail_query_transfer"]) --> SP
    dbo_sysmail_verify_addressparams_sp(["dbo.sysmail_verify_addressparams_sp"]) --> SP
