...
```mermaid
flowchart LR
    SP["dbo.sp_sysdac_update_history_entry"]
    dbo_fn_sysdac_get_currentusername(["dbo.fn_sysdac_get_currentusername"]) --> SP
    dbo_fn_sysdac_is_currentuser_sa(["dbo.fn_sysdac_is_currentuser_sa"]) --> SP
...
| Referenced Table |
|---|
| dbo.fn_sysdac_get_currentusername |
