...
```mermaid
flowchart LR
    SP["dbo.sp_sysutility_mi_collect_dac_execution_statistics_internal"]
    ...
    dbo_sysutility_mi_session_statistics_internal(["dbo.sysutility_mi_session_statistics_internal"]) --> SP
```
