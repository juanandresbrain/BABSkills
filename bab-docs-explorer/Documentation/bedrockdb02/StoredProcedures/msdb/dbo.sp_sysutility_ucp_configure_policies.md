# dbo.sp_sysutility_ucp_configure_policies
...
```mermaid
flowchart LR
    SP["dbo.sp_sysutility_ucp_configure_policies"]
    dbo_sp_delete_job(["dbo.sp_delete_job"]) --> SP
    dbo_sp_delete_schedule(["dbo.sp_delete_schedule"]) --> SP
    dbo_sp_syspolicy_add_condition(["dbo.sp_syspolicy_add_condition"]) --> SP
    dbo_sp_syspolicy_add_object_set(["dbo.sp_syspolicy_add_object_set"]) --> SP
    dbo_sp_syspolicy_add_policy(["dbo.sp_syspolicy_add_policy"]) --> SP
    dbo_sp_syspolicy_add_target_set(["dbo.sp_syspolicy_add_target_set"]) --> SP
    dbo_sp_syspolicy_add_target_set_level(["dbo.sp_syspolicy_add_target_set_level"]) --> SP
    ...
    dbo_sp_sysutility_ucp_add_policy(["dbo.sp_sysutility_ucp_add_policy"]) --> SP
    dbo_sp_sysutility_ucp_calculate_health(["dbo.sp_sysutility_ucp_calculate_health"]) --> SP
    dbo_sysjobs_view(["dbo.sysjobs_view"]) --> SP
    dbo_syspolicy_conditions(["dbo.syspolicy_conditions"]) --> SP
    dbo_syspolicy_object_sets(["dbo.syspolicy_object_sets"]) --> SP
...
| dbo.sp_sysutility_ucp_add_policy |
