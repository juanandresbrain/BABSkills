...
flowchart LR
    ...
    dbo_insert_report_criteria_form_default_webim__sp(["dbo.insert_report_criteria_form_default_webim_$sp"]) --> SP
...
| dbo.insert_report_criteria_form_default_webim_$sp |
| dbo.T_ID |
