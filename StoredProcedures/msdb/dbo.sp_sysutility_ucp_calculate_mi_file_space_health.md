...
```mermaid
flowchart LR
    SP["dbo.sp_sysutility_ucp_calculate_mi_file_space_health"]
    dbo_sysutility_ucp_databases(["dbo.sysutility_ucp_databases"]) --> SP
    dbo_sysutility_ucp_filegroups(["dbo.sysutility_ucp_filegroups"]) --> SP
