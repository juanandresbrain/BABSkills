# dbo.sp_sysutility_mi_configure_proxy_account
...
```mermaid
flowchart LR
    SP["dbo.sp_sysutility_mi_configure_proxy_account"]
    dbo_sp_add_proxy(["dbo.sp_add_proxy"]) --> SP
    dbo_sp_delete_proxy(["dbo.sp_delete_proxy"]) --> SP
    dbo_sp_grant_login_to_proxy(["dbo.sp_grant_login_to_proxy"]) --> SP
    dbo_sp_grant_proxy_to_subsystem(["dbo.sp_grant_proxy_to_subsystem"]) --> SP
