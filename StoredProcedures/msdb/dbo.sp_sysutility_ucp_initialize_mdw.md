# dbo.sp_sysutility_ucp_initialize_mdw
...
```mermaid
flowchart LR
    SP["dbo.sp_sysutility_ucp_initialize_mdw"]
    dbo_fn_sysutility_get_is_instance_ucp(["dbo.fn_sysutility_get_is_instance_ucp"]) --> SP
    dbo_sp_sysutility_ucp_recreate_synonym_internal(["dbo.sp_sysutility_ucp_recreate_synonym_internal"]) --> SP
```
...
| dbo.sp_sysutility_ucp_recreate_synonym_internal |
