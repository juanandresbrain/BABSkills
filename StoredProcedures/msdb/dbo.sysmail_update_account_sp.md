...
```mermaid
flowchart LR
    SP["dbo.sysmail_update_account_sp"]
    dbo_sysmail_account(["dbo.sysmail_account"]) --> SP
    dbo_sysmail_alter_user_credential_sp(["dbo.sysmail_alter_user_credential_sp"]) --> SP
    dbo_sysmail_create_user_credential_sp(["dbo.sysmail_create_user_credential_sp"]) --> SP
    ...
    dbo_sysmail_verify_accountparams_sp(["dbo.sysmail_verify_accountparams_sp"]) --> SP
