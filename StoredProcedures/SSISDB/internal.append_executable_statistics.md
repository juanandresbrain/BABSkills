# internal.append_executable_statistics
...
```mermaid
flowchart LR
    SP["internal.append_executable_statistics"]
    internal_check_permission(["internal.check_permission"]) --> SP
    internal_executable_statistics(["internal.executable_statistics"]) --> SP
    internal_executables(["internal.executables"]) --> SP
```
