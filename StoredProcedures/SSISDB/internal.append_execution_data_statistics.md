# internal.append_execution_data_statistics
...
```mermaid
flowchart LR
    SP["internal.append_execution_data_statistics"]
    internal_check_permission(["internal.check_permission"]) --> SP
    internal_execution_data_statistics(["internal.execution_data_statistics"]) --> SP
```
