...
```mermaid
flowchart LR
    SP["catalog.set_execution_parameter_value"]
    ...
    internal_check_parameter_value_by_name(["internal.check_parameter_value_by_name"]) --> SP
...
| internal.check_parameter_value_by_name |
