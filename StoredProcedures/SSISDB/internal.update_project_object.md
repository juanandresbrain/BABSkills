# internal.update_project_object
...
```mermaid
flowchart LR
    SP["internal.update_project_object"]
    ...
    internal_update_object_versions(["internal.update_object_versions"]) --> SP
```
...
| internal.update_object_versions |
