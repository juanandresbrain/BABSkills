...
```mermaid
flowchart LR
    SP["catalog.configure_catalog"]
    internal_catalog_properties(["internal.catalog_properties"]) --> SP
    internal_configure_environment_encryption_algorithm(["internal.configure_environment_encryption_algorithm"]) --> SP
    internal_configure_execution_encryption_algorithm(["internal.configure_execution_encryption_algorithm"]) --> SP
    internal_configure_project_encryption_algorithm(["internal.configure_project_encryption_algorithm"]) --> SP
    internal_customized_logging_levels(["internal.customized_logging_levels"]) --> SP
    ...
    internal_validate_encryption_algorithm(["internal.validate_encryption_algorithm"]) --> SP
```
...
| internal.configure_environment_encryption_algorithm |
| internal.configure_execution_encryption_algorithm |
| internal.configure_project_encryption_algorithm |
...
BEGIN
    ...
    IF @property_name NOT IN ('ENCRYPTION_ALGORITHM', 'RETENTION_WINDOW', 
            'MAX_PROJECT_VERSIONS', 'VERSION_CLEANUP_ENABLED', 'OPERATION_CLEANUP_ENABLED', 'SERVER_LOGGING_LEVEL','SERVER_CUSTOMIZED_LOGGING_LEVEL','SERVER_OPERATION_ENCRYPTION_LEVEL')
    BEGIN
