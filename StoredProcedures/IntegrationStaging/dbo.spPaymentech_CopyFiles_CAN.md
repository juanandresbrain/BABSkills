# dbo.spPaymentech_CopyFiles_CAN
...
```mermaid
flowchart LR
    SP["dbo.spPaymentech_CopyFiles_CAN"]
...
```sql
CREATE PROCEDURE [dbo].[spPaymentech_CopyFiles_CAN] 
...
set @command = 'net use ' + @destdrive + ' "\\stl-dynsnc-p-01\oData\paymentechD365can"'
insert into ##paymentech_error
exec master..xp_cmdshell @command
