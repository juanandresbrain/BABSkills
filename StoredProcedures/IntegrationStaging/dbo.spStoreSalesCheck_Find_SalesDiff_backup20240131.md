...
```mermaid
flowchart LR
    SP["dbo.spStoreSalesCheck_Find_SalesDiff_backup20240131"]
...
```sql
CREATE PROCEDURE [dbo].[spStoreSalesCheck_Find_SalesDiff_backup20240131]
AS
-- =============================================================================================================
...
where BusinessDate = 
	case when datepart(hh, getdate()) <=18 --up until 8am, the job will look for previous day, else same day
