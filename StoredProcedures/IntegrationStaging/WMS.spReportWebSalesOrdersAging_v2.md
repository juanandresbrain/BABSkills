# WMS.spReportWebSalesOrdersAging_v2
...
```mermaid
flowchart LR
    SP["WMS.spReportWebSalesOrdersAging_v2"]
...
```sql
CREATE proc [WMS].[spReportWebSalesOrdersAging_v2] 
@detailIndicator int
...
BEGIN
	...
	,DeckOrderDate,DynamicsOrderAge,ProcessingAge,case when isWaved = 1 then 'Yes'else 'No' end as isWaved
	...
	group by SalesOrderNumber,SalesOrderStatus,SalesOrderProcessingStatus,SalesOrderOriginCode,SalesOrderPoolId,ShippingCarrierId,ShippingCarrierServiceId,	
		OrderCreationDateTime,DeliveryModeCode,WebOrderNumber,WaveID,ReleasedDateAndTime
		--ItemNumber,OrderedSalesQuantity,LineDescription,WebOrderNumber,WaveID,ReleasedDateAndTime,ContainerID,WorkID
		,DeckOrderDate,DynamicsOrderAge,ProcessingAge,isWaved,isShippedOrCancelledInDeck
...
BEGIN
	...
	and ProcessingAge between 5 and 10
	group by SalesOrderNumber,SalesOrderStatus,SalesOrderProcessingStatus,SalesOrderOriginCode,SalesOrderPoolId,ShippingCarrierId,ShippingCarrierServiceId,	
		OrderCreationDateTime,DeliveryModeCode,WebOrderNumber,WaveID,ReleasedDateAndTime
		--ItemNumber,OrderedSalesQuantity,LineDescription,WebOrderNumber,WaveID,ReleasedDateAndTime,ContainerID,WorkID
		,DeckOrderDate,DynamicsOrderAge,ProcessingAge,isWaved,isShippedOrCancelledInDeck
